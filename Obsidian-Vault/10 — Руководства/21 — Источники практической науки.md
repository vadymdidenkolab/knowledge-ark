...
mirror_source: "../../21_PRACTICAL_SCIENCE_SOURCE_RESEARCH_RU.md"
mirror_sha256: "164f587d8d285873afe59796f54603687d65cc5dda123210bd1694dccfcad967"
...
> Source-of-truth: `../../21_PRACTICAL_SCIENCE_SOURCE_RESEARCH_RU.md`. Не редактируйте эту копию: следующий запуск восстановит её из корневого файла. Само зеркалирование не повышает статус инструкции, review, допуска, наличия имущества или готовности.

## Как использовать этот документ

- **Для чего нужен:** отобрать первичные источники и закрыть пробелы в практической науке.
- **Связан с:** [[10 — Руководства/20 — Сохранение практической науки|Сохранение практической науки]], [[10 — Руководства/19 — Исследование офлайн-корпуса|Исследование офлайн-корпуса]], [[10 — Руководства/04 — Источники и проверка происхождения|Источники и проверка происхождения]].
- **Когда читать:** перед архивацией учебников, стандартов, чертежей и процедур.
