...
mirror_source: "../../12_QA_AND_LIMITS_RU.md"
mirror_sha256: "ef63a2df83d3258e9d39ef1e277bfc6de258d99c3b93e8e96c6be829be183618"
...
> Source-of-truth: `../../12_QA_AND_LIMITS_RU.md`. Не редактируйте эту копию: следующий запуск восстановит её из корневого файла. Само зеркалирование не повышает статус инструкции, review, допуска, наличия имущества или готовности.

## Как использовать этот документ

- **Для чего нужен:** отличать план, зеркало, проверенную инструкцию, физическое наличие и допущенную готовность.
- **Связан с:** [[10 — Руководства/22 — Аудит готовности к полной изоляции|Аудит готовности к полной изоляции]], [[10 — Руководства/23 — Дерево технологических зависимостей|Дерево технологических зависимостей]], [[10 — Руководства/24 — Мастер-статус каталога|Мастер-статус каталога]].
- **Когда читать:** перед присвоением статуса ready, verified, released или allow.
...
- создан локальный stdlib-only инструмент `offline_library.py — административный инструмент` для инвентаризации SHA-256, проверки дерева, построения SQLite FTS5 и поиска;
- добавлен автономный `validate_release.py — административный инструмент`, который fail-closed проверяет состав выпуска, 54 CSV, E0–E5, science states, ссылки, E5/rights состояния и hash визуализации;
- созданы два офлайн-входа: [START_HERE.txt](../../START_HERE.txt) и [[10 — Руководства/00.2 — Быстрый старт|Быстрый старт]];
