...
- **package_id:** PSP-003
- **domain_group_codes:** METH|PHYS|CHEM|ELEC
- **title:** BIPM SI Brochure
- **publisher:** BIPM
- **content_scope:** Практический источник для групп METH|PHYS|CHEM|ELEC
- **canonical_url:** https://www.bipm.org/en/publications/si-brochure
- **acquisition_url:** https://www.bipm.org/en/publications/si-brochure
- **rights_url:** https://www.bipm.org/en/terms
- **license_or_terms:** BIPM terms; capture item notice
- **language:** en|fr
- **jurisdiction:** International/reference
- **format:** PDF/HTML
- **offline_method:** download current edition and translations
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Primary international SI reference.
