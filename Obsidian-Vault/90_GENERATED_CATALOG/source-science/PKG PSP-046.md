...
- **package_id:** PSP-046
- **domain_group_codes:** AGRI|HEALTH
- **title:** USDA Complete Guide to Home Canning
- **publisher:** USDA NCHFP
- **content_scope:** Практический источник для групп AGRI|HEALTH
- **canonical_url:** https://nchfp.uga.edu/resources/category/usda-guide
- **acquisition_url:** https://nchfp.uga.edu/resources/category/usda-guide
- **rights_url:** https://www.usda.gov/policies-and-links
- **license_or_terms:** US government work; hosted materials/item review
- **language:** en
- **jurisdiction:** International/reference
- **format:** PDF
- **offline_method:** download current official guide and updates
- **tier:** L1
- **safety_class:** S2_TRAINED_SUPERVISED
...
- **notes:** Validated US-reference processes; local ingredients/equipment and edition matter.
