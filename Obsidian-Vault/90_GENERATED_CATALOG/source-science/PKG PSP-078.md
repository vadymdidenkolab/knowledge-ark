...
id: "PSP-078"
kind: "source-science"
title: "Pro Git book source and releases"
...
# Pro Git book source and releases
...
- **title:** Pro Git book source and releases
- **publisher:** Git community/Apress
- **content_scope:** Практический источник для групп COMP|ARCH
- **canonical_url:** https://git-scm.com/book/en/v2
- **acquisition_url:** https://git-scm.com/book/en/v2
- **rights_url:** https://github.com/progit/progit2/blob/main/LICENSE.asc
- **license_or_terms:** CC BY-NC-SA 3.0 per repository; verify current
- **language:** multi
- **jurisdiction:** International/reference
- **format:** HTML/PDF/EPUB/source
- **offline_method:** official generated formats/source release
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Version-control curriculum.
