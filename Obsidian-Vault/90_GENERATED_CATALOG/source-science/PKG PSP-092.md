...
id: "PSP-092"
kind: "source-science"
title: "LNEC publications and repository"
...
# LNEC publications and repository
...
- **package_id:** PSP-092
- **domain_group_codes:** PORT|CIVIL
- **title:** LNEC publications and repository
- **publisher:** Laboratório Nacional de Engenharia Civil
- **content_scope:** Практический источник для групп PORT|CIVIL
- **canonical_url:** https://repositorio.lnec.pt/
- **acquisition_url:** https://repositorio.lnec.pt/
- **rights_url:** https://www.lnec.pt/pt/termos-de-utilizacao/
- **license_or_terms:** repository and per-item rights
- **language:** pt|en
- **jurisdiction:** Portugal/EU
- **format:** PDF/metadata
- **offline_method:** per-item download only after repository/item rights review
- **tier:** L2
- **safety_class:** S3_LICENSED_PROFESSIONAL
...
- **notes:** Portugal applied civil science; professional scope.
