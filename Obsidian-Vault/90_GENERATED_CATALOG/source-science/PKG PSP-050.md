...
id: "PSP-050"
kind: "source-science"
title: "European Commission agriculture and food-safety guidance"
...
# European Commission agriculture and food-safety guidance
...
- **package_id:** PSP-050
- **domain_group_codes:** AGRI|PORT
- **title:** European Commission agriculture and food-safety guidance
- **publisher:** European Commission
- **content_scope:** Практический источник для групп AGRI|PORT
- **canonical_url:** https://food.ec.europa.eu/index_en
- **acquisition_url:** https://food.ec.europa.eu/index_en
- **rights_url:** https://commission.europa.eu/legal-notice_en
- **license_or_terms:** EU reuse policy/third-party exceptions
- **language:** multi
- **jurisdiction:** Portugal/EU
- **format:** HTML/PDF/data
- **offline_method:** per-item official download and edition capture
- **tier:** L2
- **safety_class:** S2_TRAINED_SUPERVISED
...
- **notes:** EU regulatory context; current law and national implementation control.
