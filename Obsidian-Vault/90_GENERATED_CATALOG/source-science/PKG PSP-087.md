...
id: "PSP-087"
kind: "source-science"
title: "CAOP official administrative map"
...
# CAOP official administrative map
...
- **package_id:** PSP-087
- **domain_group_codes:** PORT|EARTH
- **title:** CAOP official administrative map
- **publisher:** Direção-Geral do Território
- **content_scope:** Практический источник для групп PORT|EARTH
- **canonical_url:** https://www.dgterritorio.gov.pt/atividades/cartografia/cartografia-tematica/caop
- **acquisition_url:** https://www.dgterritorio.gov.pt/atividades/cartografia/cartografia-tematica/caop
- **rights_url:** https://www.dgterritorio.gov.pt/termos-e-condicoes
- **license_or_terms:** DGT/data terms; capture exact edition
- **language:** pt
- **jurisdiction:** Portugal/EU
- **format:** GIS/PDF
- **offline_method:** official edition download with metadata/license
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Administrative boundaries, not hazard or route status.
