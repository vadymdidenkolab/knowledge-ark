...
- **canonical_url:** https://ndsa.org/publications/levels-of-digital-preservation/
- **acquisition_url:** https://ndsa.org/publications/levels-of-digital-preservation/
- **rights_url:** https://ndsa.org/about/
- **license_or_terms:** published license/item notice review
- **language:** en
- **jurisdiction:** International/reference
- **format:** PDF/HTML
- **offline_method:** download current matrix and implementation resources
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Practical preservation maturity model.
