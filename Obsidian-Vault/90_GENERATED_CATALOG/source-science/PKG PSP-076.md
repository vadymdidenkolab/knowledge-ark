...
- **package_id:** PSP-076
- **domain_group_codes:** COMP|OPS
- **title:** PostgreSQL documentation
- **publisher:** PostgreSQL Global Development Group
- **content_scope:** Практический источник для групп COMP|OPS
- **canonical_url:** https://www.postgresql.org/docs/
- **acquisition_url:** https://www.postgresql.org/docs/
- **rights_url:** https://www.postgresql.org/about/licence/
- **license_or_terms:** PostgreSQL License; documentation notice
- **language:** multi
- **jurisdiction:** International/reference
- **format:** HTML/PDF/source
- **offline_method:** official docs for archived supported versions
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Relational databases and durable records.
