...
id: "PSP-098"
kind: "source-science"
title: "dados.gov.pt open-data catalog"
...
# dados.gov.pt open-data catalog
...
- **package_id:** PSP-098
- **domain_group_codes:** PORT|OPS|COMP
- **title:** dados.gov.pt open-data catalog
- **publisher:** Agência para a Modernização Administrativa
- **content_scope:** Практический источник для групп PORT|OPS|COMP
- **canonical_url:** https://dados.gov.pt/
- **acquisition_url:** https://dados.gov.pt/
- **rights_url:** https://dados.gov.pt/pt/terms/
- **license_or_terms:** license per dataset/catalog terms
- **language:** pt
- **jurisdiction:** Portugal/EU
- **format:** metadata/data links
- **offline_method:** per-dataset export after license/maintainer review
- **tier:** L2
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Portugal open-data discovery; dataset authority and freshness vary.
