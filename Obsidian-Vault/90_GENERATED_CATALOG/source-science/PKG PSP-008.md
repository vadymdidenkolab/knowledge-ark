...
- **package_id:** PSP-008
- **domain_group_codes:** OPS|MECH|ELEC
- **title:** NASA Reliability-Centered Maintenance Guide
- **publisher:** NASA
- **content_scope:** Практический источник для групп OPS|MECH|ELEC
- **canonical_url:** https://www.nasa.gov/reference/reliability-centered-maintenance-guide/
- **acquisition_url:** https://www.nasa.gov/reference/reliability-centered-maintenance-guide/
- **rights_url:** https://www.nasa.gov/nasa-brand-center/images-and-media/
- **license_or_terms:** US government work; item/third-party review
- **language:** en
- **jurisdiction:** International/reference
- **format:** PDF/HTML
- **offline_method:** download exact publication after item review
- **tier:** L2
- **safety_class:** S2_TRAINED_SUPERVISED
...
- **notes:** Maintenance analysis; does not replace manufacturer procedures.
