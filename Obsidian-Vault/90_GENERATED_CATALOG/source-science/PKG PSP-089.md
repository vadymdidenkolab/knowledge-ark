...
id: "PSP-089"
kind: "source-science"
title: "APA water, flood and environment data"
...
# APA water, flood and environment data
...
- **package_id:** PSP-089
- **domain_group_codes:** PORT|EARTH|AGRI
- **title:** APA water, flood and environment data
- **publisher:** Agência Portuguesa do Ambiente
- **content_scope:** Практический источник для групп PORT|EARTH|AGRI
- **canonical_url:** https://apambiente.pt/
- **acquisition_url:** https://apambiente.pt/
- **rights_url:** https://apambiente.pt/apa/termos-e-condicoes
- **license_or_terms:** rights and reuse per item/dataset
- **language:** pt
- **jurisdiction:** Portugal/EU
- **format:** GIS/PDF/HTML
- **offline_method:** per-item/per-dataset acquisition with cycle and coverage
- **tier:** L2
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Portugal environmental authority; dynamic operational status must be refreshed.
