...
- **package_id:** SUP-LEA-016
- **domain_group_codes:** EARTH|AGRI
- **title:** World Reference Base for Soil Resources
- **publisher:** FAO Global Soil Partnership and IUSS
- **content_scope:** Практический источник для групп EARTH|AGRI
- **canonical_url:** https://www.fao.org/soils-portal/data-hub/soil-classification/world-reference-base/en/
- **acquisition_url:** https://www.fao.org/soils-portal/data-hub/soil-classification/world-reference-base/en/
- **rights_url:** https://www.fao.org/contact-us/terms/en/
- **license_or_terms:** Classification requires trained description and supporting measurements; translated edition must identify authoritative original
- **language:** EN; selected translations
- **jurisdiction:** International/reference
- **format:** PDF; classification keys
- **offline_method:** Download exact official edition and translation after checking its copyright page
- **tier:** L2
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
...
- **notes:** [SUPPLEMENTAL_RESEARCH] Classification requires trained description and supporting measurements; translated edition must identify authoritative original
