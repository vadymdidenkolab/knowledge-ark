...
- **package_id:** PSP-005
- **domain_group_codes:** METH|MATH
- **title:** NIST Statistical Reference Datasets
- **publisher:** NIST
- **content_scope:** Практический источник для групп METH|MATH
- **canonical_url:** https://www.itl.nist.gov/div898/strd/
- **acquisition_url:** https://www.itl.nist.gov/div898/strd/
- **rights_url:** https://www.nist.gov/open/copyright-fair-use-and-licensing-statements-srd-data-and-software
- **license_or_terms:** NIST SRD terms; item review
- **language:** en
- **jurisdiction:** International/reference
- **format:** ASCII/HTML
- **offline_method:** download datasets and certified values
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Reference data for verifying numerical software.
