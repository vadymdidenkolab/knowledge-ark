...
id: "PSP-048"
kind: "source-science"
title: "GBIF occurrence data and species backbone"
...
# GBIF occurrence data and species backbone
...
- **package_id:** PSP-048
- **domain_group_codes:** LIFE|EARTH
- **title:** GBIF occurrence data and species backbone
- **publisher:** GBIF
- **content_scope:** Практический источник для групп LIFE|EARTH
- **canonical_url:** https://www.gbif.org/
- **acquisition_url:** https://www.gbif.org/
- **rights_url:** https://www.gbif.org/terms
- **license_or_terms:** dataset licenses vary; GBIF terms and citation
- **language:** multi
- **jurisdiction:** International/reference
- **format:** Darwin Core/CSV/API
- **offline_method:** DOI-backed dataset download and metadata
- **tier:** L3
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Biodiversity evidence; record quality and sensitive coordinates require care.
