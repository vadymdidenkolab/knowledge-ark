...
id: "PSP-026"
kind: "source-science"
title: "Kiwix library catalog and OpenZIM packages"
...
# Kiwix library catalog and OpenZIM packages
...
- **package_id:** PSP-026
- **domain_group_codes:** EDU|MATH|PHYS|CHEM|LIFE|COMP
- **title:** Kiwix library catalog and OpenZIM packages
- **publisher:** Kiwix/OpenZIM
- **content_scope:** Практический источник для групп EDU|MATH|PHYS|CHEM|LIFE|COMP
- **canonical_url:** https://library.kiwix.org/
- **acquisition_url:** https://library.kiwix.org/
- **rights_url:** https://www.kiwix.org/en/legal/
- **license_or_terms:** rights per source project and ZIM
- **language:** multi
- **jurisdiction:** International/reference
- **format:** ZIM
- **offline_method:** download selected ZIM and reader; preserve catalog metadata/hash
- **tier:** L2
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** General reference and education; not action authority.
