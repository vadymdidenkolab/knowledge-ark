...
id: "PSP-113"
kind: "source-science"
title: "OpenZIM specification and tools"
...
# OpenZIM specification and tools
...
- **canonical_url:** https://openzim.org/
- **acquisition_url:** https://openzim.org/
- **rights_url:** https://github.com/openzim/zim-spec/blob/master/LICENSE
- **license_or_terms:** open-source licenses per repository
- **language:** en
- **jurisdiction:** International/reference
- **format:** HTML/source/spec
- **offline_method:** archive spec, libzim/zim-tools source and build dependencies
- **tier:** L2
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Long-term access to ZIM packages.
