...
id: "PSP-074"
kind: "source-science"
title: "GNU manuals selected toolchain set"
...
# GNU manuals selected toolchain set
...
- **canonical_url:** https://www.gnu.org/manual/manual.html
- **acquisition_url:** https://www.gnu.org/manual/manual.html
- **rights_url:** https://www.gnu.org/licenses/licenses.html
- **license_or_terms:** license per manual/software
- **language:** multi
- **jurisdiction:** International/reference
- **format:** HTML/PDF/Info/source
- **offline_method:** download manuals/source from official mirrors
- **tier:** L2
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Compilers, shell and foundational utilities.
