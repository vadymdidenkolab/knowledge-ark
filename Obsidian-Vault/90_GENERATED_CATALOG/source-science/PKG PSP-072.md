...
id: "PSP-072"
kind: "source-science"
title: "Debian package mirror documentation"
...
# Debian package mirror documentation
...
- **canonical_url:** https://www.debian.org/mirror/
- **acquisition_url:** https://www.debian.org/mirror/
- **rights_url:** https://www.debian.org/legal/licenses/
- **license_or_terms:** per-package license; mirror policy
- **language:** en
- **jurisdiction:** International/reference
- **format:** HTML/scripts/metadata
- **offline_method:** archive mirror tooling/docs and selected package pool
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Controlled offline repository construction.
