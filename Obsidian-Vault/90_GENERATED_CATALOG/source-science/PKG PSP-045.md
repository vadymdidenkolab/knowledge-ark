...
id: "PSP-045"
kind: "source-science"
title: "USDA NRCS Web Soil Survey and soil manuals"
...
# USDA NRCS Web Soil Survey and soil manuals
...
- **package_id:** PSP-045
- **domain_group_codes:** AGRI|EARTH
- **title:** USDA NRCS Web Soil Survey and soil manuals
- **publisher:** USDA NRCS
- **content_scope:** Практический источник для групп AGRI|EARTH
- **canonical_url:** https://websoilsurvey.nrcs.usda.gov/
- **acquisition_url:** https://websoilsurvey.nrcs.usda.gov/
...
- **format:** GIS/PDF/data
- **offline_method:** download selected manuals/data where permitted
- **tier:** L2
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Soil science reference; geography is mostly US.
