...
id: "PSP-107"
kind: "source-science"
title: "Arduino language/reference and open hardware files"
...
# Arduino language/reference and open hardware files
...
- **canonical_url:** https://docs.arduino.cc/
- **acquisition_url:** https://docs.arduino.cc/
- **rights_url:** https://www.arduino.cc/en/trademark/
- **license_or_terms:** software/hardware/docs licenses vary
- **language:** en
- **jurisdiction:** International/reference
- **format:** HTML/PDF/source/design files
- **offline_method:** per-board/per-library acquisition with exact licenses
- **tier:** L2
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
...
- **notes:** Low-voltage learning; clones/trademarks and board licenses separate.
