...
id: "PSP-049"
kind: "source-science"
title: "CGIAR open repositories catalog"
...
# CGIAR open repositories catalog
...
- **canonical_url:** https://cgspace.cgiar.org/
- **acquisition_url:** https://cgspace.cgiar.org/
- **rights_url:** https://cgspace.cgiar.org/info/terms
- **license_or_terms:** per-item licenses and repository terms
- **language:** multi
- **jurisdiction:** International/reference
- **format:** PDF/data/metadata
- **offline_method:** per-item acquisition after rights review
- **tier:** L3
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
...
- **notes:** Agriculture research and field methods; local adaptation required.
