...
id: "PSP-080"
kind: "source-science"
title: "FreeCAD documentation and source"
...
# FreeCAD documentation and source
...
- **package_id:** PSP-080
- **domain_group_codes:** CIVIL|MECH|COMP
- **title:** FreeCAD documentation and source
- **publisher:** FreeCAD Project
- **content_scope:** Практический источник для групп CIVIL|MECH|COMP
- **canonical_url:** https://www.freecad.org/manual/
- **acquisition_url:** https://www.freecad.org/manual/
- **rights_url:** https://www.freecad.org/license/
- **license_or_terms:** LGPL/GPL components; documentation license review
- **language:** multi
- **jurisdiction:** International/reference
- **format:** HTML/PDF/software/source
- **offline_method:** archive stable release, manual and source
- **tier:** L2
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
...
- **notes:** CAD learning and drawings; designs still require engineering review.
