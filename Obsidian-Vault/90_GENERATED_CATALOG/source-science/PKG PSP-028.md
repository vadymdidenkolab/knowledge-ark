...
id: "PSP-028"
kind: "source-science"
title: "Stack Exchange technical offline ZIM set"
...
# Stack Exchange technical offline ZIM set
...
- **package_id:** PSP-028
- **domain_group_codes:** COMP|MECH|ELEC
- **title:** Stack Exchange technical offline ZIM set
- **publisher:** Stack Exchange/OpenZIM
- **content_scope:** Практический источник для групп COMP|MECH|ELEC
- **canonical_url:** https://download.kiwix.org/zim/stack_exchange/
- **acquisition_url:** https://download.kiwix.org/zim/stack_exchange/
- **rights_url:** https://stackoverflow.com/help/licensing
- **license_or_terms:** CC BY-SA versions/attribution per posts; verify ZIM notices
- **language:** en
- **jurisdiction:** International/reference
- **format:** ZIM
- **offline_method:** select communities/date and download ZIM
- **tier:** L3
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Troubleshooting background; answers are not automatically correct.
