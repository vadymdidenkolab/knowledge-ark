...
id: "PSP-037"
kind: "source-science"
title: "Copernicus Emergency Management Service data"
...
- **canonical_url:** https://emergency.copernicus.eu/
- **acquisition_url:** https://emergency.copernicus.eu/
- **rights_url:** https://emergency.copernicus.eu/mapping/ems/terms-and-conditions
- **license_or_terms:** Copernicus terms and attribution
- **language:** en
- **jurisdiction:** Portugal/EU
- **format:** maps/data
- **offline_method:** download published activations/products per terms
- **tier:** L2
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Historical/reference products; not replacement for current authorities.
