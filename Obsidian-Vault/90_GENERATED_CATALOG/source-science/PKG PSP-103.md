...
id: "PSP-103"
kind: "source-science"
title: "Sphere Handbook WASH and humanitarian standards"
...
# Sphere Handbook WASH and humanitarian standards
...
- **package_id:** PSP-103
- **domain_group_codes:** CIVIL|AGRI|HEALTH
- **title:** Sphere Handbook WASH and humanitarian standards
- **publisher:** Sphere Association
- **content_scope:** Практический источник для групп CIVIL|AGRI|HEALTH
- **canonical_url:** https://spherestandards.org/handbook/
- **acquisition_url:** https://spherestandards.org/handbook/
- **rights_url:** https://spherestandards.org/resources/terms-of-use/
- **license_or_terms:** Sphere item/translation terms
- **language:** multi
- **jurisdiction:** International/reference
- **format:** PDF/HTML/app
- **offline_method:** download official language edition after rights review
- **tier:** L2
- **safety_class:** S2_TRAINED_SUPERVISED
...
- **notes:** Humanitarian reference; not a universal household design code.
