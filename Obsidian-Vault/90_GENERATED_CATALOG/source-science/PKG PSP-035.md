...
id: "PSP-035"
kind: "source-science"
title: "NOAA Climate Data Online and educational references"
...
# NOAA Climate Data Online and educational references
...
- **canonical_url:** https://www.ncei.noaa.gov/cdo-web/
- **acquisition_url:** https://www.ncei.noaa.gov/cdo-web/
- **rights_url:** https://www.noaa.gov/information-technology/open-data-dissemination
- **license_or_terms:** US government data with dataset exceptions
- **language:** en
- **jurisdiction:** International/reference
- **format:** CSV/data/HTML
- **offline_method:** download selected stations/periods and metadata
- **tier:** L3
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Historical climate reference; not local live warning.
