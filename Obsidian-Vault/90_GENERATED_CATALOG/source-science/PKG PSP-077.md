...
id: "PSP-077"
kind: "source-science"
title: "SQLite documentation and source"
...
# SQLite documentation and source
...
- **acquisition_url:** https://sqlite.org/docs.html
- **rights_url:** https://sqlite.org/copyright.html
- **license_or_terms:** SQLite public-domain dedication; verify ancillary docs/assets
- **language:** en
- **jurisdiction:** International/reference
- **format:** HTML/source
- **offline_method:** official source/documentation archive
- **tier:** L1
- **safety_class:** S0_OBSERVE_READ
...
- **notes:** Low-dependency local databases.
