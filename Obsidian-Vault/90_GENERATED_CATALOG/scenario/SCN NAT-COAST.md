...
- **scenario_id:** NAT-COAST
- **family:** NAT
- **name_ru:** Штормовой нагон высокие волны или береговая эрозия
- **scope:** COASTAL
...
- **decision_condition_notes:** Не приближаться к берегу ради наблюдения
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-NAV|NAV]], [[XW XW-SHEL|SHEL]], [[XW XW-TRANS|TRANS]], [[XW XW-COM|COM]]
- **spatial_need_codes:** COASTAL_HAZARD|ELEVATION|NO_GO
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** COAST
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** IPMA_APA_ANEPC
...
- **notes:** Не приближаться к берегу ради наблюдения
- **source_ids:** TBD
