---
id: "GEN-TECHNOLOGY-UNREADABLE"
kind: "scenario"
title: "GEN-TECHNOLOGY-UNREADABLE"
...
- **scenario_id:** GEN-TECHNOLOGY-UNREADABLE
- **family:** GEN
- **name_ru:** Формат носитель или среда выполнения стали нечитаемыми
- **scope:** INSTITUTION
- **trigger_class:** READ_OR_FORMAT_FAILURE
- **first_decision_class:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_sequence:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_condition_notes:** Original сохраняется; migration проверяется
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-INFO|INFO]], [[XW XW-CYB|CYB]], [[XW XW-TOOL|TOOL]], [[XW XW-ENE|ENE]]
- **spatial_need_codes:** READER|MIGRATION|EMULATION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Original сохраняется; migration проверяется
- **source_ids:** TBD
