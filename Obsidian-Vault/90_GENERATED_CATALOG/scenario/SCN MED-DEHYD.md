...
- **scenario_id:** MED-DEHYD
- **family:** MED
- **name_ru:** Обезвоживание, диарея или рвота: оценка красных флагов
- **scope:** PERSON_OR_CLUSTER
- **trigger_class:** SYMPTOM
- **first_decision_class:** ASSESS_RED_FLAGS
- **decision_sequence:** ASSESS_RED_FLAGS
- **decision_condition_notes:** 112 только при угрозе жизни; иначе срочность определяется по красным флагам, возрасту, беременности, сопутствующим состояниям и актуальной клинической маршрутизации
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-ILL|MED-ILL]], [[XW XW-WAT|WAT]], [[XW XW-SAN|SAN]], [[XW XW-FOOD|FOOD]]
- **spatial_need_codes:** WATER_SOURCE|MEDICAL_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** WHO_NATIONAL_HEALTH
...
- **notes:** 112 только при угрозе жизни; иначе срочность определяется по красным флагам, возрасту, беременности, сопутствующим состояниям и актуальной клинической маршрутизации
- **source_ids:** TBD
