...
- **scenario_id:** OPS-KEY-PERSON
- **family:** OPS
- **name_ru:** Координатор водитель caregiver или навигатор недоступен
- **scope:** GROUP
- **trigger_class:** ROLE_FAILURE
- **first_decision_class:** REUNIFY_AND_ACCOUNT
- **decision_sequence:** REUNIFY_AND_ACCOUNT
- **decision_condition_notes:** Succession или minimal safe mode
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-GOV|GOV]], [[XW XW-TRANS|TRANS]], [[XW XW-MED-NCD|MED-NCD]], [[XW XW-NAV|NAV]]
- **spatial_need_codes:** MEETUP|EVAC_ROUTE|EXTERNAL_HELP
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** не заполнено
- **group_size_scope:** N2_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** ROLE_SPECIFIC_AUTHORITY
...
- **notes:** Succession или minimal safe mode
- **source_ids:** TBD
