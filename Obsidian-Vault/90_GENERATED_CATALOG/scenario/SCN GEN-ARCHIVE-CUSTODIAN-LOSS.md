---
id: "GEN-ARCHIVE-CUSTODIAN-LOSS"
kind: "scenario"
title: "GEN-ARCHIVE-CUSTODIAN-LOSS"
...
- **scenario_id:** GEN-ARCHIVE-CUSTODIAN-LOSS
- **family:** GEN
- **name_ru:** Потеря хранителя ключей прав или каталога
- **scope:** INSTITUTION
- **trigger_class:** CUSTODIAN_LOSS
- **first_decision_class:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_sequence:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_condition_notes:** Не раскрывать secrets без законного succession
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-INFO|INFO]], [[XW XW-CYB|CYB]], [[XW XW-DOC|DOC]], [[XW XW-GOV|GOV]]
- **spatial_need_codes:** OFFSITE_COPY|EXTERNAL_CUSTODIAN
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Не раскрывать secrets без законного succession
- **source_ids:** TBD
