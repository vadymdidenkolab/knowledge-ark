...
- **scenario_id:** OPS-SEPARATION
- **family:** OPS
- **name_ru:** Группа разделилась или потеряла участника
- **scope:** GROUP
- **trigger_class:** ACCOUNTABILITY_FAILURE
- **first_decision_class:** REUNIFY_AND_ACCOUNT
- **decision_sequence:** REUNIFY_AND_ACCOUNT
- **decision_condition_notes:** Не искать в опасной зоне без служб
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-GOV|GOV]], [[XW XW-COM|COM]], [[XW XW-NAV|NAV]], [[XW XW-SAFE|SAFE]]
- **spatial_need_codes:** MEETUP|LAST_KNOWN|ROUTE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** POLICE_112_AS_APPLICABLE
...
- **notes:** Не искать в опасной зоне без служб
- **source_ids:** TBD
