...
- **scenario_id:** MED-TRAUMA
- **family:** MED
- **name_ru:** Тяжёлая травма падение или ДТП
- **scope:** PERSON_OR_MULTI
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Не входить в опасную зону ради помощи
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-TRANS|TRANS]], [[XW XW-COM|COM]], [[XW XW-GOV|GOV]]
- **spatial_need_codes:** MEDICAL_ACCESS|ROAD|EXACT_LOCATION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Не входить в опасную зону ради помощи
- **source_ids:** TBD
