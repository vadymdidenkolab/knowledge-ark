...
- **scenario_id:** TEC-UNKNOWN-ITEM
- **family:** TEC
- **name_ru:** Неизвестный порошок контейнер или подозрительный предмет
- **scope:** LOCAL
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Не трогать не нюхать не перемещать
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-PPE|PPE]], [[XW XW-COM|COM]], [[XW XW-SAFE|SAFE]]
...
- **horizon_scope:** E0_E4
- **source_authority_class:** POLICE_FIRE_ANEPC
...
- **notes:** Не трогать не нюхать не перемещать
- **source_ids:** TBD
