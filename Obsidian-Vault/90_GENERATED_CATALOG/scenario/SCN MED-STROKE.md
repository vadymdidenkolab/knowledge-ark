...
- **scenario_id:** MED-STROKE
- **family:** MED
- **name_ru:** Внезапные признаки инсульта
- **scope:** PERSON
- **trigger_class:** SYMPTOM
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Фиксировать время появления признаков
...
- **notes:** Фиксировать время появления признаков
- **source_ids:** TBD
