...
- **scenario_id:** MED-POISON
- **family:** MED
- **name_ru:** Возможное отравление лекарством пищей или веществом
- **scope:** PERSON_OR_MULTI
- **trigger_class:** EXPOSURE_OR_SYMPTOM
- **first_decision_class:** CALL_CIAV
- **decision_sequence:** CALL_CIAV
- **decision_condition_notes:** При угрозе жизни одновременно 112; не вызывать рвоту без указания
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-ILL|MED-ILL]], [[XW XW-COM|COM]], [[XW XW-PPE|PPE]]
- **spatial_need_codes:** EXPOSURE_SITE|MEDICAL_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** CIAV_PLUS_EMERGENCY_MEDICAL
...
- **notes:** При угрозе жизни одновременно 112; не вызывать рвоту без указания
- **source_ids:** TBD
