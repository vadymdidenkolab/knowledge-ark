...
- **scenario_id:** BIO-MOLD
- **family:** BIO
- **name_ru:** Плесень и влажность после затопления
- **scope:** BUILDING_OR_SHELTER
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** ISOLATE_AND_LOCKOUT
- **decision_sequence:** ISOLATE_AND_LOCKOUT
- **decision_condition_notes:** Вход и очистка зависят от безопасности здания и PPE
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-AIR|AIR]], [[XW XW-PPE|PPE]], [[XW XW-HOME|HOME]], [[XW XW-REC|REC]]
- **spatial_need_codes:** FLOOD_ZONE|BUILDING
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** RESPIRATORY_DISEASE
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** DGS_WHO_BUILDING_AUTHORITY
...
- **notes:** Вход и очистка зависят от безопасности здания и PPE
- **source_ids:** TBD
