---
id: "GEN-INTERNAL-CONFLICT"
kind: "scenario"
title: "GEN-INTERNAL-CONFLICT"
...
- **scenario_id:** GEN-INTERNAL-CONFLICT
- **family:** GEN
- **name_ru:** Разрушительный внутренний конфликт и потеря сотрудничества
- **scope:** CELL_TO_INSTITUTION
- **trigger_class:** CONFLICT_ESCALATION
- **first_decision_class:** DISCREET_SAFETY
- **decision_sequence:** DISCREET_SAFETY
- **decision_condition_notes:** Никаких offensive или coercive процедур
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SAFE|SAFE]], [[XW XW-GOV|GOV]], [[XW XW-COMM|COMM]], [[XW XW-MED-MH|MED-MH]]
- **spatial_need_codes:** SAFE_CONTACT|MEDIATION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Никаких offensive или coercive процедур
- **source_ids:** TBD
