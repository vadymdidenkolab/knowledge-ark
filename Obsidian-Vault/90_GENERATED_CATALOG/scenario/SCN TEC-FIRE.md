...
- **scenario_id:** TEC-FIRE
- **family:** TEC
- **name_ru:** Пожар в здании
- **scope:** BUILDING
- **trigger_class:** ALARM_OR_DIRECT_OBSERVATION
- **first_decision_class:** EXIT_AND_DO_NOT_RETURN
- **decision_sequence:** EXIT_AND_DO_NOT_RETURN
- **decision_condition_notes:** Не возвращаться за вещами
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-FIRE|FIRE]], [[XW XW-COM|COM]], [[XW XW-GOV|GOV]], [[SCN MED-TRAUMA|MED-TRAUMA]]
- **spatial_need_codes:** BUILDING_EXIT|ASSEMBLY_POINT|FIRE_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** APARTMENT_HIGH_RISE|MOBILITY_LIMITATION
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** ANEPC_FIRE_SERVICE_BUILDING_AUTHORITY
...
- **notes:** Не возвращаться за вещами
- **source_ids:** TBD
