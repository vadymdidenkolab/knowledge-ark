---
id: "GEN-INSTITUTION-DISSOLUTION"
kind: "scenario"
title: "GEN-INSTITUTION-DISSOLUTION"
...
- **scenario_id:** GEN-INSTITUTION-DISSOLUTION
- **family:** GEN
- **name_ru:** Прекращение или распад stewardship-института
- **scope:** INSTITUTION
- **trigger_class:** DISSOLUTION_TRIGGER
- **first_decision_class:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_sequence:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_condition_notes:** Активы и records передаются по lawful rule
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-GOV|GOV]], [[XW XW-LEG|LEG]], [[XW XW-DOC|DOC]], [[XW XW-FIN|FIN]], [[XW XW-INFO|INFO]]
- **spatial_need_codes:** LEGAL_SERVICE|SUCCESSOR_INSTITUTION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Активы и records передаются по lawful rule
- **source_ids:** TBD
