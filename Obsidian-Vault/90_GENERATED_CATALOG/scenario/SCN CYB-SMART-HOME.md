...
- **scenario_id:** CYB-SMART-HOME
- **family:** CYB
- **name_ru:** Отказ умного замка автоматики или удалённого управления
- **scope:** BUILDING
- **trigger_class:** ACCESS_OR_CONTROL_FAILURE
- **first_decision_class:** ISOLATE_AND_LOCKOUT
- **decision_sequence:** ISOLATE_AND_LOCKOUT
- **decision_condition_notes:** Нужен безопасный ручной fallback
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-HOME|HOME]], [[XW XW-FIRE|FIRE]], [[XW XW-CYB|CYB]], [[XW XW-ENE|ENE]]
- **spatial_need_codes:** BUILDING_EXIT|MANUAL_CONTROL
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** MANUFACTURER_BUILDING_AUTHORITY
...
- **notes:** Нужен безопасный ручной fallback
- **source_ids:** TBD
