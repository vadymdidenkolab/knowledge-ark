...
- **scenario_id:** INF-GAS-FUEL
- **family:** INF
- **name_ru:** Прекращение газа топлива или безопасной готовки
...
- **decision_condition_notes:** Не переносить горение в жилой объём
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-FOOD|FOOD]], [[XW XW-ENE|ENE]], [[XW XW-FIRE|FIRE]], [[XW XW-FIN|FIN]]
- **spatial_need_codes:** FUEL|SUPPLY|COOKING_SITE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** UTILITY_OPERATOR_MUNICIPAL
...
- **notes:** Не переносить горение в жилой объём
- **source_ids:** TBD
