...
- **scenario_id:** INF-ROAD
- **family:** INF
- **name_ru:** Закрытие дороги мостов тоннелей или общественного транспорта
- **scope:** LOCAL_TO_REGIONAL
- **trigger_class:** OFFICIAL_NOTICE_OR_DIRECT_OBSERVATION
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Резерв не должен иметь тот же chokepoint
...
- **spatial_need_codes:** ROAD|CLOSURE|CHOKEPOINT|ALT_ROUTE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** ROAD_OPERATOR_POLICE_ANEPC
...
- **notes:** Резерв не должен иметь тот же chokepoint
- **source_ids:** TBD
