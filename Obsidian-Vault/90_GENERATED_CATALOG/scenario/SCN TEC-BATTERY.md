...
- **scenario_id:** TEC-BATTERY
- **family:** TEC
- **name_ru:** Пожар или thermal runaway аккумулятора
...
- **decision_condition_notes:** Тип батареи и действия требуют карточки производителя/служб
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-FIRE|FIRE]], [[XW XW-ENE|ENE]], [[XW XW-PPE|PPE]], [[XW XW-COM|COM]]
- **spatial_need_codes:** BUILDING_EXIT|HAZMAT_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** FIRE_SERVICE_MANUFACTURER
...
- **notes:** Тип батареи и действия требуют карточки производителя/служб
- **source_ids:** TBD
