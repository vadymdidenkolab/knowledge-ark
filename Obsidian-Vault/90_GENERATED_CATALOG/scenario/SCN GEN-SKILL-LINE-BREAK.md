---
id: "GEN-SKILL-LINE-BREAK"
kind: "scenario"
title: "GEN-SKILL-LINE-BREAK"
...
- **scenario_id:** GEN-SKILL-LINE-BREAK
- **family:** GEN
- **name_ru:** Потеря критической компетенции и линии обучения
- **scope:** CELL_TO_INSTITUTION
- **trigger_class:** HOLDER_LOSS_OR_ASSESSMENT_FAILURE
- **first_decision_class:** ASSESS_DEPENDENCIES
- **decision_sequence:** ASSESS_DEPENDENCIES
- **decision_condition_notes:** Снизить scope до minimal-safe-mode
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-EDU|EDU]], [[XW XW-TOOL|TOOL]], [[XW XW-INFO|INFO]], [[XW XW-COMM|COMM]]
- **spatial_need_codes:** TRAINING|EXTERNAL_SPECIALIST
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Снизить scope до minimal-safe-mode
- **source_ids:** TBD
