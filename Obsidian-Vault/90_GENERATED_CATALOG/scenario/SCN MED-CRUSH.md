...
- **scenario_id:** MED-CRUSH
- **family:** MED
- **name_ru:** Сдавление или crush injury
- **scope:** PERSON_OR_MULTI
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Не проводить опасное освобождение без координации
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-COM|COM]], [[XW XW-GOV|GOV]]
- **spatial_need_codes:** RESCUE_ACCESS|MEDICAL_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** PROFESSIONAL_RESCUE_MEDICAL
...
- **notes:** Не проводить опасное освобождение без координации
- **source_ids:** TBD
