...
- **scenario_id:** NAT-COLD
- **family:** NAT
- **name_ru:** Экстремальный холод снег или лёд
...
- **decision_condition_notes:** Горение внутри создаёт CO-риск
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SHEL|SHEL]], [[XW XW-ENE|ENE]], [[XW XW-MED-ILL|MED-ILL]], [[XW XW-TRANS|TRANS]]
- **spatial_need_codes:** COLD|ROAD|WARMING_SITE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** IPMA_DGS_ANEPC
...
- **notes:** Горение внутри создаёт CO-риск
- **source_ids:** TBD
