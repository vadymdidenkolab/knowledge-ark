...
- **scenario_id:** INF-WATER-CONTAM
- **family:** INF
- **name_ru:** Официальное или подозреваемое загрязнение водопровода
- **scope:** HOUSEHOLD_TO_MUNICIPAL
- **trigger_class:** OFFICIAL_NOTICE_OR_OBSERVATION
- **first_decision_class:** ISOLATE_AND_LOCKOUT
- **decision_sequence:** ISOLATE_AND_LOCKOUT
- **decision_condition_notes:** Кипячение не исправляет любой тип загрязнения
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-WAT|WAT]], [[XW XW-SAN|SAN]], [[XW XW-INFO|INFO]], [[XW XW-MED-ILL|MED-ILL]]
- **spatial_need_codes:** WATER_DISTRIBUTION|OFFICIAL_ZONE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** WATER_OPERATOR_DGS_APA
...
- **notes:** Кипячение не исправляет любой тип загрязнения
- **source_ids:** TBD
