...
- **scenario_id:** CYB-DATA
- **family:** CYB
- **name_ru:** Удаление порча или потеря данных
- **scope:** PERSON_TO_HOUSEHOLD
- **trigger_class:** RESTORE_FAILURE_OR_MISSING_DATA
- **first_decision_class:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_sequence:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_condition_notes:** Backup не доказан без restore-test
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-CYB|CYB]], [[XW XW-INFO|INFO]], [[XW XW-DOC|DOC]]
- **spatial_need_codes:** OFFSITE_BACKUP|TRUSTED_DEVICE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E4
- **source_authority_class:** CISA_NATIONAL_CYBER_AUTHORITY
