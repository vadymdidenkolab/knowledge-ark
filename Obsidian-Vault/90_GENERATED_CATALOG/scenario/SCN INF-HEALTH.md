...
- **scenario_id:** INF-HEALTH
- **family:** INF
- **name_ru:** Перегрузка или недоступность здравоохранения и аптек
...
- **decision_condition_notes:** Continuity plan до кризиса
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-NCD|MED-NCD]], [[XW XW-MED-ILL|MED-ILL]], [[XW XW-TRANS|TRANS]], [[XW XW-COM|COM]]
- **spatial_need_codes:** HEALTHCARE|PHARMACY|ALT_REGION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** SNS_DGS_MUNICIPAL
...
- **notes:** Continuity plan до кризиса
- **source_ids:** TBD
