...
- **scenario_id:** CYB-ACCOUNT
- **family:** CYB
- **name_ru:** Блокировка аккаунта или утрата MFA
- **scope:** PERSON_OR_HOUSEHOLD
- **trigger_class:** ACCESS_FAILURE
- **first_decision_class:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_sequence:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_condition_notes:** Recovery-коды офлайн и наследуемая процедура
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-CYB|CYB]], [[XW XW-DOC|DOC]], [[XW XW-FIN|FIN]]
- **spatial_need_codes:** TRUSTED_SERVICE|ADMIN
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** SERVICE_PROVIDER
...
- **notes:** Recovery-коды офлайн и наследуемая процедура
- **source_ids:** TBD
