...
- **scenario_id:** MED-BLEED
- **family:** MED
- **name_ru:** Массивное наружное кровотечение или признаки внутреннего
- **scope:** PERSON
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Средства только в пределах навыка
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-PPE|PPE]], [[XW XW-COM|COM]]
...
- **notes:** Средства только в пределах навыка
- **source_ids:** TBD
