...
- **scenario_id:** BIO-FOOD
- **family:** BIO
- **name_ru:** Пищевое отравление или cluster
...
- **decision_condition_notes:** Сохранить идентификацию партии без повторного употребления
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-FOOD|FOOD]], [[XW XW-MED-ILL|MED-ILL]], [[XW XW-SAN|SAN]], [[XW XW-INFO|INFO]]
- **spatial_need_codes:** SUPPLY_SOURCE|HEALTHCARE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** FOOD_AUTHORITY_DGS_WHO
...
- **notes:** Сохранить идентификацию партии без повторного употребления
- **source_ids:** TBD
