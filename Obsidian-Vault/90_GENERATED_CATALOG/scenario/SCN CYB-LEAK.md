...
- **scenario_id:** CYB-LEAK
- **family:** CYB
- **name_ru:** Утечка персональных медицинских или адресных данных
- **scope:** PERSON_TO_GROUP
- **trigger_class:** BREACH_NOTICE_OR_DIRECT_OBSERVATION
- **first_decision_class:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_sequence:** PRESERVE_EVIDENCE_AND_RECOVER
- **decision_condition_notes:** Оценить физические точки и доступы которые раскрыты
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-CYB|CYB]], [[XW XW-SAFE|SAFE]], [[XW XW-DOC|DOC]], [[XW XW-LEG|LEG]]
- **spatial_need_codes:** POLICE|REGULATOR|ADMIN
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** DATA_PROTECTION_AUTHORITY_POLICE
...
- **notes:** Оценить физические точки и доступы которые раскрыты
- **source_ids:** TBD
