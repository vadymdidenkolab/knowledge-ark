...
- **scenario_id:** CYB-DISINFO
- **family:** CYB
- **name_ru:** Дезинформация подмена официального сообщения или deepfake
- **scope:** LOCAL_TO_GLOBAL
- **trigger_class:** CONFLICTING_MESSAGE
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Сверять источник время и применимую территорию
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-INFO|INFO]], [[XW XW-COM|COM]], [[XW XW-GOV|GOV]], [[XW XW-SAFE|SAFE]]
- **spatial_need_codes:** OFFICIAL_SOURCE|CURRENT_ZONE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** ANEPC_DGS_GOVERNMENT_PRIMARY_SOURCE
...
- **notes:** Сверять источник время и применимую территорию
- **source_ids:** TBD
