...
- **scenario_id:** SEC-CRIME
- **family:** SEC
- **name_ru:** Кража грабёж или преступление в моменте
- **scope:** PERSON_OR_BUILDING
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Приоритет уход дистанция и помощь
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SAFE|SAFE]], [[XW XW-COM|COM]], [[XW XW-DOC|DOC]]
- **spatial_need_codes:** SAFE_EXIT|POLICE|EXACT_LOCATION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** POLICE_112
...
- **notes:** Приоритет уход дистанция и помощь
- **source_ids:** TBD
