...
- **scenario_id:** NAT-AVALANCHE
- **family:** NAT
- **name_ru:** Лавина или снежный склон
- **scope:** LOCAL
...
- **decision_condition_notes:** Только для применимой территории и с профильной подготовкой
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-NAV|NAV]], [[XW XW-PPE|PPE]], [[XW XW-COM|COM]], [[XW XW-TRANS|TRANS]]
- **spatial_need_codes:** AVALANCHE|SLOPE|NO_GO
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** MOUNTAIN
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** REGIONAL_MOUNTAIN_RESCUE_MET_SERVICE
...
- **notes:** Только для применимой территории и с профильной подготовкой
- **source_ids:** TBD
