...
- **scenario_id:** SOC-HOME-LOSS
- **family:** SOC
- **name_ru:** Потеря жилья пожар наводнение выселение или непригодность
- **scope:** HOUSEHOLD
- **trigger_class:** DIRECT_OBSERVATION_OR_OFFICIAL_NOTICE
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Сохранить доказательства без входа в опасное здание
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SHEL|SHEL]], [[XW XW-DOC|DOC]], [[XW XW-FIN|FIN]], [[XW XW-REC|REC]], [[XW XW-SAFE|SAFE]]
- **spatial_need_codes:** SHELTER|ADMIN|INSURER
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** PET|ACCESSIBILITY
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** MUNICIPAL_SOCIAL_INSURER_LEGAL
...
- **notes:** Сохранить доказательства без входа в опасное здание
- **source_ids:** TBD
