...
- **scenario_id:** ENV-CROP
- **family:** ENV
- **name_ru:** Неурожай вредители или болезнь растений
- **scope:** HOUSEHOLD_TO_REGIONAL
- **trigger_class:** OBSERVATION_OR_OFFICIAL_ALERT
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Не использовать запрещённые средства
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-AGR|AGR]], [[XW XW-FOOD|FOOD]], [[XW XW-PRES|PRES]], [[XW XW-FIN|FIN]]
- **spatial_need_codes:** LAND_USE|WATER|SUPPLY
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E4
- **source_authority_class:** AGRICULTURE_AUTHORITY_EXTENSION
...
- **notes:** Не использовать запрещённые средства
- **source_ids:** TBD
