...
- **scenario_id:** SEC-CONFLICT
- **family:** SEC
- **name_ru:** Вооружённый конфликт обстрел или вынужденное перемещение
- **scope:** REGIONAL_TO_SYSTEMIC
...
- **decision_condition_notes:** Мины и UXO отдельный default-deny контур
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SAFE|SAFE]], [[XW XW-SHEL|SHEL]], [[XW XW-NAV|NAV]], [[XW XW-DOC|DOC]], [[XW XW-MED-NCD|MED-NCD]]
- **spatial_need_codes:** OFFICIAL_ZONE|SHELTER|BORDER|EVAC_ROUTE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** DISPLACED
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** CIVIL_PROTECTION_GOVERNMENT_HUMANITARIAN
...
- **notes:** Мины и UXO отдельный default-deny контур
- **source_ids:** TBD
