...
- **scenario_id:** SEC-MISSING
- **family:** SEC
- **name_ru:** Пропавший человек ребёнок или животное
- **scope:** LOCAL_TO_REGIONAL
- **trigger_class:** MISSED_ACCOUNTABILITY
- **first_decision_class:** REUNIFY_AND_ACCOUNT
- **decision_sequence:** REUNIFY_AND_ACCOUNT
- **decision_condition_notes:** Не создавать новых пострадавших самовольным поиском
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-GOV|GOV]], [[XW XW-COM|COM]], [[XW XW-NAV|NAV]], [[XW XW-SAFE|SAFE]], [[XW XW-PET|PET]]
- **spatial_need_codes:** LAST_KNOWN|ROUTE|POLICE|MEETUP
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** POLICE_112_ANIMAL_AUTHORITY_AS_APPLICABLE
...
- **notes:** Не создавать новых пострадавших самовольным поиском
- **source_ids:** TBD
