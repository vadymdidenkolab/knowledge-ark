---
id: "SEC-MASS-VIOLENCE"
kind: "scenario"
title: "SEC-MASS-VIOLENCE"
...
- **scenario_id:** SEC-MASS-VIOLENCE
- **family:** SEC
- **name_ru:** Массовое насилие или террористический инцидент
- **scope:** LOCAL_TO_MULTI
- **trigger_class:** DIRECT_OBSERVATION_OR_OFFICIAL_ALERT
- **first_decision_class:** ESCAPE_OR_PROTECTIVE_SHELTER
- **decision_sequence:** ESCAPE_OR_PROTECTIVE_SHELTER>CALL_112_WHEN_SAFE>REUNIFY_AND_ACCOUNT
- **decision_condition_notes:** Немедленная физическая защита предшествует звонку, если звонок задерживает уход или раскрывает позицию
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SAFE|SAFE]], [[XW XW-COM|COM]], [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-GOV|GOV]]
- **spatial_need_codes:** NO_GO|POLICE|MEDICAL_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** POLICE_ANEPC_MEDICAL
...
- **notes:** Без наступательных или оружейных инструкций
- **source_ids:** TBD
