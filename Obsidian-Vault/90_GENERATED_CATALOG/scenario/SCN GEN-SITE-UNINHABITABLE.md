---
id: "GEN-SITE-UNINHABITABLE"
kind: "scenario"
title: "GEN-SITE-UNINHABITABLE"
...
- **scenario_id:** GEN-SITE-UNINHABITABLE
- **family:** GEN
- **name_ru:** Площадка стала длительно непригодной
- **scope:** SITE_TO_REGIONAL
- **trigger_class:** SAFETY_OR_LEGAL_THRESHOLD
- **first_decision_class:** SHELTER_OR_EVACUATE_PER_OFFICIAL_DIRECTION
- **decision_sequence:** SHELTER_OR_EVACUATE_PER_OFFICIAL_DIRECTION
- **decision_condition_notes:** Жизнь и закон выше sunk cost
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SHEL|SHEL]], [[XW XW-REC|REC]], [[XW XW-NAV|NAV]], [[XW XW-TRANS|TRANS]], [[XW XW-LEG|LEG]]
- **spatial_need_codes:** ALTERNATE_SITE|ROUTE|AUTHORITY
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Жизнь и закон выше sunk cost
- **source_ids:** TBD
