...
- **scenario_id:** ENV-ANIMAL
- **family:** ENV
- **name_ru:** Болезнь или гибель животных
- **scope:** HOUSEHOLD_TO_REGIONAL
- **trigger_class:** SYMPTOM_OR_OFFICIAL_ALERT
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Ветеринарный и человеческий контуры разделены
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-PET|PET]], [[XW XW-FOOD|FOOD]], [[XW XW-PPE|PPE]], [[XW XW-SAN|SAN]]
- **spatial_need_codes:** VET|QUARANTINE|SUPPLY
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** PET|LIVESTOCK
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** VETERINARY_AGRICULTURE_AUTHORITY
...
- **notes:** Ветеринарный и человеческий контуры разделены
- **source_ids:** TBD
