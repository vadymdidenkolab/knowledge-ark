...
- **scenario_id:** BIO-WOUND
- **family:** BIO
- **name_ru:** Признаки инфекции раны: оценка красных флагов
- **scope:** PERSON
- **trigger_class:** SYMPTOM
- **first_decision_class:** ASSESS_RED_FLAGS
- **decision_sequence:** ASSESS_RED_FLAGS
- **decision_condition_notes:** 112 только при угрозе жизни; иначе требуется проверенная клиническая маршрутизация; домашняя хирургия запрещена
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-MED-ILL|MED-ILL]], [[XW XW-SAN|SAN]]
- **spatial_need_codes:** MEDICAL_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** NATIONAL_HEALTH_IFRC
...
- **notes:** 112 только при угрозе жизни; иначе требуется проверенная клиническая маршрутизация; домашняя хирургия запрещена
- **source_ids:** TBD
