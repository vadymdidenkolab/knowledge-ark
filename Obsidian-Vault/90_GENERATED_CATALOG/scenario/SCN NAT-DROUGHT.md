...
- **scenario_id:** NAT-DROUGHT
- **family:** NAT
- **name_ru:** Засуха и длительный дефицит воды
- **scope:** REGIONAL_TO_LONG_TERM
- **trigger_class:** OFFICIAL_STATUS_OR_SUPPLY_DECLINE
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Законность водозабора и качество проверяются отдельно
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-WAT|WAT]], [[XW XW-FOOD|FOOD]], [[XW XW-AGR|AGR]], [[XW XW-FIN|FIN]], [[XW XW-GOV|GOV]]
- **spatial_need_codes:** WATER_RESOURCE|RESTRICTION|FIRE_HAZARD
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E3_E4
- **source_authority_class:** APA_IPMA_MUNICIPAL
...
- **notes:** Законность водозабора и качество проверяются отдельно
- **source_ids:** TBD
