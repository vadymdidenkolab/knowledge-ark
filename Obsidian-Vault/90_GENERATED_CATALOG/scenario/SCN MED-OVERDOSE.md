...
- **scenario_id:** MED-OVERDOSE
- **family:** MED
- **name_ru:** Передозировка или интоксикация веществом
- **scope:** PERSON_OR_MULTI
- **trigger_class:** EXPOSURE_OR_SYMPTOM
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Спасательное средство только по закону протоколу и обучению
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-ILL|MED-ILL]], [[XW XW-COM|COM]], [[XW XW-SAFE|SAFE]]
...
- **horizon_scope:** E0_E4
- **source_authority_class:** EMERGENCY_MEDICAL_TOXICOLOGY
...
- **notes:** Спасательное средство только по закону протоколу и обучению
- **source_ids:** TBD
