...
- **scenario_id:** SOC-DEATH
- **family:** SOC
- **name_ru:** Смерть утрата и последующие процедуры
- **scope:** HOUSEHOLD_TO_MULTI
- **trigger_class:** PROFESSIONAL_CONFIRMATION_OR_EVENT
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Не импровизировать юридические или медицинские процедуры
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-DEAD|DEAD]], [[XW XW-DOC|DOC]], [[XW XW-LEG|LEG]], [[XW XW-MED-MH|MED-MH]], [[XW XW-REC|REC]]
- **spatial_need_codes:** HEALTHCARE|POLICE|ADMIN
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** HEALTH_POLICE_MUNICIPAL_LEGAL
...
- **notes:** Не импровизировать юридические или медицинские процедуры
- **source_ids:** TBD
