...
- **scenario_id:** MED-ARREST
- **family:** MED
- **name_ru:** Нет нормального дыхания или подозрение на остановку кровообращения
- **scope:** PERSON
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Действия только по диспетчеру или актуальному курсу
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-BLS|MED-BLS]], [[XW XW-COM|COM]], [[XW XW-GOV|GOV]]
...
- **horizon_scope:** E0_E4
- **source_authority_class:** ERC_PLUS_LOCAL_EMERGENCY_SYSTEM
...
- **notes:** Действия только по диспетчеру или актуальному курсу
- **source_ids:** TBD
