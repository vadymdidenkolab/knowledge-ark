...
- **scenario_id:** TEC-COLLAPSE
- **family:** TEC
- **name_ru:** Обрушение или серьёзное повреждение здания
- **scope:** BUILDING_OR_LOCAL
...
- **decision_condition_notes:** Не проводить самовольный structural search
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SHEL|SHEL]], [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-COM|COM]], [[XW XW-NAV|NAV]]
- **spatial_need_codes:** BUILDING|NO_GO|RESCUE_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** ANEPC_FIRE_ENGINEERING_MUNICIPAL
...
- **notes:** Не проводить самовольный structural search
- **source_ids:** TBD
