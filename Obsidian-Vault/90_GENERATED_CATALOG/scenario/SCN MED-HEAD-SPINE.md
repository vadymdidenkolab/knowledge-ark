...
- **scenario_id:** MED-HEAD-SPINE
- **family:** MED
- **name_ru:** Травма головы шеи или позвоночника
- **scope:** PERSON
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Перемещение только по необходимости безопасности и навыку
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-COM|COM]], [[XW XW-TRANS|TRANS]]
- **spatial_need_codes:** MEDICAL_ACCESS|EVAC_ROUTE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** ANTICOAGULATION
...
- **notes:** Перемещение только по необходимости безопасности и навыку
- **source_ids:** TBD
