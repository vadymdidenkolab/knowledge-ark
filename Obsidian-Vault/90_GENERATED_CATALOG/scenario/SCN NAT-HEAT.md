...
- **scenario_id:** NAT-HEAT
- **family:** NAT
- **name_ru:** Экстремальная жара
- **scope:** LOCAL_TO_REGIONAL
- **trigger_class:** OFFICIAL_WARNING_OR_TEMPERATURE
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Лекарства и хронические болезни требуют персонального плана
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-ILL|MED-ILL]], [[XW XW-WAT|WAT]], [[XW XW-SHEL|SHEL]], [[XW XW-ENE|ENE]]
- **spatial_need_codes:** HEAT|COOLING_SITE|WATER|HEALTHCARE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** AGE_PROFILE|CHRONIC_DISEASE
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** IPMA_DGS_MUNICIPAL
...
- **notes:** Лекарства и хронические болезни требуют персонального плана
- **source_ids:** TBD
