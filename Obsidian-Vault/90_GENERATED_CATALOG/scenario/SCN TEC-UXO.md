...
- **scenario_id:** TEC-UXO
- **family:** TEC
- **name_ru:** Мина боеприпас или неразорвавшийся предмет
- **scope:** LOCAL_TO_CONFLICT
- **trigger_class:** DIRECT_OBSERVATION_OR_OFFICIAL_ALERT
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Не приближаться и не маркировать рядом физически
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SAFE|SAFE]], [[XW XW-NAV|NAV]], [[XW XW-COM|COM]]
- **spatial_need_codes:** NO_GO|EXACT_LOCATION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** CONFLICT
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** POLICE_MILITARY_CIVIL_PROTECTION
...
- **notes:** Не приближаться и не маркировать рядом физически
- **source_ids:** TBD
