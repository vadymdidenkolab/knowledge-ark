...
- **scenario_id:** TEC-EXPLOSION
- **family:** TEC
- **name_ru:** Взрыв или blast incident
- **scope:** LOCAL_TO_MULTI
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Учитывать вторичные устройства и неустойчивые конструкции
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[SCN MED-TRAUMA|MED-TRAUMA]], [[XW XW-FIRE|FIRE]], [[XW XW-NAV|NAV]], [[XW XW-COM|COM]]
- **spatial_need_codes:** NO_GO|RESCUE_ACCESS|MEDICAL_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** ANEPC_FIRE_POLICE_MEDICAL
...
- **notes:** Учитывать вторичные устройства и неустойчивые конструкции
- **source_ids:** TBD
