...
- **scenario_id:** SOC-ISOLATION
- **family:** SOC
- **name_ru:** Длительная изоляция горе или разрушение распорядка
- **scope:** PERSON_TO_GROUP
- **trigger_class:** DURATION_OR_SYMPTOM
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Суицидальный риск имеет отдельный срочный маршрут
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-MH|MED-MH]], [[XW XW-COMM|COMM]], [[XW XW-EDU|EDU]], [[XW XW-SAFE|SAFE]]
- **spatial_need_codes:** HEALTHCARE|COMMUNITY|SAFE_SPACE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** ALONE
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** HEALTH_SOCIAL_COMMUNITY
...
- **notes:** Суицидальный риск имеет отдельный срочный маршрут
- **source_ids:** TBD
