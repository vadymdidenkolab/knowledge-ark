...
- **scenario_id:** NAT-VOLC
- **family:** NAT
- **name_ru:** Вулканическое событие пепел газ или лава
...
- **decision_condition_notes:** Применимо прежде всего к соответствующей территории
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-AIR|AIR]], [[XW XW-PPE|PPE]], [[XW XW-SHEL|SHEL]], [[XW XW-NAV|NAV]], [[XW XW-WAT|WAT]]
- **spatial_need_codes:** VOLCANIC|EVAC_ROUTE|AIR_QUALITY
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** ISLAND
- **group_size_scope:** N1_TO_N7
- **horizon_scope:** E0_E4
- **source_authority_class:** REGIONAL_CIVIL_PROTECTION_VOLCANO_OBSERVATORY
...
- **notes:** Применимо прежде всего к соответствующей территории
- **source_ids:** TBD
