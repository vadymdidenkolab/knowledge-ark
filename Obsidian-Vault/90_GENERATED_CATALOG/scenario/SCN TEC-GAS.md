...
- **scenario_id:** TEC-GAS
- **family:** TEC
- **name_ru:** Утечка горючего газа
- **scope:** BUILDING_OR_LOCAL
- **trigger_class:** ODOR_ALARM_OR_OFFICIAL_NOTICE
- **first_decision_class:** EXIT_AND_DO_NOT_RETURN
- **decision_sequence:** EXIT_AND_DO_NOT_RETURN
- **decision_condition_notes:** Не создавать искру
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-FIRE|FIRE]], [[XW XW-COM|COM]], [[XW XW-HOME|HOME]]
- **spatial_need_codes:** BUILDING_EXIT|UTILITY_ZONE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** GAS_OPERATOR_ANEPC_FIRE_SERVICE
