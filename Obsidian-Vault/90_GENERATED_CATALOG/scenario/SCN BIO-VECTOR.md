...
- **scenario_id:** BIO-VECTOR
- **family:** BIO
- **name_ru:** Болезни комаров клещей и других переносчиков
- **scope:** PERSON_TO_REGIONAL
- **trigger_class:** SEASONAL_ALERT_OR_SYMPTOM
- **first_decision_class:** OFFICIAL_DIRECTION
- **decision_sequence:** OFFICIAL_DIRECTION
- **decision_condition_notes:** Профилактика и симптомы по локальному виду
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-PPE|PPE]], [[XW XW-SHEL|SHEL]], [[XW XW-MED-ILL|MED-ILL]], [[XW XW-INFO|INFO]]
- **spatial_need_codes:** VECTOR_RISK|HEALTHCARE
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **notes:** Профилактика и симптомы по локальному виду
- **source_ids:** TBD
