...
- **scenario_id:** MED-AIRWAY
- **family:** MED
- **name_ru:** Удушье или острая проблема дыхательных путей
- **scope:** PERSON
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Не заменяет очное обучение
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-BLS|MED-BLS]], [[XW XW-COM|COM]]
...
- **notes:** Не заменяет очное обучение
- **source_ids:** TBD
