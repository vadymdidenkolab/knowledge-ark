...
- **scenario_id:** INF-HOUSING
- **family:** INF
- **name_ru:** Непригодность жилья или массовое временное размещение
...
- **decision_condition_notes:** Объект не считается открытым без подтверждения
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-SHEL|SHEL]], [[XW XW-DOC|DOC]], [[XW XW-FIN|FIN]], [[XW XW-SAN|SAN]], [[XW XW-SAFE|SAFE]]
- **spatial_need_codes:** SHELTER|HOUSING|REUNIFICATION
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** MUNICIPAL_ANEPC_SOCIAL_SERVICES
...
- **notes:** Объект не считается открытым без подтверждения
- **source_ids:** TBD
