...
- **scenario_id:** MED-DROWN
- **family:** MED
- **name_ru:** Утопление или инцидент в воде
- **scope:** PERSON_OR_MULTI
- **trigger_class:** DIRECT_OBSERVATION
- **first_decision_class:** CALL_112
- **decision_sequence:** CALL_112
- **decision_condition_notes:** Не становиться второй жертвой
- **decision_sequence_status:** INDEX_ONLY_NOT_REVIEWED
- **capability_ids:** [[XW XW-MED-BLS|MED-BLS]], [[XW XW-PPE|PPE]], [[XW XW-COM|COM]]
- **spatial_need_codes:** WATER_ACCESS|RESCUE_ACCESS
- **map_ids:** TBD
- **route_ids:** TBD
- **site_ids:** TBD
- **modifier_codes:** COLD
...
- **horizon_scope:** E0_E4
- **source_authority_class:** ERC_PLUS_PROFESSIONAL_RESCUE
...
- **notes:** Не становиться второй жертвой
- **source_ids:** TBD
