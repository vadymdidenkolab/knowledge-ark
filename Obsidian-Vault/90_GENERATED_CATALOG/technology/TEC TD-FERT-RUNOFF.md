...
id: "TD-FERT-RUNOFF"
kind: "technology"
title: "Сток; вымывание и защита воды"
...
- **node_id:** TD-FERT-RUNOFF
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Сток; вымывание и защита воды
- **outcome:** Иметь измеримую и проверяемую способность: сток; вымывание и защита воды
- **safety_class:** S2_TRAINED_SUPERVISED
