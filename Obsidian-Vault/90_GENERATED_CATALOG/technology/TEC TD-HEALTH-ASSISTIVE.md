---
id: "TD-HEALTH-ASSISTIVE"
kind: "technology"
title: "Очки; слуховые аппараты; кресла; ходунки и протезы"
...
# Очки; слуховые аппараты; кресла; ходунки и протезы
...
- **node_id:** TD-HEALTH-ASSISTIVE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** MATERIAL
- **title_ru:** Очки; слуховые аппараты; кресла; ходунки и протезы
- **outcome:** Иметь измеримую и проверяемую способность: очки; слуховые аппараты; кресла; ходунки и протезы
- **safety_class:** S2_TRAINED_SUPERVISED
