---
id: "TD-CONSTRUCTION-FLOOD"
kind: "technology"
title: "Наводнение; отметки и водоустойчивость"
...
# Наводнение; отметки и водоустойчивость
...
- **node_id:** TD-CONSTRUCTION-FLOOD
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** SITE_DATA
- **title_ru:** Наводнение; отметки и водоустойчивость
- **outcome:** Иметь измеримую и проверяемую способность: наводнение; отметки и водоустойчивость
- **safety_class:** S3_LICENSED_PROFESSIONAL
