...
id: "TD-AGRI-SOIL-OM"
kind: "technology"
title: "Органическое вещество и структура почвы"
...
- **node_id:** TD-AGRI-SOIL-OM
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Органическое вещество и структура почвы
- **outcome:** Иметь измеримую и проверяемую способность: органическое вещество и структура почвы
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
