---
id: "TD-HEALTH-URINARY"
kind: "technology"
title: "Острая задержка мочи и срочная маршрутизация"
...
# Острая задержка мочи и срочная маршрутизация
...
- **node_id:** TD-HEALTH-URINARY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Острая задержка мочи и срочная маршрутизация
- **outcome:** Иметь измеримую и проверяемую способность: острая задержка мочи и срочная маршрутизация
- **safety_class:** S3_LICENSED_PROFESSIONAL
