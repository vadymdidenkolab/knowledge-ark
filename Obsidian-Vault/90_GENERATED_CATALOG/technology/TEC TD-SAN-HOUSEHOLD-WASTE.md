---
id: "TD-SAN-HOUSEHOLD-WASTE"
kind: "technology"
title: "Твёрдые бытовые отходы"
...
- **node_id:** TD-SAN-HOUSEHOLD-WASTE
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Твёрдые бытовые отходы
- **outcome:** Иметь измеримую и проверяемую способность: твёрдые бытовые отходы
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
