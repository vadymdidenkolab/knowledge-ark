---
id: "TD-HEALTH-GRIEF-CAREGIVER"
kind: "technology"
title: "Горе; нагрузка caregiver и психологическая поддержка"
...
# Горе; нагрузка caregiver и психологическая поддержка
...
- **node_id:** TD-HEALTH-GRIEF-CAREGIVER
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Горе; нагрузка caregiver и психологическая поддержка
- **outcome:** Иметь измеримую и проверяемую способность: горе; нагрузка caregiver и психологическая поддержка
- **safety_class:** S2_TRAINED_SUPERVISED
