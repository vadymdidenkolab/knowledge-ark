---
id: "TD-HEALTH-RABIES-TETANUS"
kind: "technology"
title: "Риск бешенства и столбняка; история вакцинации и referral"
...
# Риск бешенства и столбняка; история вакцинации и referral
...
- **node_id:** TD-HEALTH-RABIES-TETANUS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Риск бешенства и столбняка; история вакцинации и referral
- **outcome:** Иметь измеримую и проверяемую способность: риск бешенства и столбняка; история вакцинации и referral
- **safety_class:** S3_LICENSED_PROFESSIONAL
