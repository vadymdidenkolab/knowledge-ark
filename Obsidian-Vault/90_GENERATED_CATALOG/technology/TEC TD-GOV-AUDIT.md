...
id: "TD-GOV-AUDIT"
kind: "technology"
title: "Независимый аудит решений и ресурсов"
...
# Независимый аудит решений и ресурсов
...
- **node_id:** TD-GOV-AUDIT
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** GOVERNANCE
- **title_ru:** Независимый аудит решений и ресурсов
- **outcome:** Иметь измеримую и проверяемую способность: независимый аудит решений и ресурсов
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
