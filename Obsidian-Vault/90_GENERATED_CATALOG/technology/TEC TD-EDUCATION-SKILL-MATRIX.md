---
id: "TD-EDUCATION-SKILL-MATRIX"
kind: "technology"
title: "Матрица навыков; роли и дублёры"
...
# Матрица навыков; роли и дублёры
...
- **node_id:** TD-EDUCATION-SKILL-MATRIX
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** GOVERNANCE
- **title_ru:** Матрица навыков; роли и дублёры
- **outcome:** Иметь измеримую и проверяемую способность: матрица навыков; роли и дублёры
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
