---
id: "TD-TRANSPORT-PAYLOAD"
kind: "technology"
title: "Полезная нагрузка и центр тяжести"
...
# Полезная нагрузка и центр тяжести
...
- **node_id:** TD-TRANSPORT-PAYLOAD
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TEST
- **title_ru:** Полезная нагрузка и центр тяжести
- **outcome:** Иметь измеримую и проверяемую способность: полезная нагрузка и центр тяжести
- **safety_class:** S2_TRAINED_SUPERVISED
