---
id: "TD-HEALTH-P4-DEVICE-MAKE"
kind: "technology"
title: "Регулируемое производство медицинских изделий"
...
# Регулируемое производство медицинских изделий
...
- **node_id:** TD-HEALTH-P4-DEVICE-MAKE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Регулируемое производство медицинских изделий
- **outcome:** Иметь измеримую и проверяемую способность: регулируемое производство медицинских изделий
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
