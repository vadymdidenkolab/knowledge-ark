---
id: "TD-HEALTH-DROWNING"
kind: "technology"
title: "Утопление и инцидент в воде"
...
- **node_id:** TD-HEALTH-DROWNING
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Утопление и инцидент в воде
- **outcome:** Иметь измеримую и проверяемую способность: утопление и инцидент в воде
- **safety_class:** S2_TRAINED_SUPERVISED
