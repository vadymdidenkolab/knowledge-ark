---
id: "TD-EDUCATION-PREREQ"
kind: "technology"
title: "Предварительные знания и допуски"
...
# Предварительные знания и допуски
...
- **node_id:** TD-EDUCATION-PREREQ
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** GOVERNANCE
- **title_ru:** Предварительные знания и допуски
- **outcome:** Иметь измеримую и проверяемую способность: предварительные знания и допуски
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
