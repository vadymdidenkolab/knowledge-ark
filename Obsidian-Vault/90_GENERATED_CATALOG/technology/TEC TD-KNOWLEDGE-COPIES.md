---
id: "TD-KNOWLEDGE-COPIES"
kind: "technology"
title: "Независимые локальные и offsite копии"
...
# Независимые локальные и offsite копии
...
- **node_id:** TD-KNOWLEDGE-COPIES
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** MATERIAL
- **title_ru:** Независимые локальные и offsite копии
- **outcome:** Иметь измеримую и проверяемую способность: независимые локальные и offsite копии
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
