---
id: "TD-HEALTH-CONT-ANTICOAG"
kind: "technology"
title: "Антикоагуляция и person-specific plan"
...
# Антикоагуляция и person-specific plan
...
- **node_id:** TD-HEALTH-CONT-ANTICOAG
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Антикоагуляция и person-specific plan
- **outcome:** Иметь измеримую и проверяемую способность: антикоагуляция и person-specific plan
- **safety_class:** S3_LICENSED_PROFESSIONAL
