---
id: "TD-TRANSPORT-BICYCLE"
kind: "technology"
title: "Велосипед и грузовая конфигурация"
...
# Велосипед и грузовая конфигурация
...
- **node_id:** TD-TRANSPORT-BICYCLE
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TOOL
- **title_ru:** Велосипед и грузовая конфигурация
- **outcome:** Иметь измеримую и проверяемую способность: велосипед и грузовая конфигурация
- **safety_class:** S2_TRAINED_SUPERVISED
