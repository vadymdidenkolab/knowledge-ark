---
id: "TD-AGRI-VARIETY-STATUS"
kind: "technology"
title: "OP; landrace; F1 hybrid и правовой статус сорта"
...
# OP; landrace; F1 hybrid и правовой статус сорта
...
- **node_id:** TD-AGRI-VARIETY-STATUS
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** SITE_DATA
- **title_ru:** OP; landrace; F1 hybrid и правовой статус сорта
- **outcome:** Иметь измеримую и проверяемую способность: op; landrace; f1 hybrid и правовой статус сорта
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
