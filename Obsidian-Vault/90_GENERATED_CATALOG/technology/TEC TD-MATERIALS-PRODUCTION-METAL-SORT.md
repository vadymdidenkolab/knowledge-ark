---
id: "TD-MATERIALS-PRODUCTION-METAL-SORT"
kind: "technology"
title: "Идентификация и сортировка металлолома"
...
# Идентификация и сортировка металлолома
...
- **node_id:** TD-MATERIALS-PRODUCTION-METAL-SORT
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Идентификация и сортировка металлолома
- **outcome:** Иметь измеримую и проверяемую способность: идентификация и сортировка металлолома
- **safety_class:** S3_LICENSED_PROFESSIONAL
