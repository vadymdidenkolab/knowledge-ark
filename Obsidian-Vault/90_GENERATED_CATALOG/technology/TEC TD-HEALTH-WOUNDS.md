...
id: "TD-HEALTH-WOUNDS"
kind: "technology"
title: "Малые раны; перевязочный цикл и красные флаги"
...
# Малые раны; перевязочный цикл и красные флаги
...
- **node_id:** TD-HEALTH-WOUNDS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Малые раны; перевязочный цикл и красные флаги
- **outcome:** Иметь измеримую и проверяемую способность: малые раны; перевязочный цикл и красные флаги
- **safety_class:** S2_TRAINED_SUPERVISED
