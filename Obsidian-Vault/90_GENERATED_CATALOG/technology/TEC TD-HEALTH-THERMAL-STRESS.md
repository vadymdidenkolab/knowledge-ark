---
id: "TD-HEALTH-THERMAL-STRESS"
kind: "technology"
title: "Гипотермия; перегрев и тепловая болезнь"
...
# Гипотермия; перегрев и тепловая болезнь
...
- **node_id:** TD-HEALTH-THERMAL-STRESS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Гипотермия; перегрев и тепловая болезнь
- **outcome:** Иметь измеримую и проверяемую способность: гипотермия; перегрев и тепловая болезнь
- **safety_class:** S2_TRAINED_SUPERVISED
