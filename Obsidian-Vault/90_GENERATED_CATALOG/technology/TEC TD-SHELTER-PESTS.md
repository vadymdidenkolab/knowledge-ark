...
id: "TD-SHELTER-PESTS"
kind: "technology"
title: "Вредители; точки входа и безопасный контроль"
...
# Вредители; точки входа и безопасный контроль
...
- **node_id:** TD-SHELTER-PESTS
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** PROCESS
- **title_ru:** Вредители; точки входа и безопасный контроль
- **outcome:** Иметь измеримую и проверяемую способность: вредители; точки входа и безопасный контроль
- **safety_class:** S2_TRAINED_SUPERVISED
