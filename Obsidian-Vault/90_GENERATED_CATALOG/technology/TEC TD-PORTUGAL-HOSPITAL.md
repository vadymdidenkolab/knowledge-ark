---
id: "TD-PORTUGAL-HOSPITAL"
kind: "technology"
title: "Ближайшие больницы; centros de saúde и аптеки"
...
# Ближайшие больницы; centros de saúde и аптеки
...
- **node_id:** TD-PORTUGAL-HOSPITAL
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** SITE_DATA
- **title_ru:** Ближайшие больницы; centros de saúde и аптеки
- **outcome:** Иметь измеримую и проверяемую способность: ближайшие больницы; centros de saúde и аптеки
- **safety_class:** S0_OBSERVE_READ
