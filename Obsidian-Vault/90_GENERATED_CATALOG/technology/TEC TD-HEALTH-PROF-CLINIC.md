---
id: "TD-HEALTH-PROF-CLINIC"
kind: "technology"
title: "Clinic design; triage flow; registry; referral и transport"
...
# Clinic design; triage flow; registry; referral и transport
...
- **node_id:** TD-HEALTH-PROF-CLINIC
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Clinic design; triage flow; registry; referral и transport
- **outcome:** Иметь измеримую и проверяемую способность: clinic design; triage flow; registry; referral и transport
- **safety_class:** S3_LICENSED_PROFESSIONAL
