---
id: "TD-TRANSPORT-RESTRAINT"
kind: "technology"
title: "Удерживающие системы детей; людей и животных"
...
# Удерживающие системы детей; людей и животных
...
- **node_id:** TD-TRANSPORT-RESTRAINT
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** MATERIAL
- **title_ru:** Удерживающие системы детей; людей и животных
- **outcome:** Иметь измеримую и проверяемую способность: удерживающие системы детей; людей и животных
- **safety_class:** S2_TRAINED_SUPERVISED
