---
id: "TD-HEALTH-PROF-BIOMED"
kind: "technology"
title: "Biomedical engineering; сервис и вывод приборов"
...
# Biomedical engineering; сервис и вывод приборов
...
- **node_id:** TD-HEALTH-PROF-BIOMED
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Biomedical engineering; сервис и вывод приборов
- **outcome:** Иметь измеримую и проверяемую способность: biomedical engineering; сервис и вывод приборов
- **safety_class:** S3_LICENSED_PROFESSIONAL
