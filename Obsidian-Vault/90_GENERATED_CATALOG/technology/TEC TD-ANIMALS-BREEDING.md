---
id: "TD-ANIMALS-BREEDING"
kind: "technology"
title: "Размножение и генетическое разнообразие"
...
# Размножение и генетическое разнообразие
...
- **node_id:** TD-ANIMALS-BREEDING
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** PROCESS
- **title_ru:** Размножение и генетическое разнообразие
- **outcome:** Иметь измеримую и проверяемую способность: размножение и генетическое разнообразие
- **safety_class:** S3_LICENSED_PROFESSIONAL
