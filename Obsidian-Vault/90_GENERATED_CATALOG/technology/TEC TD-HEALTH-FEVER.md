...
id: "TD-HEALTH-FEVER"
kind: "technology"
title: "Лихорадка с опасными признаками"
...
# Лихорадка с опасными признаками
...
- **node_id:** TD-HEALTH-FEVER
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Лихорадка с опасными признаками
- **outcome:** Иметь измеримую и проверяемую способность: лихорадка с опасными признаками
- **safety_class:** S2_TRAINED_SUPERVISED
