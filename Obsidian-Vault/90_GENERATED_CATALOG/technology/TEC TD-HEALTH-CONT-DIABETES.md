---
id: "TD-HEALTH-CONT-DIABETES"
kind: "technology"
title: "Непрерывность лечения диабета"
...
- **node_id:** TD-HEALTH-CONT-DIABETES
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Непрерывность лечения диабета
- **outcome:** Иметь измеримую и проверяемую способность: непрерывность лечения диабета
- **safety_class:** S3_LICENSED_PROFESSIONAL
