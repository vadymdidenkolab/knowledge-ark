---
id: "TD-FUEL-USE-POWER"
kind: "technology"
title: "Топливо для генерации; выхлоп и CO"
...
# Топливо для генерации; выхлоп и CO
...
- **node_id:** TD-FUEL-USE-POWER
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** PROCESS
- **title_ru:** Топливо для генерации; выхлоп и CO
- **outcome:** Иметь измеримую и проверяемую способность: топливо для генерации; выхлоп и co
- **safety_class:** S3_LICENSED_PROFESSIONAL
