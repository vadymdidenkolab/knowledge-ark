---
id: "TD-EDUCATION-SUPERVISED"
kind: "technology"
title: "Практика под надзором"
...
- **node_id:** TD-EDUCATION-SUPERVISED
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** TRAINING
- **title_ru:** Практика под надзором
- **outcome:** Иметь измеримую и проверяемую способность: практика под надзором
- **safety_class:** S2_TRAINED_SUPERVISED
