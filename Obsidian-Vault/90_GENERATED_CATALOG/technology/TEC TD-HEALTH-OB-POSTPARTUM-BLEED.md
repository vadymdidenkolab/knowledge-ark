---
id: "TD-HEALTH-OB-POSTPARTUM-BLEED"
kind: "technology"
...
- **node_id:** TD-HEALTH-OB-POSTPARTUM-BLEED
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Послеродовое кровотечение
- **outcome:** Иметь измеримую и проверяемую способность: послеродовое кровотечение
- **safety_class:** S3_LICENSED_PROFESSIONAL
