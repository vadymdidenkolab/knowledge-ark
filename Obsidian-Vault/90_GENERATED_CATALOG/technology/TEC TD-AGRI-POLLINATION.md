---
id: "TD-AGRI-POLLINATION"
kind: "technology"
title: "Опыление и управление опылителями"
...
# Опыление и управление опылителями
...
- **node_id:** TD-AGRI-POLLINATION
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Опыление и управление опылителями
- **outcome:** Иметь измеримую и проверяемую способность: опыление и управление опылителями
- **safety_class:** S2_TRAINED_SUPERVISED
