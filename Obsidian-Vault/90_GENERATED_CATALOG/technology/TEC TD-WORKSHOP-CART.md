...
id: "TD-WORKSHOP-CART"
kind: "technology"
title: "Обслуживание ручной тележки"
...
- **node_id:** TD-WORKSHOP-CART
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** MAINTENANCE
- **title_ru:** Обслуживание ручной тележки
- **outcome:** Иметь измеримую и проверяемую способность: обслуживание ручной тележки
- **safety_class:** S2_TRAINED_SUPERVISED
