---
id: "TD-HEALTH-CONT-RESP"
kind: "technology"
title: "Непрерывность лечения астмы и COPD"
...
# Непрерывность лечения астмы и COPD
...
- **node_id:** TD-HEALTH-CONT-RESP
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Непрерывность лечения астмы и COPD
- **outcome:** Иметь измеримую и проверяемую способность: непрерывность лечения астмы и copd
- **safety_class:** S3_LICENSED_PROFESSIONAL
