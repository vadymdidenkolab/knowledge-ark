...
id: "TD-FERT-LEGUMES"
kind: "technology"
title: "Бобовые; покровные культуры и сидераты"
...
# Бобовые; покровные культуры и сидераты
...
- **node_id:** TD-FERT-LEGUMES
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Бобовые; покровные культуры и сидераты
- **outcome:** Иметь измеримую и проверяемую способность: бобовые; покровные культуры и сидераты
- **safety_class:** S2_TRAINED_SUPERVISED
