---
id: "TD-ANIMALS-SLAUGHTER"
kind: "technology"
title: "Убой; ветеринарный контроль и пищевая безопасность"
...
# Убой; ветеринарный контроль и пищевая безопасность
...
- **node_id:** TD-ANIMALS-SLAUGHTER
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Убой; ветеринарный контроль и пищевая безопасность
- **outcome:** Иметь измеримую и проверяемую способность: убой; ветеринарный контроль и пищевая безопасность
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
