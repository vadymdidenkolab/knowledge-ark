---
id: "TD-HEALTH-BLS-DROWNING"
kind: "technology"
title: "Реанимация после утопления по очному курсу"
...
# Реанимация после утопления по очному курсу
...
- **node_id:** TD-HEALTH-BLS-DROWNING
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Реанимация после утопления по очному курсу
- **outcome:** Иметь измеримую и проверяемую способность: реанимация после утопления по очному курсу
- **safety_class:** S2_TRAINED_SUPERVISED
