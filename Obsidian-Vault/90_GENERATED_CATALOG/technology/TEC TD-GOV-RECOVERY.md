...
id: "TD-GOV-RECOVERY"
kind: "technology"
title: "After-action review и восстановление"
...
# After-action review и восстановление
...
- **node_id:** TD-GOV-RECOVERY
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** PROCESS
- **title_ru:** After-action review и восстановление
- **outcome:** Иметь измеримую и проверяемую способность: after-action review и восстановление
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
