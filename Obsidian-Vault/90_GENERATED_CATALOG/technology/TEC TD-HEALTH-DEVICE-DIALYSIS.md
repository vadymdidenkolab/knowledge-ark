---
id: "TD-HEALTH-DEVICE-DIALYSIS"
kind: "technology"
title: "Потеря диализа или почечной поддержки"
...
# Потеря диализа или почечной поддержки
...
- **node_id:** TD-HEALTH-DEVICE-DIALYSIS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Потеря диализа или почечной поддержки
- **outcome:** Иметь измеримую и проверяемую способность: потеря диализа или почечной поддержки
- **safety_class:** S3_LICENSED_PROFESSIONAL
