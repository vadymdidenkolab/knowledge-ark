---
id: "TD-FERT-MICRONUTRIENTS"
kind: "technology"
title: "Микроэлементы и риск передозировки"
...
# Микроэлементы и риск передозировки
...
- **node_id:** TD-FERT-MICRONUTRIENTS
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Микроэлементы и риск передозировки
- **outcome:** Иметь измеримую и проверяемую способность: микроэлементы и риск передозировки
- **safety_class:** S3_LICENSED_PROFESSIONAL
