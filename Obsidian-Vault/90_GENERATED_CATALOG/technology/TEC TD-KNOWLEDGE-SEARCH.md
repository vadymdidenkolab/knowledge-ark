---
id: "TD-KNOWLEDGE-SEARCH"
kind: "technology"
title: "Локальный полнотекстовый индекс"
...
# Локальный полнотекстовый индекс
...
- **node_id:** TD-KNOWLEDGE-SEARCH
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** PROCESS
- **title_ru:** Локальный полнотекстовый индекс
- **outcome:** Иметь измеримую и проверяемую способность: локальный полнотекстовый индекс
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
