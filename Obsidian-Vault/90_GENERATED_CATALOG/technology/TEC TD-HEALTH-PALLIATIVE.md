---
id: "TD-HEALTH-PALLIATIVE"
kind: "technology"
title: "Паллиативная поддержка; достоинство и advance plan"
...
# Паллиативная поддержка; достоинство и advance plan
...
- **node_id:** TD-HEALTH-PALLIATIVE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Паллиативная поддержка; достоинство и advance plan
- **outcome:** Иметь измеримую и проверяемую способность: паллиативная поддержка; достоинство и advance plan
- **safety_class:** S3_LICENSED_PROFESSIONAL
