---
id: "TD-WORKSHOP-POST-TEST"
kind: "technology"
title: "Послеремонтное испытание и карантин брака"
...
# Послеремонтное испытание и карантин брака
...
- **node_id:** TD-WORKSHOP-POST-TEST
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** TEST
- **title_ru:** Послеремонтное испытание и карантин брака
- **outcome:** Иметь измеримую и проверяемую способность: послеремонтное испытание и карантин брака
- **safety_class:** S2_TRAINED_SUPERVISED
