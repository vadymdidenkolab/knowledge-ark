---
id: "TD-MATERIALS-PRODUCTION-METAL-COLD"
kind: "technology"
title: "Холодная обработка и механические соединения металла"
...
# Холодная обработка и механические соединения металла
...
- **node_id:** TD-MATERIALS-PRODUCTION-METAL-COLD
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Холодная обработка и механические соединения металла
- **outcome:** Иметь измеримую и проверяемую способность: холодная обработка и механические соединения металла
- **safety_class:** S3_LICENSED_PROFESSIONAL
