---
id: "TD-CONSTRUCTION-INSULATION"
kind: "technology"
title: "Теплоизоляция и безопасные материалы"
...
# Теплоизоляция и безопасные материалы
...
- **node_id:** TD-CONSTRUCTION-INSULATION
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Теплоизоляция и безопасные материалы
- **outcome:** Иметь измеримую и проверяемую способность: теплоизоляция и безопасные материалы
- **safety_class:** S3_LICENSED_PROFESSIONAL
