---
id: "TD-HEALTH-PROF-EPIDEMIOLOGY"
kind: "technology"
title: "Эпидемиология; surveillance и outbreak management"
...
# Эпидемиология; surveillance и outbreak management
...
- **node_id:** TD-HEALTH-PROF-EPIDEMIOLOGY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Эпидемиология; surveillance и outbreak management
- **outcome:** Иметь измеримую и проверяемую способность: эпидемиология; surveillance и outbreak management
- **safety_class:** S3_LICENSED_PROFESSIONAL
