...
id: "TD-COMMS-LOG"
kind: "technology"
title: "Журнал сообщений; время и решения"
...
# Журнал сообщений; время и решения
...
- **node_id:** TD-COMMS-LOG
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** GOVERNANCE
- **title_ru:** Журнал сообщений; время и решения
- **outcome:** Иметь измеримую и проверяемую способность: журнал сообщений; время и решения
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
