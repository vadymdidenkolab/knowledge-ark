---
id: "TD-HEALTH-PROF-ANATOMY"
kind: "technology"
title: "Профессиональная анатомия; физиология и патология"
...
# Профессиональная анатомия; физиология и патология
...
- **node_id:** TD-HEALTH-PROF-ANATOMY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Профессиональная анатомия; физиология и патология
- **outcome:** Иметь измеримую и проверяемую способность: профессиональная анатомия; физиология и патология
- **safety_class:** S3_LICENSED_PROFESSIONAL
