---
id: "TD-ENVIRONMENT-FIRE"
kind: "technology"
title: "Природный пожар; дым и эвакуация"
...
# Природный пожар; дым и эвакуация
...
- **node_id:** TD-ENVIRONMENT-FIRE
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** SITE_DATA
- **title_ru:** Природный пожар; дым и эвакуация
- **outcome:** Иметь измеримую и проверяемую способность: природный пожар; дым и эвакуация
- **safety_class:** S3_LICENSED_PROFESSIONAL
