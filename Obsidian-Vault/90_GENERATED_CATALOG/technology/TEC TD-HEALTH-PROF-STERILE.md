---
id: "TD-HEALTH-PROF-STERILE"
kind: "technology"
title: "Стерилизация и healthcare facility IPC"
...
# Стерилизация и healthcare facility IPC
...
- **node_id:** TD-HEALTH-PROF-STERILE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Стерилизация и healthcare facility IPC
- **outcome:** Иметь измеримую и проверяемую способность: стерилизация и healthcare facility ipc
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
