---
id: "TD-PORTUGAL-RADIO"
kind: "technology"
title: "Радио; частоты; мощность и лицензии"
...
# Радио; частоты; мощность и лицензии
...
- **node_id:** TD-PORTUGAL-RADIO
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Радио; частоты; мощность и лицензии
- **outcome:** Иметь измеримую и проверяемую способность: радио; частоты; мощность и лицензии
- **safety_class:** S3_LICENSED_PROFESSIONAL
