...
- **node_id:** TD-AGRI-CLEAN
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Очистка семян и урожая
- **outcome:** Иметь измеримую и проверяемую способность: очистка семян и урожая
- **safety_class:** S2_TRAINED_SUPERVISED
