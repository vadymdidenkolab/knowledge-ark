---
id: "TD-MATERIALS-PRODUCTION-FASTENER"
kind: "technology"
title: "Крепёж и стандартные резьбы"
...
- **node_id:** TD-MATERIALS-PRODUCTION-FASTENER
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** MATERIAL
- **title_ru:** Крепёж и стандартные резьбы
- **outcome:** Иметь измеримую и проверяемую способность: крепёж и стандартные резьбы
- **safety_class:** S2_TRAINED_SUPERVISED
