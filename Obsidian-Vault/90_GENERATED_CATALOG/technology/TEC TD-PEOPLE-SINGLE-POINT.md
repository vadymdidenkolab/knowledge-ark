---
id: "TD-PEOPLE-SINGLE-POINT"
kind: "technology"
title: "Одиночный оператор и human single points of failure"
...
# Одиночный оператор и human single points of failure
...
- **node_id:** TD-PEOPLE-SINGLE-POINT
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** TEST
- **title_ru:** Одиночный оператор и human single points of failure
- **outcome:** Иметь измеримую и проверяемую способность: одиночный оператор и human single points of failure
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
