...
id: "TD-PORTUGAL-BURN"
kind: "technology"
title: "Ограничения сжигания и пожарный период"
...
# Ограничения сжигания и пожарный период
...
- **node_id:** TD-PORTUGAL-BURN
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Ограничения сжигания и пожарный период
- **outcome:** Иметь измеримую и проверяемую способность: ограничения сжигания и пожарный период
- **safety_class:** S3_LICENSED_PROFESSIONAL
