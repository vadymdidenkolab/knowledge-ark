---
id: "TD-HEALTH-BITES-STINGS"
kind: "technology"
title: "Укусы; ужаления и аллергический риск"
...
# Укусы; ужаления и аллергический риск
...
- **node_id:** TD-HEALTH-BITES-STINGS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Укусы; ужаления и аллергический риск
- **outcome:** Иметь измеримую и проверяемую способность: укусы; ужаления и аллергический риск
- **safety_class:** S2_TRAINED_SUPERVISED
