...
id: "TD-COMMS-MESSAGE"
kind: "technology"
title: "Короткий формат сообщения и read-back"
...
# Короткий формат сообщения и read-back
...
- **node_id:** TD-COMMS-MESSAGE
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** PROCESS
- **title_ru:** Короткий формат сообщения и read-back
- **outcome:** Иметь измеримую и проверяемую способность: короткий формат сообщения и read-back
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
