---
id: "TD-HEALTH-FROSTBITE"
kind: "technology"
title: "Переохлаждение и обморожение"
...
- **node_id:** TD-HEALTH-FROSTBITE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Переохлаждение и обморожение
- **outcome:** Иметь измеримую и проверяемую способность: переохлаждение и обморожение
- **safety_class:** S2_TRAINED_SUPERVISED
