...
id: "TD-FUEL-USE-HEAT"
kind: "technology"
title: "Топливо для тепла и измеренный расход"
...
# Топливо для тепла и измеренный расход
...
- **node_id:** TD-FUEL-USE-HEAT
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** PROCESS
- **title_ru:** Топливо для тепла и измеренный расход
- **outcome:** Иметь измеримую и проверяемую способность: топливо для тепла и измеренный расход
- **safety_class:** S3_LICENSED_PROFESSIONAL
