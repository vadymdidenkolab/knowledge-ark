---
id: "TD-EDUCATION-CHILD"
kind: "technology"
title: "Безопасная учебная программа для детей"
...
# Безопасная учебная программа для детей
...
- **node_id:** TD-EDUCATION-CHILD
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** GOVERNANCE
- **title_ru:** Безопасная учебная программа для детей
- **outcome:** Иметь измеримую и проверяемую способность: безопасная учебная программа для детей
- **safety_class:** S2_TRAINED_SUPERVISED
