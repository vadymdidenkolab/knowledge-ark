...
- **node_id:** TD-HEALTH-CONT-AUTOIMMUNE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Аутоиммунные заболевания
- **outcome:** Иметь измеримую и проверяемую способность: аутоиммунные заболевания
- **safety_class:** S3_LICENSED_PROFESSIONAL
