---
id: "TD-HEALTH-DEVICE-QC"
kind: "technology"
title: "Контроль; отказ и вывод медицинских приборов"
...
# Контроль; отказ и вывод медицинских приборов
...
- **node_id:** TD-HEALTH-DEVICE-QC
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TEST
- **title_ru:** Контроль; отказ и вывод медицинских приборов
- **outcome:** Иметь измеримую и проверяемую способность: контроль; отказ и вывод медицинских приборов
- **safety_class:** S3_LICENSED_PROFESSIONAL
