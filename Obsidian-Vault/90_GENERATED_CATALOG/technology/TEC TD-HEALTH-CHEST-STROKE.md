---
id: "TD-HEALTH-CHEST-STROKE"
kind: "technology"
title: "Боль в груди и признаки инсульта"
...
# Боль в груди и признаки инсульта
...
- **node_id:** TD-HEALTH-CHEST-STROKE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Боль в груди и признаки инсульта
- **outcome:** Иметь измеримую и проверяемую способность: боль в груди и признаки инсульта
- **safety_class:** S2_TRAINED_SUPERVISED
