---
id: "TD-METRO-TURBIDITY"
kind: "technology"
title: "Мутность как операционный показатель"
...
# Мутность как операционный показатель
...
- **node_id:** TD-METRO-TURBIDITY
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Мутность как операционный показатель
- **outcome:** Иметь измеримую и проверяемую способность: мутность как операционный показатель
- **safety_class:** S2_TRAINED_SUPERVISED
