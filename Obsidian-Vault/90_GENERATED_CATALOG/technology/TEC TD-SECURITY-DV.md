...
id: "TD-SECURITY-DV"
kind: "technology"
title: "Домашнее насилие; конфиденциальный безопасный маршрут"
...
# Домашнее насилие; конфиденциальный безопасный маршрут
...
- **node_id:** TD-SECURITY-DV
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** KNOWLEDGE
- **title_ru:** Домашнее насилие; конфиденциальный безопасный маршрут
- **outcome:** Иметь измеримую и проверяемую способность: домашнее насилие; конфиденциальный безопасный маршрут
- **safety_class:** S3_LICENSED_PROFESSIONAL
