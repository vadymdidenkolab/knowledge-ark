---
id: "TD-WATER-LOWE-PUMP"
kind: "technology"
title: "Низкоэнергетический насос и резерв питания"
...
# Низкоэнергетический насос и резерв питания
...
- **node_id:** TD-WATER-LOWE-PUMP
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Низкоэнергетический насос и резерв питания
- **outcome:** Иметь измеримую и проверяемую способность: низкоэнергетический насос и резерв питания
- **safety_class:** S2_TRAINED_SUPERVISED
