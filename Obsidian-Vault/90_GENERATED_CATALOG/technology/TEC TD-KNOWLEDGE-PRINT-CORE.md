---
id: "TD-KNOWLEDGE-PRINT-CORE"
kind: "technology"
title: "Печатное P0/P1 ядро"
...
- **node_id:** TD-KNOWLEDGE-PRINT-CORE
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** MATERIAL
- **title_ru:** Печатное P0/P1 ядро
- **outcome:** Иметь измеримую и проверяемую способность: печатное p0/p1 ядро
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
