...
id: "TD-FOOD-NO-COOK"
kind: "technology"
title: "Пища без готовки при потере энергии"
...
# Пища без готовки при потере энергии
...
- **node_id:** TD-FOOD-NO-COOK
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Пища без готовки при потере энергии
- **outcome:** Иметь измеримую и проверяемую способность: пища без готовки при потере энергии
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
