...
id: "TD-FOOD-PEST"
kind: "technology"
title: "Защита запасов от вредителей"
...
- **node_id:** TD-FOOD-PEST
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Защита запасов от вредителей
- **outcome:** Иметь измеримую и проверяемую способность: защита запасов от вредителей
- **safety_class:** S2_TRAINED_SUPERVISED
