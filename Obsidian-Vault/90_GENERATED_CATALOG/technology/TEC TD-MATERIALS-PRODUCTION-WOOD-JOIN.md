---
id: "TD-MATERIALS-PRODUCTION-WOOD-JOIN"
kind: "technology"
title: "Деревянные соединения и ремонт"
...
# Деревянные соединения и ремонт
...
- **node_id:** TD-MATERIALS-PRODUCTION-WOOD-JOIN
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Деревянные соединения и ремонт
- **outcome:** Иметь измеримую и проверяемую способность: деревянные соединения и ремонт
- **safety_class:** S2_TRAINED_SUPERVISED
