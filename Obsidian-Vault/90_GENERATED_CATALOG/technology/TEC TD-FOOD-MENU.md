...
id: "TD-FOOD-MENU"
kind: "technology"
title: "Фактическое меню и порции для состава группы"
...
# Фактическое меню и порции для состава группы
...
- **node_id:** TD-FOOD-MENU
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Фактическое меню и порции для состава группы
- **outcome:** Иметь измеримую и проверяемую способность: фактическое меню и порции для состава группы
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
