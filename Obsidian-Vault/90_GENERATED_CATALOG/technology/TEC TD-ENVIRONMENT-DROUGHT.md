---
id: "TD-ENVIRONMENT-DROUGHT"
kind: "technology"
title: "Засуха и водный дефицит"
...
- **node_id:** TD-ENVIRONMENT-DROUGHT
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** SITE_DATA
- **title_ru:** Засуха и водный дефицит
- **outcome:** Иметь измеримую и проверяемую способность: засуха и водный дефицит
- **safety_class:** S2_TRAINED_SUPERVISED
