---
id: "TD-FERT-TRACEABILITY"
kind: "technology"
title: "Партия; состав; применение и результат"
...
# Партия; состав; применение и результат
...
- **node_id:** TD-FERT-TRACEABILITY
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** GOVERNANCE
- **title_ru:** Партия; состав; применение и результат
- **outcome:** Иметь измеримую и проверяемую способность: партия; состав; применение и результат
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
