---
id: "TD-HEALTH-BLS-INFANT"
kind: "technology"
title: "BLS для младенца по очному курсу"
...
# BLS для младенца по очному курсу
...
- **node_id:** TD-HEALTH-BLS-INFANT
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** BLS для младенца по очному курсу
- **outcome:** Иметь измеримую и проверяемую способность: bls для младенца по очному курсу
- **safety_class:** S2_TRAINED_SUPERVISED
