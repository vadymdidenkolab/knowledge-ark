---
id: "TD-WORKSHOP-CONSUMABLES"
kind: "technology"
title: "Расходники и минимальные остатки"
...
- **node_id:** TD-WORKSHOP-CONSUMABLES
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** MATERIAL
- **title_ru:** Расходники и минимальные остатки
- **outcome:** Иметь измеримую и проверяемую способность: расходники и минимальные остатки
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
