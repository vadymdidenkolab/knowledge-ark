...
id: "TD-FOOD-ROTATION"
kind: "technology"
title: "FEFO; сроки; осмотр и пополнение"
...
# FEFO; сроки; осмотр и пополнение
...
- **node_id:** TD-FOOD-ROTATION
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MAINTENANCE
- **title_ru:** FEFO; сроки; осмотр и пополнение
- **outcome:** Иметь измеримую и проверяемую способность: fefo; сроки; осмотр и пополнение
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
