...
id: "TD-KNOWLEDGE-GIS"
kind: "technology"
title: "Офлайн GIS и открытые форматы"
...
- **node_id:** TD-KNOWLEDGE-GIS
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** KNOWLEDGE
- **title_ru:** Офлайн GIS и открытые форматы
- **outcome:** Иметь измеримую и проверяемую способность: офлайн gis и открытые форматы
- **safety_class:** S2_TRAINED_SUPERVISED
