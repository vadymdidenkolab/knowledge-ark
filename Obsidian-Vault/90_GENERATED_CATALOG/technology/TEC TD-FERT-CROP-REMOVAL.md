---
id: "TD-FERT-CROP-REMOVAL"
kind: "technology"
title: "Вынос питательных веществ урожаем"
...
- **node_id:** TD-FERT-CROP-REMOVAL
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Вынос питательных веществ урожаем
- **outcome:** Иметь измеримую и проверяемую способность: вынос питательных веществ урожаем
- **safety_class:** S2_TRAINED_SUPERVISED
