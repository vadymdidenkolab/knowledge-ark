---
id: "TD-CONSTRUCTION-EARTHWORKS"
kind: "technology"
title: "Земляные работы и устойчивость выемок"
...
# Земляные работы и устойчивость выемок
...
- **node_id:** TD-CONSTRUCTION-EARTHWORKS
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Земляные работы и устойчивость выемок
- **outcome:** Иметь измеримую и проверяемую способность: земляные работы и устойчивость выемок
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
