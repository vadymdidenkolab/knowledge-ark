...
id: "TD-ANIMALS-WASTE"
kind: "technology"
title: "Навоз; подстилка и защита воды"
...
- **node_id:** TD-ANIMALS-WASTE
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** PROCESS
- **title_ru:** Навоз; подстилка и защита воды
- **outcome:** Иметь измеримую и проверяемую способность: навоз; подстилка и защита воды
- **safety_class:** S3_LICENSED_PROFESSIONAL
