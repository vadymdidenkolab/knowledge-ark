...
id: "TD-GOV-STOCK"
kind: "technology"
title: "Минимальные остатки; reorder point и ротация"
...
# Минимальные остатки; reorder point и ротация
...
- **node_id:** TD-GOV-STOCK
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** GOVERNANCE
- **title_ru:** Минимальные остатки; reorder point и ротация
- **outcome:** Иметь измеримую и проверяемую способность: минимальные остатки; reorder point и ротация
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
