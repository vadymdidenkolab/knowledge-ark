...
id: "TD-PORTUGAL-IMT"
kind: "technology"
title: "IMT: транспорт и водительские требования"
...
# IMT: транспорт и водительские требования
...
- **node_id:** TD-PORTUGAL-IMT
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** IMT: транспорт и водительские требования
- **outcome:** Иметь измеримую и проверяемую способность: imt: транспорт и водительские требования
- **safety_class:** S0_OBSERVE_READ
