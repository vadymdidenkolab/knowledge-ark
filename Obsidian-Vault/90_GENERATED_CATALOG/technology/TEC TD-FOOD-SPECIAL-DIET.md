---
id: "TD-FOOD-SPECIAL-DIET"
kind: "technology"
title: "Лечебные; возрастные и религиозные диеты"
...
# Лечебные; возрастные и религиозные диеты
...
- **node_id:** TD-FOOD-SPECIAL-DIET
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** SITE_DATA
- **title_ru:** Лечебные; возрастные и религиозные диеты
- **outcome:** Иметь измеримую и проверяемую способность: лечебные; возрастные и религиозные диеты
- **safety_class:** S2_TRAINED_SUPERVISED
