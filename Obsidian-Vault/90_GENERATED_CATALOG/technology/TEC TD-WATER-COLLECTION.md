---
id: "TD-WATER-COLLECTION"
kind: "technology"
title: "Законный сбор воды"
...
- **node_id:** TD-WATER-COLLECTION
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Законный сбор воды
- **outcome:** Иметь измеримую и проверяемую способность: законный сбор воды
- **safety_class:** S2_TRAINED_SUPERVISED
