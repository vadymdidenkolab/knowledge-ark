---
id: "TD-WORKSHOP-LIGHT"
kind: "technology"
title: "Освещение рабочего места"
...
- **node_id:** TD-WORKSHOP-LIGHT
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** MATERIAL
- **title_ru:** Освещение рабочего места
- **outcome:** Иметь измеримую и проверяемую способность: освещение рабочего места
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
