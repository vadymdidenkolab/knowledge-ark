---
id: "TD-ANIMALS-PASTURE"
kind: "technology"
title: "Пастбище и carrying capacity"
...
- **node_id:** TD-ANIMALS-PASTURE
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** SITE_DATA
- **title_ru:** Пастбище и carrying capacity
- **outcome:** Иметь измеримую и проверяемую способность: пастбище и carrying capacity
- **safety_class:** S2_TRAINED_SUPERVISED
