---
id: "TD-CONSTRUCTION-WEATHER"
kind: "technology"
title: "Ветрозащита и водозащитная оболочка"
...
# Ветрозащита и водозащитная оболочка
...
- **node_id:** TD-CONSTRUCTION-WEATHER
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Ветрозащита и водозащитная оболочка
- **outcome:** Иметь измеримую и проверяемую способность: ветрозащита и водозащитная оболочка
- **safety_class:** S3_LICENSED_PROFESSIONAL
