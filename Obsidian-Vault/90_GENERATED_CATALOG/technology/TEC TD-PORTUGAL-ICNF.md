...
id: "TD-PORTUGAL-ICNF"
kind: "technology"
title: "ICNF: лес; пожар и охраняемые территории"
...
# ICNF: лес; пожар и охраняемые территории
...
- **node_id:** TD-PORTUGAL-ICNF
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** ICNF: лес; пожар и охраняемые территории
- **outcome:** Иметь измеримую и проверяемую способность: icnf: лес; пожар и охраняемые территории
- **safety_class:** S0_OBSERVE_READ
