---
id: "TD-PORTUGAL-ENERGY"
kind: "technology"
title: "DGEG/ERSE: энергия и топливо"
...
- **node_id:** TD-PORTUGAL-ENERGY
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** DGEG/ERSE: энергия и топливо
- **outcome:** Иметь измеримую и проверяемую способность: dgeg/erse: энергия и топливо
- **safety_class:** S0_OBSERVE_READ
