---
id: "TD-CONSTRUCTION-PLUMBING"
kind: "technology"
title: "Сантехника; давление и обратный поток"
...
# Сантехника; давление и обратный поток
...
- **node_id:** TD-CONSTRUCTION-PLUMBING
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Сантехника; давление и обратный поток
- **outcome:** Иметь измеримую и проверяемую способность: сантехника; давление и обратный поток
- **safety_class:** S3_LICENSED_PROFESSIONAL
