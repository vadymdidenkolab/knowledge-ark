---
id: "TD-HEALTH-CONT-HEMOPHILIA"
kind: "technology"
title: "Нарушения свёртывания и гемофилия"
...
# Нарушения свёртывания и гемофилия
...
- **node_id:** TD-HEALTH-CONT-HEMOPHILIA
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Нарушения свёртывания и гемофилия
- **outcome:** Иметь измеримую и проверяемую способность: нарушения свёртывания и гемофилия
- **safety_class:** S3_LICENSED_PROFESSIONAL
