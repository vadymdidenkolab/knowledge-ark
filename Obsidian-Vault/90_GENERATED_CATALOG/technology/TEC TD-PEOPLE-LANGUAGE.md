---
id: "TD-PEOPLE-LANGUAGE"
kind: "technology"
title: "Языки; грамотность и доступный формат информации"
...
# Языки; грамотность и доступный формат информации
...
- **node_id:** TD-PEOPLE-LANGUAGE
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** SITE_DATA
- **title_ru:** Языки; грамотность и доступный формат информации
- **outcome:** Иметь измеримую и проверяемую способность: языки; грамотность и доступный формат информации
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
