...
id: "TD-SAN-MEDICAL"
kind: "technology"
title: "Загрязнённые медицинские материалы"
...
# Загрязнённые медицинские материалы
...
- **node_id:** TD-SAN-MEDICAL
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Загрязнённые медицинские материалы
- **outcome:** Иметь измеримую и проверяемую способность: загрязнённые медицинские материалы
- **safety_class:** S3_LICENSED_PROFESSIONAL
