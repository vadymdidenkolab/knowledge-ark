...
id: "TD-AGRI-RESEED"
kind: "technology"
title: "Резерв пересева после отказа"
...
- **node_id:** TD-AGRI-RESEED
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Резерв пересева после отказа
- **outcome:** Иметь измеримую и проверяемую способность: резерв пересева после отказа
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
