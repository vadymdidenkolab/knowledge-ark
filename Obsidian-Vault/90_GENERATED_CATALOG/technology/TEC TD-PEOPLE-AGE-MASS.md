---
id: "TD-PEOPLE-AGE-MASS"
kind: "technology"
title: "Возраст; масса и возрастные ограничения там; где это необходимо"
...
# Возраст; масса и возрастные ограничения там; где это необходимо
...
- **node_id:** TD-PEOPLE-AGE-MASS
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** SITE_DATA
- **title_ru:** Возраст; масса и возрастные ограничения там; где это необходимо
- **outcome:** Иметь измеримую и проверяемую способность: возраст; масса и возрастные ограничения там; где это необходимо
- **safety_class:** S2_TRAINED_SUPERVISED
