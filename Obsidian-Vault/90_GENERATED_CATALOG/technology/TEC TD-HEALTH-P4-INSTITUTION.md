---
id: "TD-HEALTH-P4-INSTITUTION"
kind: "technology"
title: "Преемственность клиники; аптеки; лаборатории и referral network"
...
# Преемственность клиники; аптеки; лаборатории и referral network
...
- **node_id:** TD-HEALTH-P4-INSTITUTION
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Преемственность клиники; аптеки; лаборатории и referral network
- **outcome:** Иметь измеримую и проверяемую способность: преемственность клиники; аптеки; лаборатории и referral network
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
