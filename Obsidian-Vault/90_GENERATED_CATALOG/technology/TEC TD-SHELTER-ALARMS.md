---
id: "TD-SHELTER-ALARMS"
kind: "technology"
title: "Дымовые и CO извещатели; питание и тест"
...
# Дымовые и CO извещатели; питание и тест
...
- **node_id:** TD-SHELTER-ALARMS
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** MAINTENANCE
- **title_ru:** Дымовые и CO извещатели; питание и тест
- **outcome:** Иметь измеримую и проверяемую способность: дымовые и co извещатели; питание и тест
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
