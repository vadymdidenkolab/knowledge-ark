---
id: "TD-HEALTH-PROF-TOX"
kind: "technology"
title: "Клиническая токсикология"
...
- **node_id:** TD-HEALTH-PROF-TOX
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Клиническая токсикология
- **outcome:** Иметь измеримую и проверяемую способность: клиническая токсикология
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
