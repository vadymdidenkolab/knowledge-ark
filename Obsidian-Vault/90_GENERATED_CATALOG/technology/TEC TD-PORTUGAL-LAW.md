...
id: "TD-PORTUGAL-LAW"
kind: "technology"
title: "Diário da República и контроль редакции закона"
...
# Diário da República и контроль редакции закона
...
- **node_id:** TD-PORTUGAL-LAW
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** Diário da República и контроль редакции закона
- **outcome:** Иметь измеримую и проверяемую способность: diário da república и контроль редакции закона
- **safety_class:** S0_OBSERVE_READ
