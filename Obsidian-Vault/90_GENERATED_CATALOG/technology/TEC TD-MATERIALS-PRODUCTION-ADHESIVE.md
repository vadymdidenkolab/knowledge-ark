---
id: "TD-MATERIALS-PRODUCTION-ADHESIVE"
kind: "technology"
title: "Готовые клеи; герметики и покрытия"
...
# Готовые клеи; герметики и покрытия
...
- **node_id:** TD-MATERIALS-PRODUCTION-ADHESIVE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** MATERIAL
- **title_ru:** Готовые клеи; герметики и покрытия
- **outcome:** Иметь измеримую и проверяемую способность: готовые клеи; герметики и покрытия
- **safety_class:** S3_LICENSED_PROFESSIONAL
