---
id: "TD-KNOWLEDGE-MIGRATION"
kind: "technology"
title: "Миграция форматов и носителей"
...
- **node_id:** TD-KNOWLEDGE-MIGRATION
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** PROCESS
- **title_ru:** Миграция форматов и носителей
- **outcome:** Иметь измеримую и проверяемую способность: миграция форматов и носителей
- **safety_class:** S2_TRAINED_SUPERVISED
