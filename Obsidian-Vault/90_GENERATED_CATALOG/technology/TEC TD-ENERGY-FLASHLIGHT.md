---
id: "TD-ENERGY-FLASHLIGHT"
kind: "technology"
title: "Автономные фонари и запас питания"
...
# Автономные фонари и запас питания
...
- **node_id:** TD-ENERGY-FLASHLIGHT
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** MATERIAL
- **title_ru:** Автономные фонари и запас питания
- **outcome:** Иметь измеримую и проверяемую способность: автономные фонари и запас питания
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
