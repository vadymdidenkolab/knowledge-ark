---
id: "TD-METRO-REFERENCE"
kind: "technology"
title: "Reference/check; zero и контрольная точка"
...
# Reference/check; zero и контрольная точка
...
- **node_id:** TD-METRO-REFERENCE
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** TEST
- **title_ru:** Reference/check; zero и контрольная точка
- **outcome:** Иметь измеримую и проверяемую способность: reference/check; zero и контрольная точка
- **safety_class:** S2_TRAINED_SUPERVISED
