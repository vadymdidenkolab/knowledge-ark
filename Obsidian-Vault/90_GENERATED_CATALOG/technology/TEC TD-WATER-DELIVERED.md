---
id: "TD-WATER-DELIVERED"
kind: "technology"
title: "Привозная вода и приёмка партии"
...
# Привозная вода и приёмка партии
...
- **node_id:** TD-WATER-DELIVERED
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Привозная вода и приёмка партии
- **outcome:** Иметь измеримую и проверяемую способность: привозная вода и приёмка партии
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
