---
id: "TD-WORKSHOP-DONOR"
kind: "technology"
title: "Сортировка доноров и карантин неизвестных компонентов"
...
# Сортировка доноров и карантин неизвестных компонентов
...
- **node_id:** TD-WORKSHOP-DONOR
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Сортировка доноров и карантин неизвестных компонентов
- **outcome:** Иметь измеримую и проверяемую способность: сортировка доноров и карантин неизвестных компонентов
- **safety_class:** S2_TRAINED_SUPERVISED
