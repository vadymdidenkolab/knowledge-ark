...
id: "TD-SAN-DIAPERS"
kind: "technology"
title: "Подгузники и детские санитарные потребности"
...
# Подгузники и детские санитарные потребности
...
- **node_id:** TD-SAN-DIAPERS
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** MATERIAL
- **title_ru:** Подгузники и детские санитарные потребности
- **outcome:** Иметь измеримую и проверяемую способность: подгузники и детские санитарные потребности
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
