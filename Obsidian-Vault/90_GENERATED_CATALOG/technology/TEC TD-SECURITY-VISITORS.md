---
id: "TD-SECURITY-VISITORS"
kind: "technology"
title: "Учёт посетителей без незаконного удержания"
...
# Учёт посетителей без незаконного удержания
...
- **node_id:** TD-SECURITY-VISITORS
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** GOVERNANCE
- **title_ru:** Учёт посетителей без незаконного удержания
- **outcome:** Иметь измеримую и проверяемую способность: учёт посетителей без незаконного удержания
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
