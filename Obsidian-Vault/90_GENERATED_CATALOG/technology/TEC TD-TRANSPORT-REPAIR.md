---
id: "TD-TRANSPORT-REPAIR"
kind: "technology"
title: "Ремкомплект и послеремонтная приёмка"
...
# Ремкомплект и послеремонтная приёмка
...
- **node_id:** TD-TRANSPORT-REPAIR
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** MAINTENANCE
- **title_ru:** Ремкомплект и послеремонтная приёмка
- **outcome:** Иметь измеримую и проверяемую способность: ремкомплект и послеремонтная приёмка
- **safety_class:** S3_LICENSED_PROFESSIONAL
