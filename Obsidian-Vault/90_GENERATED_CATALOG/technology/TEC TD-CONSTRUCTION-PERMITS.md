---
id: "TD-CONSTRUCTION-PERMITS"
kind: "technology"
title: "Разрешения; PDM и профессиональные подписи"
...
# Разрешения; PDM и профессиональные подписи
...
- **node_id:** TD-CONSTRUCTION-PERMITS
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** GOVERNANCE
- **title_ru:** Разрешения; PDM и профессиональные подписи
- **outcome:** Иметь измеримую и проверяемую способность: разрешения; pdm и профессиональные подписи
- **safety_class:** S0_OBSERVE_READ
