---
id: "TD-CONSTRUCTION-WALLS"
kind: "technology"
title: "Стены и ненесущие ремонтные работы"
...
# Стены и ненесущие ремонтные работы
...
- **node_id:** TD-CONSTRUCTION-WALLS
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Стены и ненесущие ремонтные работы
- **outcome:** Иметь измеримую и проверяемую способность: стены и ненесущие ремонтные работы
- **safety_class:** S3_LICENSED_PROFESSIONAL
