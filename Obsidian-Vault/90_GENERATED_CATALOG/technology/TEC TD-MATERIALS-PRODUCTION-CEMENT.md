---
id: "TD-MATERIALS-PRODUCTION-CEMENT"
kind: "technology"
title: "Цемент; бетон и контроль смеси"
...
- **node_id:** TD-MATERIALS-PRODUCTION-CEMENT
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Цемент; бетон и контроль смеси
- **outcome:** Иметь измеримую и проверяемую способность: цемент; бетон и контроль смеси
- **safety_class:** S3_LICENSED_PROFESSIONAL
