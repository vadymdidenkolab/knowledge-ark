---
id: "TD-ENERGY-POWERBANK"
kind: "technology"
title: "Сертифицированные power banks"
...
- **node_id:** TD-ENERGY-POWERBANK
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** MATERIAL
- **title_ru:** Сертифицированные power banks
- **outcome:** Иметь измеримую и проверяемую способность: сертифицированные power banks
- **safety_class:** S2_TRAINED_SUPERVISED
