---
id: "TD-WATER-CROSS-CONTAM"
kind: "technology"
title: "Предотвращение перекрёстного загрязнения"
...
- **node_id:** TD-WATER-CROSS-CONTAM
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Предотвращение перекрёстного загрязнения
- **outcome:** Иметь измеримую и проверяемую способность: предотвращение перекрёстного загрязнения
- **safety_class:** S2_TRAINED_SUPERVISED
