---
id: "TD-MATERIALS-PRODUCTION-GLASS-REPAIR"
kind: "technology"
title: "Безопасное обращение; резка и ремонт стекла"
...
# Безопасное обращение; резка и ремонт стекла
...
- **node_id:** TD-MATERIALS-PRODUCTION-GLASS-REPAIR
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Безопасное обращение; резка и ремонт стекла
- **outcome:** Иметь измеримую и проверяемую способность: безопасное обращение; резка и ремонт стекла
- **safety_class:** S3_LICENSED_PROFESSIONAL
