---
id: "TD-WORKSHOP-BICYCLE"
kind: "technology"
title: "Обслуживание велосипеда"
...
- **node_id:** TD-WORKSHOP-BICYCLE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** MAINTENANCE
- **title_ru:** Обслуживание велосипеда
- **outcome:** Иметь измеримую и проверяемую способность: обслуживание велосипеда
- **safety_class:** S2_TRAINED_SUPERVISED
