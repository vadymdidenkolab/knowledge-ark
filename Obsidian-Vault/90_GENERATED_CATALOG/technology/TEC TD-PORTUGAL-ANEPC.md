---
id: "TD-PORTUGAL-ANEPC"
kind: "technology"
title: "ANEPC: риски; планы и предупреждения"
...
# ANEPC: риски; планы и предупреждения
...
- **node_id:** TD-PORTUGAL-ANEPC
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** ANEPC: риски; планы и предупреждения
- **outcome:** Иметь измеримую и проверяемую способность: anepc: риски; планы и предупреждения
- **safety_class:** S0_OBSERVE_READ
