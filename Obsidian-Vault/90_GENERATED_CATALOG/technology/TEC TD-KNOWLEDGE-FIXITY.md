---
id: "TD-KNOWLEDGE-FIXITY"
kind: "technology"
title: "Регулярная fixity-проверка ранее записанных хешей"
...
# Регулярная fixity-проверка ранее записанных хешей
...
- **node_id:** TD-KNOWLEDGE-FIXITY
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** TEST
- **title_ru:** Регулярная fixity-проверка ранее записанных хешей
- **outcome:** Иметь измеримую и проверяемую способность: регулярная fixity-проверка ранее записанных хешей
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
