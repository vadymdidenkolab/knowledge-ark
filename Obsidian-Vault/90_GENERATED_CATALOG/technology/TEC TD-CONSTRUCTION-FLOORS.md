---
id: "TD-CONSTRUCTION-FLOORS"
kind: "technology"
title: "Перекрытия и полы"
...
- **node_id:** TD-CONSTRUCTION-FLOORS
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Перекрытия и полы
- **outcome:** Иметь измеримую и проверяемую способность: перекрытия и полы
- **safety_class:** S3_LICENSED_PROFESSIONAL
