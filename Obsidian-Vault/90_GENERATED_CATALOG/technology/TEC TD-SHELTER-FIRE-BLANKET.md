---
id: "TD-SHELTER-FIRE-BLANKET"
kind: "technology"
title: "Пожарное покрывало и размещение"
...
# Пожарное покрывало и размещение
...
- **node_id:** TD-SHELTER-FIRE-BLANKET
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** TOOL
- **title_ru:** Пожарное покрывало и размещение
- **outcome:** Иметь измеримую и проверяемую способность: пожарное покрывало и размещение
- **safety_class:** S2_TRAINED_SUPERVISED
