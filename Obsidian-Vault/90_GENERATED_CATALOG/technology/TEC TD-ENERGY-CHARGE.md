...
id: "TD-ENERGY-CHARGE"
kind: "technology"
title: "Безопасная зарядка; кабели и совместимость"
...
# Безопасная зарядка; кабели и совместимость
...
- **node_id:** TD-ENERGY-CHARGE
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** PROCESS
- **title_ru:** Безопасная зарядка; кабели и совместимость
- **outcome:** Иметь измеримую и проверяемую способность: безопасная зарядка; кабели и совместимость
- **safety_class:** S2_TRAINED_SUPERVISED
