---
id: "TD-HEALTH-PROF-ENVIRONMENT"
kind: "technology"
title: "Environmental и climate health"
...
# Environmental и climate health
...
- **node_id:** TD-HEALTH-PROF-ENVIRONMENT
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Environmental и climate health
- **outcome:** Иметь измеримую и проверяемую способность: environmental и climate health
- **safety_class:** S3_LICENSED_PROFESSIONAL
