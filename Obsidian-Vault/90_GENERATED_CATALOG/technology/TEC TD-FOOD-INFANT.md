...
id: "TD-FOOD-INFANT"
kind: "technology"
title: "Безопасное питание младенцев"
...
- **node_id:** TD-FOOD-INFANT
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Безопасное питание младенцев
- **outcome:** Иметь измеримую и проверяемую способность: безопасное питание младенцев
- **safety_class:** S3_LICENSED_PROFESSIONAL
