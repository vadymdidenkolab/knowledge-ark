---
id: "TD-HEALTH-MH-AGITATION"
kind: "technology"
title: "Тяжёлое возбуждение и безопасность помощника"
...
# Тяжёлое возбуждение и безопасность помощника
...
- **node_id:** TD-HEALTH-MH-AGITATION
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Тяжёлое возбуждение и безопасность помощника
- **outcome:** Иметь измеримую и проверяемую способность: тяжёлое возбуждение и безопасность помощника
- **safety_class:** S3_LICENSED_PROFESSIONAL
