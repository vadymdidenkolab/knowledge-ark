---
id: "TD-CONSTRUCTION-ELECTRICAL"
kind: "technology"
title: "Стационарная электрика 230 V"
...
- **node_id:** TD-CONSTRUCTION-ELECTRICAL
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Стационарная электрика 230 V
- **outcome:** Иметь измеримую и проверяемую способность: стационарная электрика 230 v
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
