---
id: "TD-PORTUGAL-ANACOM"
kind: "technology"
title: "ANACOM: радио и связь"
...
- **node_id:** TD-PORTUGAL-ANACOM
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** ANACOM: радио и связь
- **outcome:** Иметь измеримую и проверяемую способность: anacom: радио и связь
- **safety_class:** S0_OBSERVE_READ
