---
id: "TD-SHELTER-SAFE-ZONE"
kind: "technology"
title: "Безопасная внутренняя зона"
...
- **node_id:** TD-SHELTER-SAFE-ZONE
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** SITE_DATA
- **title_ru:** Безопасная внутренняя зона
- **outcome:** Иметь измеримую и проверяемую способность: безопасная внутренняя зона
- **safety_class:** S2_TRAINED_SUPERVISED
