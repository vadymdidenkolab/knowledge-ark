---
id: "TD-SHELTER-KITCHEN"
kind: "technology"
title: "Кухонная санитария и безопасное хранение"
...
# Кухонная санитария и безопасное хранение
...
- **node_id:** TD-SHELTER-KITCHEN
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** PROCESS
- **title_ru:** Кухонная санитария и безопасное хранение
- **outcome:** Иметь измеримую и проверяемую способность: кухонная санитария и безопасное хранение
- **safety_class:** S2_TRAINED_SUPERVISED
