---
id: "TD-COMMS-ACCOUNTABILITY"
kind: "technology"
title: "Учёт людей и последнего известного места"
...
# Учёт людей и последнего известного места
...
- **node_id:** TD-COMMS-ACCOUNTABILITY
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** GOVERNANCE
- **title_ru:** Учёт людей и последнего известного места
- **outcome:** Иметь измеримую и проверяемую способность: учёт людей и последнего известного места
- **safety_class:** S2_TRAINED_SUPERVISED
