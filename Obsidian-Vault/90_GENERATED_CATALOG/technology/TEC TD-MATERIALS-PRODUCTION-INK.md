---
id: "TD-MATERIALS-PRODUCTION-INK"
kind: "technology"
title: "Чернила и маркировка"
...
- **node_id:** TD-MATERIALS-PRODUCTION-INK
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Чернила и маркировка
- **outcome:** Иметь измеримую и проверяемую способность: чернила и маркировка
- **safety_class:** S3_LICENSED_PROFESSIONAL
