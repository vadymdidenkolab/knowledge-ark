---
id: "TD-MATERIALS-PRODUCTION-CERAMIC"
kind: "technology"
title: "Керамика; кирпич; черепица и огнеупоры"
...
# Керамика; кирпич; черепица и огнеупоры
...
- **node_id:** TD-MATERIALS-PRODUCTION-CERAMIC
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Керамика; кирпич; черепица и огнеупоры
- **outcome:** Иметь измеримую и проверяемую способность: керамика; кирпич; черепица и огнеупоры
- **safety_class:** S3_LICENSED_PROFESSIONAL
