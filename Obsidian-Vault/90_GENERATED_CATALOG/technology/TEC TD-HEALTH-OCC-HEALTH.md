---
id: "TD-HEALTH-OCC-HEALTH"
kind: "technology"
title: "Шум; пыль; химикаты; вибрация; тепло и усталость"
...
# Шум; пыль; химикаты; вибрация; тепло и усталость
...
- **node_id:** TD-HEALTH-OCC-HEALTH
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Шум; пыль; химикаты; вибрация; тепло и усталость
- **outcome:** Иметь измеримую и проверяемую способность: шум; пыль; химикаты; вибрация; тепло и усталость
- **safety_class:** S3_LICENSED_PROFESSIONAL
