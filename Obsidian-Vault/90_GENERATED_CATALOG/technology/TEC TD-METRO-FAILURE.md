...
id: "TD-METRO-FAILURE"
kind: "technology"
title: "Признаки отказа и ручной fallback"
...
# Признаки отказа и ручной fallback
...
- **node_id:** TD-METRO-FAILURE
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** TEST
- **title_ru:** Признаки отказа и ручной fallback
- **outcome:** Иметь измеримую и проверяемую способность: признаки отказа и ручной fallback
- **safety_class:** S2_TRAINED_SUPERVISED
