...
id: "TD-GOV-COMMUNITY"
kind: "technology"
title: "Межгрупповая кооперация и взаимопомощь"
...
# Межгрупповая кооперация и взаимопомощь
...
- **node_id:** TD-GOV-COMMUNITY
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** GOVERNANCE
- **title_ru:** Межгрупповая кооперация и взаимопомощь
- **outcome:** Иметь измеримую и проверяемую способность: межгрупповая кооперация и взаимопомощь
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
