---
id: "TD-TRANSPORT-ABANDON"
kind: "technology"
title: "Abandonment plan и переход на ручную переноску"
...
# Abandonment plan и переход на ручную переноску
...
- **node_id:** TD-TRANSPORT-ABANDON
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** PROCESS
- **title_ru:** Abandonment plan и переход на ручную переноску
- **outcome:** Иметь измеримую и проверяемую способность: abandonment plan и переход на ручную переноску
- **safety_class:** S2_TRAINED_SUPERVISED
