...
id: "TD-FUEL-SPILL"
kind: "technology"
title: "Разлив; изоляция и законная очистка"
...
# Разлив; изоляция и законная очистка
...
- **node_id:** TD-FUEL-SPILL
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** PROCESS
- **title_ru:** Разлив; изоляция и законная очистка
- **outcome:** Иметь измеримую и проверяемую способность: разлив; изоляция и законная очистка
- **safety_class:** S3_LICENSED_PROFESSIONAL
