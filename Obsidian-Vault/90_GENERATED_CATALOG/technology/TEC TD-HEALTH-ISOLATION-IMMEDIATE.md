---
id: "TD-HEALTH-ISOLATION-IMMEDIATE"
kind: "technology"
title: "Немедленная изоляция симптомного человека"
...
# Немедленная изоляция симптомного человека
...
- **node_id:** TD-HEALTH-ISOLATION-IMMEDIATE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Немедленная изоляция симптомного человека
- **outcome:** Иметь измеримую и проверяемую способность: немедленная изоляция симптомного человека
- **safety_class:** S2_TRAINED_SUPERVISED
