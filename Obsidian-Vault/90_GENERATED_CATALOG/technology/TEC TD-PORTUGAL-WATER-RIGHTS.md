---
id: "TD-PORTUGAL-WATER-RIGHTS"
kind: "technology"
title: "Право на воду; captação; колодец и скважина"
...
# Право на воду; captação; колодец и скважина
...
- **node_id:** TD-PORTUGAL-WATER-RIGHTS
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Право на воду; captação; колодец и скважина
- **outcome:** Иметь измеримую и проверяемую способность: право на воду; captação; колодец и скважина
- **safety_class:** S3_LICENSED_PROFESSIONAL
