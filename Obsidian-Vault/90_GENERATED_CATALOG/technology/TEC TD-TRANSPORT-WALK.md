---
id: "TD-TRANSPORT-WALK"
kind: "technology"
title: "Пешая мобильность и доступность"
...
# Пешая мобильность и доступность
...
- **node_id:** TD-TRANSPORT-WALK
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** PROCESS
- **title_ru:** Пешая мобильность и доступность
- **outcome:** Иметь измеримую и проверяемую способность: пешая мобильность и доступность
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
