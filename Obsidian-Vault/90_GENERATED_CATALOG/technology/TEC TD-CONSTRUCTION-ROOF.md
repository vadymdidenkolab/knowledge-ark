---
id: "TD-CONSTRUCTION-ROOF"
kind: "technology"
title: "Крыша; высота и временная погодозащита"
...
# Крыша; высота и временная погодозащита
...
- **node_id:** TD-CONSTRUCTION-ROOF
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Крыша; высота и временная погодозащита
- **outcome:** Иметь измеримую и проверяемую способность: крыша; высота и временная погодозащита
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
