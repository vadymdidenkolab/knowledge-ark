---
id: "TD-PORTUGAL-OFFLINE"
kind: "technology"
title: "Локальные копии; права; язык и дата проверки"
...
# Локальные копии; права; язык и дата проверки
...
- **node_id:** TD-PORTUGAL-OFFLINE
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** Локальные копии; права; язык и дата проверки
- **outcome:** Иметь измеримую и проверяемую способность: локальные копии; права; язык и дата проверки
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
