---
id: "TD-WORKSHOP-PLANE"
kind: "technology"
title: "Строгание древесины"
...
- **node_id:** TD-WORKSHOP-PLANE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** TRAINING
- **title_ru:** Строгание древесины
- **outcome:** Иметь измеримую и проверяемую способность: строгание древесины
- **safety_class:** S2_TRAINED_SUPERVISED
