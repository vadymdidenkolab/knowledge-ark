---
id: "TD-ENVIRONMENT-HEAT"
kind: "technology"
title: "Жара и тепловой риск"
...
- **node_id:** TD-ENVIRONMENT-HEAT
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** SITE_DATA
- **title_ru:** Жара и тепловой риск
- **outcome:** Иметь измеримую и проверяемую способность: жара и тепловой риск
- **safety_class:** S2_TRAINED_SUPERVISED
