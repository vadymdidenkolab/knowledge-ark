---
id: "TD-AGRI-SOIL-TEST"
kind: "technology"
title: "Анализ почвы и корректная интерпретация"
...
# Анализ почвы и корректная интерпретация
...
- **node_id:** TD-AGRI-SOIL-TEST
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Анализ почвы и корректная интерпретация
- **outcome:** Иметь измеримую и проверяемую способность: анализ почвы и корректная интерпретация
- **safety_class:** S2_TRAINED_SUPERVISED
