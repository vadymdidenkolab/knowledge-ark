---
id: "TD-AGRI-SOIL-SALINITY"
kind: "technology"
title: "Солёность и электропроводность почвы"
...
# Солёность и электропроводность почвы
...
- **node_id:** TD-AGRI-SOIL-SALINITY
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Солёность и электропроводность почвы
- **outcome:** Иметь измеримую и проверяемую способность: солёность и электропроводность почвы
- **safety_class:** S2_TRAINED_SUPERVISED
