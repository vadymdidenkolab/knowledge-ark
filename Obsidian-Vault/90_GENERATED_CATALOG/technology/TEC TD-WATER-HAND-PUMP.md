---
id: "TD-WATER-HAND-PUMP"
kind: "technology"
title: "Ручной насос и его ремонт"
...
- **node_id:** TD-WATER-HAND-PUMP
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** TOOL
- **title_ru:** Ручной насос и его ремонт
- **outcome:** Иметь измеримую и проверяемую способность: ручной насос и его ремонт
- **safety_class:** S2_TRAINED_SUPERVISED
