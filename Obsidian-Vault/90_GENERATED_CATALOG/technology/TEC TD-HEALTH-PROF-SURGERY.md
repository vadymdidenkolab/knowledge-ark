---
id: "TD-HEALTH-PROF-SURGERY"
kind: "technology"
title: "Хирургия; анестезия и trauma surgery"
...
# Хирургия; анестезия и trauma surgery
...
- **node_id:** TD-HEALTH-PROF-SURGERY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Хирургия; анестезия и trauma surgery
- **outcome:** Иметь измеримую и проверяемую способность: хирургия; анестезия и trauma surgery
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
