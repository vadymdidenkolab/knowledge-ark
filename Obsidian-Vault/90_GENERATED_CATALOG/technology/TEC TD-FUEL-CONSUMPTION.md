---
id: "TD-FUEL-CONSUMPTION"
kind: "technology"
title: "Измеренный расход по конкретному прибору"
...
# Измеренный расход по конкретному прибору
...
- **node_id:** TD-FUEL-CONSUMPTION
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** TEST
- **title_ru:** Измеренный расход по конкретному прибору
- **outcome:** Иметь измеримую и проверяемую способность: измеренный расход по конкретному прибору
- **safety_class:** S2_TRAINED_SUPERVISED
