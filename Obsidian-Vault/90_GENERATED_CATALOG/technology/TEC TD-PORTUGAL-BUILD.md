---
id: "TD-PORTUGAL-BUILD"
kind: "technology"
title: "Разрешения; проекты и professional sign-off"
...
# Разрешения; проекты и professional sign-off
...
- **node_id:** TD-PORTUGAL-BUILD
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Разрешения; проекты и professional sign-off
- **outcome:** Иметь измеримую и проверяемую способность: разрешения; проекты и professional sign-off
- **safety_class:** S3_LICENSED_PROFESSIONAL
