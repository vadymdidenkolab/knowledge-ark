...
id: "TD-PEOPLE-ELDER"
kind: "technology"
title: "Пожилые люди и возрастная уязвимость"
...
# Пожилые люди и возрастная уязвимость
...
- **node_id:** TD-PEOPLE-ELDER
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** GOVERNANCE
- **title_ru:** Пожилые люди и возрастная уязвимость
- **outcome:** Иметь измеримую и проверяемую способность: пожилые люди и возрастная уязвимость
- **safety_class:** S2_TRAINED_SUPERVISED
