---
id: "TD-SECURITY-MISSING"
kind: "technology"
title: "Пропавший участник и последняя известная точка"
...
# Пропавший участник и последняя известная точка
...
- **node_id:** TD-SECURITY-MISSING
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** PROCESS
- **title_ru:** Пропавший участник и последняя известная точка
- **outcome:** Иметь измеримую и проверяемую способность: пропавший участник и последняя известная точка
- **safety_class:** S2_TRAINED_SUPERVISED
