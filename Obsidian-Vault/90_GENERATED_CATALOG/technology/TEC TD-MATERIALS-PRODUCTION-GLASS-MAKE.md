---
id: "TD-MATERIALS-PRODUCTION-GLASS-MAKE"
kind: "technology"
...
- **node_id:** TD-MATERIALS-PRODUCTION-GLASS-MAKE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Производство стекла
- **outcome:** Иметь измеримую и проверяемую способность: производство стекла
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
