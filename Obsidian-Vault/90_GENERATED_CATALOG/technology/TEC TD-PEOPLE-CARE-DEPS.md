---
id: "TD-PEOPLE-CARE-DEPS"
kind: "technology"
title: "Caregiver dependencies и объём ухода"
...
# Caregiver dependencies и объём ухода
...
- **node_id:** TD-PEOPLE-CARE-DEPS
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** GOVERNANCE
- **title_ru:** Caregiver dependencies и объём ухода
- **outcome:** Иметь измеримую и проверяемую способность: caregiver dependencies и объём ухода
- **safety_class:** S2_TRAINED_SUPERVISED
