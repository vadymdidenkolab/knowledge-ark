---
id: "TD-KNOWLEDGE-READERS-SPARE"
kind: "technology"
title: "Запасные readers и установщики"
...
# Запасные readers и установщики
...
- **node_id:** TD-KNOWLEDGE-READERS-SPARE
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** MATERIAL
- **title_ru:** Запасные readers и установщики
- **outcome:** Иметь измеримую и проверяемую способность: запасные readers и установщики
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
