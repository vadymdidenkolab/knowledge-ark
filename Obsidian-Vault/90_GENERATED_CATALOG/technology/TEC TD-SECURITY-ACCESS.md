---
id: "TD-SECURITY-ACCESS"
kind: "technology"
title: "Механический контроль доступа и ключей"
...
# Механический контроль доступа и ключей
...
- **node_id:** TD-SECURITY-ACCESS
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** PROCESS
- **title_ru:** Механический контроль доступа и ключей
- **outcome:** Иметь измеримую и проверяемую способность: механический контроль доступа и ключей
- **safety_class:** S2_TRAINED_SUPERVISED
