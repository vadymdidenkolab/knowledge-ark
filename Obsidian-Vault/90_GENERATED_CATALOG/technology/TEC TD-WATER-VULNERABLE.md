---
id: "TD-WATER-VULNERABLE"
kind: "technology"
title: "Вода для лекарств; младенцев и уязвимых людей"
...
# Вода для лекарств; младенцев и уязвимых людей
...
- **node_id:** TD-WATER-VULNERABLE
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** SITE_DATA
- **title_ru:** Вода для лекарств; младенцев и уязвимых людей
- **outcome:** Иметь измеримую и проверяемую способность: вода для лекарств; младенцев и уязвимых людей
- **safety_class:** S2_TRAINED_SUPERVISED
