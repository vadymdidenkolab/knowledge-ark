---
id: "TD-KNOWLEDGE-RIGHTS"
kind: "technology"
title: "Права; provenance и допустимая локальная копия"
...
# Права; provenance и допустимая локальная копия
...
- **node_id:** TD-KNOWLEDGE-RIGHTS
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** GOVERNANCE
- **title_ru:** Права; provenance и допустимая локальная копия
- **outcome:** Иметь измеримую и проверяемую способность: права; provenance и допустимая локальная копия
- **safety_class:** S0_OBSERVE_READ
