---
id: "TD-TRANSPORT-SPARES"
kind: "technology"
title: "Запасные части и стандартные интерфейсы"
...
# Запасные части и стандартные интерфейсы
...
- **node_id:** TD-TRANSPORT-SPARES
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** MATERIAL
- **title_ru:** Запасные части и стандартные интерфейсы
- **outcome:** Иметь измеримую и проверяемую способность: запасные части и стандартные интерфейсы
- **safety_class:** S2_TRAINED_SUPERVISED
