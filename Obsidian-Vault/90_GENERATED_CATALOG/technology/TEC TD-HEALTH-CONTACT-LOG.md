---
id: "TD-HEALTH-CONTACT-LOG"
kind: "technology"
title: "Первичный журнал контактов с защитой приватности"
...
# Первичный журнал контактов с защитой приватности
...
- **node_id:** TD-HEALTH-CONTACT-LOG
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Первичный журнал контактов с защитой приватности
- **outcome:** Иметь измеримую и проверяемую способность: первичный журнал контактов с защитой приватности
- **safety_class:** S2_TRAINED_SUPERVISED
