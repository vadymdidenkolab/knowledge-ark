---
id: "TD-FOOD-COOK-SAFETY"
kind: "technology"
title: "Пожар; CO; вентиляция и пищевая безопасность при готовке"
...
# Пожар; CO; вентиляция и пищевая безопасность при готовке
...
- **node_id:** TD-FOOD-COOK-SAFETY
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Пожар; CO; вентиляция и пищевая безопасность при готовке
- **outcome:** Иметь измеримую и проверяемую способность: пожар; co; вентиляция и пищевая безопасность при готовке
- **safety_class:** S2_TRAINED_SUPERVISED
