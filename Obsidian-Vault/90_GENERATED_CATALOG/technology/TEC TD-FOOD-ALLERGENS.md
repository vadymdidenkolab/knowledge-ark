---
id: "TD-FOOD-ALLERGENS"
kind: "technology"
title: "Аллергены и перекрёстный контакт"
...
# Аллергены и перекрёстный контакт
...
- **node_id:** TD-FOOD-ALLERGENS
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Аллергены и перекрёстный контакт
- **outcome:** Иметь измеримую и проверяемую способность: аллергены и перекрёстный контакт
- **safety_class:** S2_TRAINED_SUPERVISED
