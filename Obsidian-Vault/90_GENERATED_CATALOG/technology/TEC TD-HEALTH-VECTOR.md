...
id: "TD-HEALTH-VECTOR"
kind: "technology"
title: "Переносчики и environmental health"
...
# Переносчики и environmental health
...
- **node_id:** TD-HEALTH-VECTOR
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Переносчики и environmental health
- **outcome:** Иметь измеримую и проверяемую способность: переносчики и environmental health
- **safety_class:** S3_LICENSED_PROFESSIONAL
