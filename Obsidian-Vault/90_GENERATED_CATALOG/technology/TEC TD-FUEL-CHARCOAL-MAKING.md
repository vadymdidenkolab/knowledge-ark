---
id: "TD-FUEL-CHARCOAL-MAKING"
kind: "technology"
title: "Производство древесного угля и пиролиз"
...
# Производство древесного угля и пиролиз
...
- **node_id:** TD-FUEL-CHARCOAL-MAKING
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Производство древесного угля и пиролиз
- **outcome:** Preserve only industrial or professionally supervised knowledge while preventing CO; fire and wildfire harm
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
- **execution_policy:** REFERENCE_ONLY_NO_BUILD
- **prerequisite_node_ids:** [[TEC TD-BASE-SAFETY|TD-BASE-SAFETY]]
- **source_package_ids:** не заполнено
- **materials_tools_state:** NO_HOME_PYROLYSIS
- **instrument_ids:** не заполнено
- **measurement_acceptance:** No-build boundary; recognition of CO; uncontrolled heat and wildfire risk
- **calibration_reference:** Competent fire and process authority
- **drawings_bom_state:** NO_BUILD_DRAWINGS
- **localization_state:** PORTUGAL_FIRE_FORESTRY_AND_EMISSIONS_RULES_REQUIRED
- **waste_storage:** Licensed ash; tar and contaminated-condensate routes
- **stop_conditions:** CO; smoke; hot vessel; pressure; wildfire condition; unknown feedstock
- **maintenance_spares:** Authority review only
- **successor_proof:** Преемник refuses household kiln construction and evacuates on CO or fire signs
- **evidence_required:** Boundary card; official sources; tabletop
- **evidence_state:** BOUNDARY_DEFINED
- **capability_status:** REFERENCE_ONLY
- **release_gate:** REFERENCE_ONLY
- **notes:** No kiln recipe; temperature schedule or yield optimization
