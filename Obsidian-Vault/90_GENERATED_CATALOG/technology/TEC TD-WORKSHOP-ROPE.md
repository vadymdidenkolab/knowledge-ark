...
id: "TD-WORKSHOP-ROPE"
kind: "technology"
title: "Канаты; узлы; сети и такелаж без life-safety импровизации"
...
# Канаты; узлы; сети и такелаж без life-safety импровизации
...
- **node_id:** TD-WORKSHOP-ROPE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** TRAINING
- **title_ru:** Канаты; узлы; сети и такелаж без life-safety импровизации
- **outcome:** Иметь измеримую и проверяемую способность: канаты; узлы; сети и такелаж без life-safety импровизации
- **safety_class:** S2_TRAINED_SUPERVISED
