---
id: "TD-HEALTH-PROF-LAB"
kind: "technology"
title: "Лабораторная медицина; samples и quality control"
...
# Лабораторная медицина; samples и quality control
...
- **node_id:** TD-HEALTH-PROF-LAB
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Лабораторная медицина; samples и quality control
- **outcome:** Иметь измеримую и проверяемую способность: лабораторная медицина; samples и quality control
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
