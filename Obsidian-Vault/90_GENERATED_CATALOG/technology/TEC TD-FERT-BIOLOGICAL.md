---
id: "TD-FERT-BIOLOGICAL"
kind: "technology"
title: "Микробные инокулянты и biofertilizers"
...
# Микробные инокулянты и biofertilizers
...
- **node_id:** TD-FERT-BIOLOGICAL
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Микробные инокулянты и biofertilizers
- **outcome:** Prevent cultivation or release of unknown biology while preserving regulated-product knowledge
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
- **execution_policy:** REFERENCE_ONLY_NO_BUILD
- **prerequisite_node_ids:** [[TEC TD-BASE-SAFETY|TD-BASE-SAFETY]]
- **source_package_ids:** не заполнено
- **materials_tools_state:** NO_CULTURE_OR_INOCULANT
- **instrument_ids:** не заполнено
- **measurement_acceptance:** No culturing; isolation; amplification or field release of unknown microorganisms
- **calibration_reference:** Regulated product label; qualified microbiology and agronomy sources
- **drawings_bom_state:** NO_CULTURE_PROTOCOL
- **localization_state:** PORTUGAL_BIOSECURITY_FERTILIZER_AND_ENVIRONMENT_RULES_REQUIRED
- **waste_storage:** Expired product and contaminated culture material through approved route
- **stop_conditions:** Unknown organism; contamination; aerosol; immunocompromised person; unregistered product
- **maintenance_spares:** Sealed certified product only; label controls
- **successor_proof:** Преемник refuses home culture and isolates damaged package
- **evidence_required:** Boundary card; product registration; label
- **evidence_state:** BOUNDARY_DEFINED
- **capability_status:** REFERENCE_ONLY
- **release_gate:** REFERENCE_ONLY
- **notes:** No microbial growth conditions or inoculation recipe
