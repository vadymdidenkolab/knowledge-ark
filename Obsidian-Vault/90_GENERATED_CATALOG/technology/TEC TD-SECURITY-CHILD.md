---
id: "TD-SECURITY-CHILD"
kind: "technology"
title: "Защита детей и зависимых людей"
...
# Защита детей и зависимых людей
...
- **node_id:** TD-SECURITY-CHILD
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** GOVERNANCE
- **title_ru:** Защита детей и зависимых людей
- **outcome:** Иметь измеримую и проверяемую способность: защита детей и зависимых людей
- **safety_class:** S2_TRAINED_SUPERVISED
