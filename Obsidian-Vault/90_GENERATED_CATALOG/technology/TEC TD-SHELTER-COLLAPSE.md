---
id: "TD-SHELTER-COLLAPSE"
kind: "technology"
title: "Признаки риска обрушения и запрет входа"
...
# Признаки риска обрушения и запрет входа
...
- **node_id:** TD-SHELTER-COLLAPSE
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Признаки риска обрушения и запрет входа
- **outcome:** Иметь измеримую и проверяемую способность: признаки риска обрушения и запрет входа
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
