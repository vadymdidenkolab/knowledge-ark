...
- **node_id:** TD-ANIMALS-FEED
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** MATERIAL
- **title_ru:** Корма; питание и запас
- **outcome:** Иметь измеримую и проверяемую способность: корма; питание и запас
- **safety_class:** S2_TRAINED_SUPERVISED
