---
id: "TD-HEALTH-SURVEILLANCE"
kind: "technology"
title: "Синдромный журнал группы и outbreak reporting"
...
# Синдромный журнал группы и outbreak reporting
...
- **node_id:** TD-HEALTH-SURVEILLANCE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Синдромный журнал группы и outbreak reporting
- **outcome:** Иметь измеримую и проверяемую способность: синдромный журнал группы и outbreak reporting
- **safety_class:** S3_LICENSED_PROFESSIONAL
