---
id: "TD-SHELTER-COLD-ZONE"
kind: "technology"
title: "Безопасная тёплая зона при холоде"
...
# Безопасная тёплая зона при холоде
...
- **node_id:** TD-SHELTER-COLD-ZONE
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** PROCESS
- **title_ru:** Безопасная тёплая зона при холоде
- **outcome:** Иметь измеримую и проверяемую способность: безопасная тёплая зона при холоде
- **safety_class:** S2_TRAINED_SUPERVISED
