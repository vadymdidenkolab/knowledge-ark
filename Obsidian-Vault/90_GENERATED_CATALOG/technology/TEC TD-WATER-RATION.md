...
id: "TD-WATER-RATION"
kind: "technology"
title: "Выдача; учёт и приоритеты воды"
...
- **node_id:** TD-WATER-RATION
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** GOVERNANCE
- **title_ru:** Выдача; учёт и приоритеты воды
- **outcome:** Иметь измеримую и проверяемую способность: выдача; учёт и приоритеты воды
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
