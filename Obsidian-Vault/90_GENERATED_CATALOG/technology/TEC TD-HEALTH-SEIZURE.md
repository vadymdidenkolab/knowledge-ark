---
id: "TD-HEALTH-SEIZURE"
kind: "technology"
title: "Судороги и изменённое сознание"
...
# Судороги и изменённое сознание
...
- **node_id:** TD-HEALTH-SEIZURE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Судороги и изменённое сознание
- **outcome:** Иметь измеримую и проверяемую способность: судороги и изменённое сознание
- **safety_class:** S2_TRAINED_SUPERVISED
