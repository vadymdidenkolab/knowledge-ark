---
id: "TD-ENERGY-MEDICAL"
kind: "technology"
title: "Питание медицинских устройств"
...
- **node_id:** TD-ENERGY-MEDICAL
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** OUTCOME
- **title_ru:** Питание медицинских устройств
- **outcome:** Иметь измеримую и проверяемую способность: питание медицинских устройств
- **safety_class:** S2_TRAINED_SUPERVISED
