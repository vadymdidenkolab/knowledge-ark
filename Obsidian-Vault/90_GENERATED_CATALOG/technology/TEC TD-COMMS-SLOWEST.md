...
id: "TD-COMMS-SLOWEST"
kind: "technology"
title: "Полевой маршрут для самого медленного участника"
...
# Полевой маршрут для самого медленного участника
...
- **node_id:** TD-COMMS-SLOWEST
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** TEST
- **title_ru:** Полевой маршрут для самого медленного участника
- **outcome:** Иметь измеримую и проверяемую способность: полевой маршрут для самого медленного участника
- **safety_class:** S2_TRAINED_SUPERVISED
