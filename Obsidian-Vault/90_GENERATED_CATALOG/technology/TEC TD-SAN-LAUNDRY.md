...
id: "TD-SAN-LAUNDRY"
kind: "technology"
title: "Стирка; сушка и разделение загрязнённого белья"
...
# Стирка; сушка и разделение загрязнённого белья
...
- **node_id:** TD-SAN-LAUNDRY
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Стирка; сушка и разделение загрязнённого белья
- **outcome:** Иметь измеримую и проверяемую способность: стирка; сушка и разделение загрязнённого белья
- **safety_class:** S2_TRAINED_SUPERVISED
