---
id: "TD-CONSTRUCTION-ACCESS"
kind: "technology"
title: "Доступность и универсальный дизайн"
...
- **node_id:** TD-CONSTRUCTION-ACCESS
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** DRAWING
- **title_ru:** Доступность и универсальный дизайн
- **outcome:** Иметь измеримую и проверяемую способность: доступность и универсальный дизайн
- **safety_class:** S3_LICENSED_PROFESSIONAL
