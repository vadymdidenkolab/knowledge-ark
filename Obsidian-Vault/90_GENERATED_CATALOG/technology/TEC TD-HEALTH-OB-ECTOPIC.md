---
id: "TD-HEALTH-OB-ECTOPIC"
kind: "technology"
title: "Признаки возможной внематочной беременности"
...
# Признаки возможной внематочной беременности
...
- **node_id:** TD-HEALTH-OB-ECTOPIC
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Признаки возможной внематочной беременности
- **outcome:** Иметь измеримую и проверяемую способность: признаки возможной внематочной беременности
- **safety_class:** S3_LICENSED_PROFESSIONAL
