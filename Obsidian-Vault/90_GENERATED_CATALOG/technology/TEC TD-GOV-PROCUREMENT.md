---
id: "TD-GOV-PROCUREMENT"
kind: "technology"
title: "Закупка; приёмка и provenance"
...
- **node_id:** TD-GOV-PROCUREMENT
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** PROCESS
- **title_ru:** Закупка; приёмка и provenance
- **outcome:** Иметь измеримую и проверяемую способность: закупка; приёмка и provenance
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
