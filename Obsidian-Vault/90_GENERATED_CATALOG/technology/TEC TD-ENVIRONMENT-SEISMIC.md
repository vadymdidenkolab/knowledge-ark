---
id: "TD-ENVIRONMENT-SEISMIC"
kind: "technology"
title: "Землетрясение и вторичные опасности"
...
# Землетрясение и вторичные опасности
...
- **node_id:** TD-ENVIRONMENT-SEISMIC
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** SITE_DATA
- **title_ru:** Землетрясение и вторичные опасности
- **outcome:** Иметь измеримую и проверяемую способность: землетрясение и вторичные опасности
- **safety_class:** S2_TRAINED_SUPERVISED
