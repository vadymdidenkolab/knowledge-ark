---
id: "TD-HEALTH-FALLS-DECONDITION"
kind: "technology"
title: "Профилактика падений и декондиционирования"
...
# Профилактика падений и декондиционирования
...
- **node_id:** TD-HEALTH-FALLS-DECONDITION
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Профилактика падений и декондиционирования
- **outcome:** Иметь измеримую и проверяемую способность: профилактика падений и декондиционирования
- **safety_class:** S2_TRAINED_SUPERVISED
