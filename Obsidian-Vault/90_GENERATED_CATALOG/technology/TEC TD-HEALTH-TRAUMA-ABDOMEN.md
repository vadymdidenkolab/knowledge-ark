---
id: "TD-HEALTH-TRAUMA-ABDOMEN"
kind: "technology"
title: "Тяжёлая травма живота и таза"
...
- **node_id:** TD-HEALTH-TRAUMA-ABDOMEN
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Тяжёлая травма живота и таза
- **outcome:** Иметь измеримую и проверяемую способность: тяжёлая травма живота и таза
- **safety_class:** S3_LICENSED_PROFESSIONAL
