---
id: "TD-HEALTH-CONT-HIV-TB"
kind: "technology"
title: "HIV/TB и непрерывность лечения"
...
# HIV/TB и непрерывность лечения
...
- **node_id:** TD-HEALTH-CONT-HIV-TB
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** HIV/TB и непрерывность лечения
- **outcome:** Иметь измеримую и проверяемую способность: hiv/tb и непрерывность лечения
- **safety_class:** S3_LICENSED_PROFESSIONAL
