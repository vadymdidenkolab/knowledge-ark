---
id: "TD-ENVIRONMENT-BIODIVERSITY"
kind: "technology"
title: "Биоразнообразие и запрет неизвестных интродукций"
...
# Биоразнообразие и запрет неизвестных интродукций
...
- **node_id:** TD-ENVIRONMENT-BIODIVERSITY
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** GOVERNANCE
- **title_ru:** Биоразнообразие и запрет неизвестных интродукций
- **outcome:** Иметь измеримую и проверяемую способность: биоразнообразие и запрет неизвестных интродукций
- **safety_class:** S2_TRAINED_SUPERVISED
