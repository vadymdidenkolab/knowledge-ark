...
- **node_id:** TD-METRO-HUMIDITY
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Относительная влажность
- **outcome:** Иметь измеримую и проверяемую способность: относительная влажность
- **safety_class:** S2_TRAINED_SUPERVISED
