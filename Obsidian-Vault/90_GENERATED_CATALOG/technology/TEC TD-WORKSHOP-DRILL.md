---
id: "TD-WORKSHOP-DRILL"
kind: "technology"
title: "Ручное и маломощное сверление"
...
- **node_id:** TD-WORKSHOP-DRILL
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** TRAINING
- **title_ru:** Ручное и маломощное сверление
- **outcome:** Иметь измеримую и проверяемую способность: ручное и маломощное сверление
- **safety_class:** S2_TRAINED_SUPERVISED
