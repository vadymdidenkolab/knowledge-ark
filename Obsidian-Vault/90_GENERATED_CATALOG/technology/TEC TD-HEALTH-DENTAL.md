...
id: "TD-HEALTH-DENTAL"
kind: "technology"
title: "Профилактическая стоматология и срочная маршрутизация"
...
# Профилактическая стоматология и срочная маршрутизация
...
- **node_id:** TD-HEALTH-DENTAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Профилактическая стоматология и срочная маршрутизация
- **outcome:** Иметь измеримую и проверяемую способность: профилактическая стоматология и срочная маршрутизация
- **safety_class:** S2_TRAINED_SUPERVISED
