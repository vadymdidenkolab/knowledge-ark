...
id: "TD-METRO-PH"
kind: "technology"
title: "pH с ограничением интерпретации"
...
# pH с ограничением интерпретации
...
- **title_ru:** pH с ограничением интерпретации
- **outcome:** Иметь измеримую и проверяемую способность: ph с ограничением интерпретации
- **safety_class:** S2_TRAINED_SUPERVISED
