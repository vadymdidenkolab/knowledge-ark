---
id: "TD-MATERIALS-PRODUCTION-PAPER"
kind: "technology"
title: "Бумага и долговременное хранение"
...
# Бумага и долговременное хранение
...
- **node_id:** TD-MATERIALS-PRODUCTION-PAPER
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Бумага и долговременное хранение
- **outcome:** Иметь измеримую и проверяемую способность: бумага и долговременное хранение
- **safety_class:** S2_TRAINED_SUPERVISED
