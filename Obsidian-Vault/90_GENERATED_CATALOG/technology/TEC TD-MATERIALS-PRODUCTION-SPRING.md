---
id: "TD-MATERIALS-PRODUCTION-SPRING"
kind: "technology"
title: "Пружины и stored energy"
...
- **node_id:** TD-MATERIALS-PRODUCTION-SPRING
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Пружины и stored energy
- **outcome:** Иметь измеримую и проверяемую способность: пружины и stored energy
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
