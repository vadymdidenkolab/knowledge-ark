---
id: "TD-SHELTER-SHUTOFF-GAS"
kind: "technology"
title: "Штатное отключение газа квалифицированным способом"
...
# Штатное отключение газа квалифицированным способом
...
- **node_id:** TD-SHELTER-SHUTOFF-GAS
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** TRAINING
- **title_ru:** Штатное отключение газа квалифицированным способом
- **outcome:** Иметь измеримую и проверяемую способность: штатное отключение газа квалифицированным способом
- **safety_class:** S3_LICENSED_PROFESSIONAL
