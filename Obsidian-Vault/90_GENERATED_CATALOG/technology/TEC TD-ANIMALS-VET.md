...
id: "TD-ANIMALS-VET"
kind: "technology"
title: "Ветеринарная помощь и лекарства"
...
# Ветеринарная помощь и лекарства
...
- **node_id:** TD-ANIMALS-VET
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** KNOWLEDGE
- **title_ru:** Ветеринарная помощь и лекарства
- **outcome:** Иметь измеримую и проверяемую способность: ветеринарная помощь и лекарства
- **safety_class:** S3_LICENSED_PROFESSIONAL
