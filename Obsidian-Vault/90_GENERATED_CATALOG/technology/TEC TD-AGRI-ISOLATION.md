---
id: "TD-AGRI-ISOLATION"
kind: "technology"
title: "Видоспецифическая изоляция при семеноводстве"
...
# Видоспецифическая изоляция при семеноводстве
...
- **node_id:** TD-AGRI-ISOLATION
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Видоспецифическая изоляция при семеноводстве
- **outcome:** Иметь измеримую и проверяемую способность: видоспецифическая изоляция при семеноводстве
- **safety_class:** S2_TRAINED_SUPERVISED
