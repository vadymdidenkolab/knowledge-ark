---
id: "TD-SHELTER-HEAT-ZONE"
kind: "technology"
title: "Безопасная прохладная зона при жаре"
...
# Безопасная прохладная зона при жаре
...
- **node_id:** TD-SHELTER-HEAT-ZONE
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** PROCESS
- **title_ru:** Безопасная прохладная зона при жаре
- **outcome:** Иметь измеримую и проверяемую способность: безопасная прохладная зона при жаре
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
