...
id: "TD-COMMS-R1-R3"
kind: "technology"
title: "Независимые маршруты R1/R2/R3"
...
- **node_id:** TD-COMMS-R1-R3
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** DRAWING
- **title_ru:** Независимые маршруты R1/R2/R3
- **outcome:** Иметь измеримую и проверяемую способность: независимые маршруты r1/r2/r3
- **safety_class:** S2_TRAINED_SUPERVISED
