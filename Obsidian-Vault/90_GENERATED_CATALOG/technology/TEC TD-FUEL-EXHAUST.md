...
id: "TD-FUEL-EXHAUST"
kind: "technology"
title: "Выхлоп; CO; вентиляция и дымоход"
...
# Выхлоп; CO; вентиляция и дымоход
...
- **node_id:** TD-FUEL-EXHAUST
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** PROCESS
- **title_ru:** Выхлоп; CO; вентиляция и дымоход
- **outcome:** Иметь измеримую и проверяемую способность: выхлоп; co; вентиляция и дымоход
- **safety_class:** S3_LICENSED_PROFESSIONAL
