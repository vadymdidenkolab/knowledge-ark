---
id: "TD-METRO-MOISTURE"
kind: "technology"
title: "Влажность зерна; семян и древесины"
...
# Влажность зерна; семян и древесины
...
- **node_id:** TD-METRO-MOISTURE
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Влажность зерна; семян и древесины
- **outcome:** Иметь измеримую и проверяемую способность: влажность зерна; семян и древесины
- **safety_class:** S2_TRAINED_SUPERVISED
