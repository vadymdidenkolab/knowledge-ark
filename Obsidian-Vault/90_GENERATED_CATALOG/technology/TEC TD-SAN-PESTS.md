...
- **node_id:** TD-SAN-PESTS
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Вредители и переносчики
- **outcome:** Иметь измеримую и проверяемую способность: вредители и переносчики
- **safety_class:** S2_TRAINED_SUPERVISED
