---
id: "TD-MATERIALS-PRODUCTION-ABRASIVE"
kind: "technology"
title: "Абразивы и режущий инструмент"
...
- **node_id:** TD-MATERIALS-PRODUCTION-ABRASIVE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** MATERIAL
- **title_ru:** Абразивы и режущий инструмент
- **outcome:** Иметь измеримую и проверяемую способность: абразивы и режущий инструмент
- **safety_class:** S3_LICENSED_PROFESSIONAL
