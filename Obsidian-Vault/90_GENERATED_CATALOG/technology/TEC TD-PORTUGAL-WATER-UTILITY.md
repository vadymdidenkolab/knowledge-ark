---
id: "TD-PORTUGAL-WATER-UTILITY"
kind: "technology"
title: "Водоканал и аварийные контакты"
...
# Водоканал и аварийные контакты
...
- **node_id:** TD-PORTUGAL-WATER-UTILITY
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** SITE_DATA
- **title_ru:** Водоканал и аварийные контакты
- **outcome:** Иметь измеримую и проверяемую способность: водоканал и аварийные контакты
- **safety_class:** S0_OBSERVE_READ
