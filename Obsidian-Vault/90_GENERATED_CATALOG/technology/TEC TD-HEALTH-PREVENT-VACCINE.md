---
id: "TD-HEALTH-PREVENT-VACCINE"
kind: "technology"
title: "Профилактика и вакцинация по персональному плану"
...
# Профилактика и вакцинация по персональному плану
...
- **node_id:** TD-HEALTH-PREVENT-VACCINE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Профилактика и вакцинация по персональному плану
- **outcome:** Иметь измеримую и проверяемую способность: профилактика и вакцинация по персональному плану
- **safety_class:** S3_LICENSED_PROFESSIONAL
