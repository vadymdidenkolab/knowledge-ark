---
id: "TD-TRANSPORT-ANIMAL"
kind: "technology"
title: "Тягловые животные при наличии; welfare и handler"
...
# Тягловые животные при наличии; welfare и handler
...
- **node_id:** TD-TRANSPORT-ANIMAL
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** PROCESS
- **title_ru:** Тягловые животные при наличии; welfare и handler
- **outcome:** Иметь измеримую и проверяемую способность: тягловые животные при наличии; welfare и handler
- **safety_class:** S3_LICENSED_PROFESSIONAL
