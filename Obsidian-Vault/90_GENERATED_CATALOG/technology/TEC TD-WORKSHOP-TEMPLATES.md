---
id: "TD-WORKSHOP-TEMPLATES"
kind: "technology"
title: "Шаблоны; кондукторы и повторяемость"
...
# Шаблоны; кондукторы и повторяемость
...
- **node_id:** TD-WORKSHOP-TEMPLATES
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** DRAWING
- **title_ru:** Шаблоны; кондукторы и повторяемость
- **outcome:** Иметь измеримую и проверяемую способность: шаблоны; кондукторы и повторяемость
- **safety_class:** S2_TRAINED_SUPERVISED
