...
id: "TD-SHELTER-LIGHT"
kind: "technology"
title: "Аварийное освещение путей выхода"
...
# Аварийное освещение путей выхода
...
- **node_id:** TD-SHELTER-LIGHT
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** MATERIAL
- **title_ru:** Аварийное освещение путей выхода
- **outcome:** Иметь измеримую и проверяемую способность: аварийное освещение путей выхода
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
