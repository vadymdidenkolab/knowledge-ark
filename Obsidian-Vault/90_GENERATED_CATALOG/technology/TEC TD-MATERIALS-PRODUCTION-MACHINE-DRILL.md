---
id: "TD-MATERIALS-PRODUCTION-MACHINE-DRILL"
kind: "technology"
title: "Ручная стойка и drill press"
...
- **node_id:** TD-MATERIALS-PRODUCTION-MACHINE-DRILL
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** TOOL
- **title_ru:** Ручная стойка и drill press
- **outcome:** Иметь измеримую и проверяемую способность: ручная стойка и drill press
- **safety_class:** S3_LICENSED_PROFESSIONAL
