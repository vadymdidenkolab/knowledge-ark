...
- **node_id:** TD-WATER-GRAVITY
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Гравитационная подача
- **outcome:** Иметь измеримую и проверяемую способность: гравитационная подача
- **safety_class:** S2_TRAINED_SUPERVISED
