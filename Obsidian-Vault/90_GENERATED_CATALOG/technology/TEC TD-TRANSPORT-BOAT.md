---
id: "TD-TRANSPORT-BOAT"
kind: "technology"
title: "Лодка и побережье только при локальной применимости"
...
# Лодка и побережье только при локальной применимости
...
- **node_id:** TD-TRANSPORT-BOAT
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Лодка и побережье только при локальной применимости
- **outcome:** Иметь измеримую и проверяемую способность: лодка и побережье только при локальной применимости
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
