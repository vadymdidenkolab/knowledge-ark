---
id: "TD-SHELTER-SHUTOFF-ELECTRIC"
kind: "technology"
title: "Штатное отключение электричества без работ в щите"
...
# Штатное отключение электричества без работ в щите
...
- **node_id:** TD-SHELTER-SHUTOFF-ELECTRIC
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** TRAINING
- **title_ru:** Штатное отключение электричества без работ в щите
- **outcome:** Иметь измеримую и проверяемую способность: штатное отключение электричества без работ в щите
- **safety_class:** S2_TRAINED_SUPERVISED
