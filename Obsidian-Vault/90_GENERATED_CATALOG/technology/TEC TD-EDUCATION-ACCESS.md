---
id: "TD-EDUCATION-ACCESS"
kind: "technology"
title: "Доступность обучения для разных возможностей"
...
# Доступность обучения для разных возможностей
...
- **node_id:** TD-EDUCATION-ACCESS
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** PROCESS
- **title_ru:** Доступность обучения для разных возможностей
- **outcome:** Иметь измеримую и проверяемую способность: доступность обучения для разных возможностей
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
