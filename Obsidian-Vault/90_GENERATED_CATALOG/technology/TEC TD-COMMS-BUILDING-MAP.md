---
id: "TD-COMMS-BUILDING-MAP"
kind: "technology"
title: "План здания; выходы; отключения и огнетушители"
...
# План здания; выходы; отключения и огнетушители
...
- **node_id:** TD-COMMS-BUILDING-MAP
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** DRAWING
- **title_ru:** План здания; выходы; отключения и огнетушители
- **outcome:** Иметь измеримую и проверяемую способность: план здания; выходы; отключения и огнетушители
- **safety_class:** S2_TRAINED_SUPERVISED
