---
id: "TD-AGRI-MICROCLIMATE"
kind: "technology"
title: "Микроклимат; мороз; жара; ветер и экспозиция"
...
# Микроклимат; мороз; жара; ветер и экспозиция
...
- **node_id:** TD-AGRI-MICROCLIMATE
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** SITE_DATA
- **title_ru:** Микроклимат; мороз; жара; ветер и экспозиция
- **outcome:** Иметь измеримую и проверяемую способность: микроклимат; мороз; жара; ветер и экспозиция
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
