---
id: "TD-MATERIALS-PRODUCTION-WOOL"
kind: "technology"
title: "Шерсть; очистка и хранение"
...
- **node_id:** TD-MATERIALS-PRODUCTION-WOOL
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Шерсть; очистка и хранение
- **outcome:** Иметь измеримую и проверяемую способность: шерсть; очистка и хранение
- **safety_class:** S2_TRAINED_SUPERVISED
