---
id: "TD-EDUCATION-MASTERY"
kind: "technology"
title: "Проверка мастерства по критериям"
...
# Проверка мастерства по критериям
...
- **node_id:** TD-EDUCATION-MASTERY
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** TEST
- **title_ru:** Проверка мастерства по критериям
- **outcome:** Иметь измеримую и проверяемую способность: проверка мастерства по критериям
- **safety_class:** S2_TRAINED_SUPERVISED
