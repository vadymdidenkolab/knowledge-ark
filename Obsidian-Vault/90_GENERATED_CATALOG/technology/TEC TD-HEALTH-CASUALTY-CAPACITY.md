---
id: "TD-HEALTH-CASUALTY-CAPACITY"
kind: "technology"
title: "Мощность ухода и порог перегрузки группы"
...
# Мощность ухода и порог перегрузки группы
...
- **node_id:** TD-HEALTH-CASUALTY-CAPACITY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TEST
- **title_ru:** Мощность ухода и порог перегрузки группы
- **outcome:** Иметь измеримую и проверяемую способность: мощность ухода и порог перегрузки группы
- **safety_class:** S2_TRAINED_SUPERVISED
