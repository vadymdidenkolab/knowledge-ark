---
id: "TD-HEALTH-DELAYED-CARE"
kind: "technology"
title: "Поддерживающий уход при задержке профессиональной помощи"
...
# Поддерживающий уход при задержке профессиональной помощи
...
- **node_id:** TD-HEALTH-DELAYED-CARE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Поддерживающий уход при задержке профессиональной помощи
- **outcome:** Иметь измеримую и проверяемую способность: поддерживающий уход при задержке профессиональной помощи
- **safety_class:** S3_LICENSED_PROFESSIONAL
