---
id: "TD-TRANSPORT-JACK"
kind: "technology"
title: "Домкрат; опоры и запрет работы под грузом"
...
# Домкрат; опоры и запрет работы под грузом
...
- **node_id:** TD-TRANSPORT-JACK
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TOOL
- **title_ru:** Домкрат; опоры и запрет работы под грузом
- **outcome:** Иметь измеримую и проверяемую способность: домкрат; опоры и запрет работы под грузом
- **safety_class:** S3_LICENSED_PROFESSIONAL
