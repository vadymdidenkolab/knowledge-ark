...
id: "TD-PORTUGAL-LABS"
kind: "technology"
title: "Лаборатории воды и почвы"
...
- **node_id:** TD-PORTUGAL-LABS
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** SITE_DATA
- **title_ru:** Лаборатории воды и почвы
- **outcome:** Иметь измеримую и проверяемую способность: лаборатории воды и почвы
- **safety_class:** S0_OBSERVE_READ
