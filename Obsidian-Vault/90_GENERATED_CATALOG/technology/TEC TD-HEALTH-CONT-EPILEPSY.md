---
id: "TD-HEALTH-CONT-EPILEPSY"
kind: "technology"
title: "Непрерывность лечения эпилепсии"
...
# Непрерывность лечения эпилепсии
...
- **node_id:** TD-HEALTH-CONT-EPILEPSY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Непрерывность лечения эпилепсии
- **outcome:** Иметь измеримую и проверяемую способность: непрерывность лечения эпилепсии
- **safety_class:** S3_LICENSED_PROFESSIONAL
