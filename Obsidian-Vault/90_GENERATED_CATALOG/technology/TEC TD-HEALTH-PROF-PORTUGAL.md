---
id: "TD-HEALTH-PROF-PORTUGAL"
kind: "technology"
title: "SNS; INEM; DGS; INFARMED и португальский medical overlay"
...
# SNS; INEM; DGS; INFARMED и португальский medical overlay
...
- **node_id:** TD-HEALTH-PROF-PORTUGAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** SNS; INEM; DGS; INFARMED и португальский medical overlay
- **outcome:** Иметь измеримую и проверяемую способность: sns; inem; dgs; infarmed и португальский medical overlay
- **safety_class:** S3_LICENSED_PROFESSIONAL
