---
id: "TD-FOOD-COOK-FUEL"
kind: "technology"
title: "Измеренный расход топлива для готовки"
...
# Измеренный расход топлива для готовки
...
- **node_id:** TD-FOOD-COOK-FUEL
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Измеренный расход топлива для готовки
- **outcome:** Иметь измеримую и проверяемую способность: измеренный расход топлива для готовки
- **safety_class:** S2_TRAINED_SUPERVISED
