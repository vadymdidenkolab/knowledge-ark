---
id: "TD-PORTUGAL-INIAV"
kind: "technology"
title: "INIAV: агрономия; почвы; семена и исследования"
...
# INIAV: агрономия; почвы; семена и исследования
...
- **node_id:** TD-PORTUGAL-INIAV
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** INIAV: агрономия; почвы; семена и исследования
- **outcome:** Иметь измеримую и проверяемую способность: iniav: агрономия; почвы; семена и исследования
- **safety_class:** S0_OBSERVE_READ
