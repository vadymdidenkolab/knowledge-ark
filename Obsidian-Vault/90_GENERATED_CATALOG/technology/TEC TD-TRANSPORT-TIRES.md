---
id: "TD-TRANSPORT-TIRES"
kind: "technology"
title: "Шины; давление; износ и запас"
...
- **node_id:** TD-TRANSPORT-TIRES
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** MAINTENANCE
- **title_ru:** Шины; давление; износ и запас
- **outcome:** Иметь измеримую и проверяемую способность: шины; давление; износ и запас
- **safety_class:** S2_TRAINED_SUPERVISED
