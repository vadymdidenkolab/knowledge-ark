---
id: "TD-MATERIALS-PRODUCTION-SMELT"
kind: "technology"
title: "Плавка; литьё; ковка и термообработка"
...
# Плавка; литьё; ковка и термообработка
...
- **node_id:** TD-MATERIALS-PRODUCTION-SMELT
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Плавка; литьё; ковка и термообработка
- **outcome:** Иметь измеримую и проверяемую способность: плавка; литьё; ковка и термообработка
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
