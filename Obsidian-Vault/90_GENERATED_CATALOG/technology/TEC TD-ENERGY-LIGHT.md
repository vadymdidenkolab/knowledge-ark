...
- **node_id:** TD-ENERGY-LIGHT
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** OUTCOME
- **title_ru:** Критическое освещение
- **outcome:** Иметь измеримую и проверяемую способность: критическое освещение
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
