---
id: "TD-PORTUGAL-HAZARDS"
kind: "technology"
title: "Пожар; засуха; жара; наводнение; цунами и землетрясение"
...
# Пожар; засуха; жара; наводнение; цунами и землетрясение
...
- **node_id:** TD-PORTUGAL-HAZARDS
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** SITE_DATA
- **title_ru:** Пожар; засуха; жара; наводнение; цунами и землетрясение
- **outcome:** Иметь измеримую и проверяемую способность: пожар; засуха; жара; наводнение; цунами и землетрясение
- **safety_class:** S2_TRAINED_SUPERVISED
