---
id: "TD-WORKSHOP-PUMPS"
kind: "technology"
title: "Насосы; клапаны и уплотнения"
...
- **node_id:** TD-WORKSHOP-PUMPS
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** MAINTENANCE
- **title_ru:** Насосы; клапаны и уплотнения
- **outcome:** Иметь измеримую и проверяемую способность: насосы; клапаны и уплотнения
- **safety_class:** S3_LICENSED_PROFESSIONAL
