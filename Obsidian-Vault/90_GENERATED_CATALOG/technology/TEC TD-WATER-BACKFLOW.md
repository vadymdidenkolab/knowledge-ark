---
id: "TD-WATER-BACKFLOW"
kind: "technology"
title: "Защита от обратного потока"
...
- **node_id:** TD-WATER-BACKFLOW
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Защита от обратного потока
- **outcome:** Иметь измеримую и проверяемую способность: защита от обратного потока
- **safety_class:** S3_LICENSED_PROFESSIONAL
