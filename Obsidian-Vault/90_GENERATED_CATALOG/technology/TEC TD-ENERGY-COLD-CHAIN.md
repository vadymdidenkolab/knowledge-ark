---
id: "TD-ENERGY-COLD-CHAIN"
kind: "technology"
title: "Энергия для холодовой цепи"
...
- **node_id:** TD-ENERGY-COLD-CHAIN
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** OUTCOME
- **title_ru:** Энергия для холодовой цепи
- **outcome:** Иметь измеримую и проверяемую способность: энергия для холодовой цепи
- **safety_class:** S2_TRAINED_SUPERVISED
