...
id: "TD-METRO-LENGTH"
kind: "technology"
title: "Длина; площадь и геометрия"
...
- **node_id:** TD-METRO-LENGTH
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Длина; площадь и геометрия
- **outcome:** Иметь измеримую и проверяемую способность: длина; площадь и геометрия
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
