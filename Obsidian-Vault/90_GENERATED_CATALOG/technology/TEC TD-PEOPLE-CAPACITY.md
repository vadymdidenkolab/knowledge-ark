---
id: "TD-PEOPLE-CAPACITY"
kind: "technology"
title: "Физическая и навыковая способность выполнять функции"
...
# Физическая и навыковая способность выполнять функции
...
- **node_id:** TD-PEOPLE-CAPACITY
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** TEST
- **title_ru:** Физическая и навыковая способность выполнять функции
- **outcome:** Иметь измеримую и проверяемую способность: физическая и навыковая способность выполнять функции
- **safety_class:** S2_TRAINED_SUPERVISED
