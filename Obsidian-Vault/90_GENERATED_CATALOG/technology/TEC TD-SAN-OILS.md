...
id: "TD-SAN-OILS"
kind: "technology"
title: "Отработанные масла и топливо"
...
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Отработанные масла и топливо
- **outcome:** Иметь измеримую и проверяемую способность: отработанные масла и топливо
- **safety_class:** S3_LICENSED_PROFESSIONAL
