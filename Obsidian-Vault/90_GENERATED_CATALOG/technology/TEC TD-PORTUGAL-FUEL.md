...
id: "TD-PORTUGAL-FUEL"
kind: "technology"
title: "Хранение топлива и пожарные ограничения"
...
# Хранение топлива и пожарные ограничения
...
- **node_id:** TD-PORTUGAL-FUEL
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Хранение топлива и пожарные ограничения
- **outcome:** Иметь измеримую и проверяемую способность: хранение топлива и пожарные ограничения
- **safety_class:** S3_LICENSED_PROFESSIONAL
