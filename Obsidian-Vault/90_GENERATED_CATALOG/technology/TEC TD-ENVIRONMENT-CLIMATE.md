---
id: "TD-ENVIRONMENT-CLIMATE"
kind: "technology"
title: "Климатические траектории и adaptive pathways"
...
# Климатические траектории и adaptive pathways
...
- **node_id:** TD-ENVIRONMENT-CLIMATE
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** KNOWLEDGE
- **title_ru:** Климатические траектории и adaptive pathways
- **outcome:** Иметь измеримую и проверяемую способность: климатические траектории и adaptive pathways
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
