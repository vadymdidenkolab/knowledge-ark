---
id: "TD-CONSTRUCTION-AS-BUILT"
kind: "technology"
title: "As-built чертежи; скрытые сети и ревизии"
...
# As-built чертежи; скрытые сети и ревизии
...
- **node_id:** TD-CONSTRUCTION-AS-BUILT
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** DRAWING
- **title_ru:** As-built чертежи; скрытые сети и ревизии
- **outcome:** Иметь измеримую и проверяемую способность: as-built чертежи; скрытые сети и ревизии
- **safety_class:** S2_TRAINED_SUPERVISED
