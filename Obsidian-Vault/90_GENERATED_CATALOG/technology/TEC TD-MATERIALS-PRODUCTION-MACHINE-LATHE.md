---
id: "TD-MATERIALS-PRODUCTION-MACHINE-LATHE"
kind: "technology"
...
- **node_id:** TD-MATERIALS-PRODUCTION-MACHINE-LATHE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Токарный станок
- **outcome:** Иметь измеримую и проверяемую способность: токарный станок
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
