---
id: "TD-WATER-REDUNDANCY"
kind: "technology"
title: "Отказ одного источника и независимый резерв"
...
# Отказ одного источника и независимый резерв
...
- **node_id:** TD-WATER-REDUNDANCY
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** TEST
- **title_ru:** Отказ одного источника и независимый резерв
- **outcome:** Иметь измеримую и проверяемую способность: отказ одного источника и независимый резерв
- **safety_class:** S2_TRAINED_SUPERVISED
