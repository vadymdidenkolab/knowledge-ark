---
id: "TD-HEALTH-ANAPHYLAXIS"
kind: "technology"
title: "Анафилаксия и персональные rescue medicines"
...
# Анафилаксия и персональные rescue medicines
...
- **node_id:** TD-HEALTH-ANAPHYLAXIS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Анафилаксия и персональные rescue medicines
- **outcome:** Иметь измеримую и проверяемую способность: анафилаксия и персональные rescue medicines
- **safety_class:** S3_LICENSED_PROFESSIONAL
