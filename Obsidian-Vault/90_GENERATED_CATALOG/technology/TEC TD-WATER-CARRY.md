...
id: "TD-WATER-CARRY"
kind: "technology"
title: "Ручная переноска без травмы и загрязнения"
...
# Ручная переноска без травмы и загрязнения
...
- **node_id:** TD-WATER-CARRY
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Ручная переноска без травмы и загрязнения
- **outcome:** Иметь измеримую и проверяемую способность: ручная переноска без травмы и загрязнения
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
