---
id: "TD-HEALTH-PROF-PEDIATRICS"
kind: "technology"
title: "Неонатология и педиатрия"
...
- **node_id:** TD-HEALTH-PROF-PEDIATRICS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Неонатология и педиатрия
- **outcome:** Иметь измеримую и проверяемую способность: неонатология и педиатрия
- **safety_class:** S3_LICENSED_PROFESSIONAL
