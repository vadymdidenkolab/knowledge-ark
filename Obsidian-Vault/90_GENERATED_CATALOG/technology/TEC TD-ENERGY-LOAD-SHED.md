---
id: "TD-ENERGY-LOAD-SHED"
kind: "technology"
title: "Приоритетное отключение нагрузок"
...
# Приоритетное отключение нагрузок
...
- **node_id:** TD-ENERGY-LOAD-SHED
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** GOVERNANCE
- **title_ru:** Приоритетное отключение нагрузок
- **outcome:** Иметь измеримую и проверяемую способность: приоритетное отключение нагрузок
- **safety_class:** S2_TRAINED_SUPERVISED
