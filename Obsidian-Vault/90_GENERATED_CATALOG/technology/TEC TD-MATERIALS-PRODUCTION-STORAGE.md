---
id: "TD-MATERIALS-PRODUCTION-STORAGE"
kind: "technology"
title: "Совместимое хранение материалов"
...
# Совместимое хранение материалов
...
- **node_id:** TD-MATERIALS-PRODUCTION-STORAGE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Совместимое хранение материалов
- **outcome:** Иметь измеримую и проверяемую способность: совместимое хранение материалов
- **safety_class:** S2_TRAINED_SUPERVISED
