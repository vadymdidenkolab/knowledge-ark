---
id: "TD-EDUCATION-TECH-READ"
kind: "technology"
title: "Чтение технического текста и чертежей"
...
# Чтение технического текста и чертежей
...
- **node_id:** TD-EDUCATION-TECH-READ
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** TRAINING
- **title_ru:** Чтение технического текста и чертежей
- **outcome:** Иметь измеримую и проверяемую способность: чтение технического текста и чертежей
- **safety_class:** S2_TRAINED_SUPERVISED
