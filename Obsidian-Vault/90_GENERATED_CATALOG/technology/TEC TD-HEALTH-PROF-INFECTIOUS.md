---
id: "TD-HEALTH-PROF-INFECTIOUS"
kind: "technology"
title: "Инфекционные болезни; IPC и antimicrobial stewardship"
...
# Инфекционные болезни; IPC и antimicrobial stewardship
...
- **node_id:** TD-HEALTH-PROF-INFECTIOUS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Инфекционные болезни; IPC и antimicrobial stewardship
- **outcome:** Иметь измеримую и проверяемую способность: инфекционные болезни; ipc и antimicrobial stewardship
- **safety_class:** S3_LICENSED_PROFESSIONAL
