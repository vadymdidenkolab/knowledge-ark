...
id: "TD-METRO-SPARES"
kind: "technology"
title: "Питание; реактивы и расходники измерений"
...
# Питание; реактивы и расходники измерений
...
- **node_id:** TD-METRO-SPARES
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** MATERIAL
- **title_ru:** Питание; реактивы и расходники измерений
- **outcome:** Иметь измеримую и проверяемую способность: питание; реактивы и расходники измерений
- **safety_class:** S2_TRAINED_SUPERVISED
