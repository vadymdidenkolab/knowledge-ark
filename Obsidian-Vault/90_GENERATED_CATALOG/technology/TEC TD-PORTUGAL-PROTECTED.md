---
id: "TD-PORTUGAL-PROTECTED"
kind: "technology"
title: "Охраняемые земли; побережье и ограничения"
...
# Охраняемые земли; побережье и ограничения
...
- **node_id:** TD-PORTUGAL-PROTECTED
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Охраняемые земли; побережье и ограничения
- **outcome:** Иметь измеримую и проверяемую способность: охраняемые земли; побережье и ограничения
- **safety_class:** S3_LICENSED_PROFESSIONAL
