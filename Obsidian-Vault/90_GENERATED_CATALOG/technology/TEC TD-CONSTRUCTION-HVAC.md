---
id: "TD-CONSTRUCTION-HVAC"
kind: "technology"
title: "Отопление и охлаждение здания"
...
- **node_id:** TD-CONSTRUCTION-HVAC
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Отопление и охлаждение здания
- **outcome:** Иметь измеримую и проверяемую способность: отопление и охлаждение здания
- **safety_class:** S3_LICENSED_PROFESSIONAL
