---
id: "TD-HEALTH-OB-PREECLAMPSIA"
kind: "technology"
title: "Признаки преэклампсии и эклампсии"
...
# Признаки преэклампсии и эклампсии
...
- **node_id:** TD-HEALTH-OB-PREECLAMPSIA
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Признаки преэклампсии и эклампсии
- **outcome:** Иметь измеримую и проверяемую способность: признаки преэклампсии и эклампсии
- **safety_class:** S3_LICENSED_PROFESSIONAL
