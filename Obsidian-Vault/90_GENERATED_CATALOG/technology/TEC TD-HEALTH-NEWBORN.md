---
id: "TD-HEALTH-NEWBORN"
kind: "technology"
title: "Опасные признаки у новорождённого"
...
- **node_id:** TD-HEALTH-NEWBORN
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Опасные признаки у новорождённого
- **outcome:** Иметь измеримую и проверяемую способность: опасные признаки у новорождённого
- **safety_class:** S3_LICENSED_PROFESSIONAL
