---
id: "TD-MATERIALS-PRODUCTION-IDENTITY"
kind: "technology"
title: "Идентификация материала; партии и неизвестных примесей"
...
# Идентификация материала; партии и неизвестных примесей
...
- **node_id:** TD-MATERIALS-PRODUCTION-IDENTITY
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** SITE_DATA
- **title_ru:** Идентификация материала; партии и неизвестных примесей
- **outcome:** Иметь измеримую и проверяемую способность: идентификация материала; партии и неизвестных примесей
- **safety_class:** S2_TRAINED_SUPERVISED
