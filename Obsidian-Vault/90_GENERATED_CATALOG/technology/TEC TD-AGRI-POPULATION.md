---
id: "TD-AGRI-POPULATION"
kind: "technology"
title: "Размер репродуктивной популяции"
...
# Размер репродуктивной популяции
...
- **node_id:** TD-AGRI-POPULATION
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Размер репродуктивной популяции
- **outcome:** Иметь измеримую и проверяемую способность: размер репродуктивной популяции
- **safety_class:** S2_TRAINED_SUPERVISED
