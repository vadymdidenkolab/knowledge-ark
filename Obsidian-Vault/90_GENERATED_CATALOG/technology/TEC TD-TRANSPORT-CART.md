---
id: "TD-TRANSPORT-CART"
kind: "technology"
title: "Ручная тележка и полезная нагрузка"
...
# Ручная тележка и полезная нагрузка
...
- **node_id:** TD-TRANSPORT-CART
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TOOL
- **title_ru:** Ручная тележка и полезная нагрузка
- **outcome:** Иметь измеримую и проверяемую способность: ручная тележка и полезная нагрузка
- **safety_class:** S2_TRAINED_SUPERVISED
