---
id: "TD-SHELTER-ACCESSIBLE-EXIT"
kind: "technology"
title: "Доступный путь выхода"
...
- **node_id:** TD-SHELTER-ACCESSIBLE-EXIT
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** DRAWING
- **title_ru:** Доступный путь выхода
- **outcome:** Иметь измеримую и проверяемую способность: доступный путь выхода
- **safety_class:** S2_TRAINED_SUPERVISED
