---
id: "TD-HEALTH-OB-BLEED"
kind: "technology"
title: "Кровотечение при беременности"
...
- **node_id:** TD-HEALTH-OB-BLEED
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Кровотечение при беременности
- **outcome:** Иметь измеримую и проверяемую способность: кровотечение при беременности
- **safety_class:** S3_LICENSED_PROFESSIONAL
