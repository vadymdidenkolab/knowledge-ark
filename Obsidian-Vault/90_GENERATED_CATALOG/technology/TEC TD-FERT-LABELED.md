...
id: "TD-FERT-LABELED"
kind: "technology"
title: "Готовые маркированные удобрения по анализу и этикетке"
...
# Готовые маркированные удобрения по анализу и этикетке
...
- **node_id:** TD-FERT-LABELED
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Готовые маркированные удобрения по анализу и этикетке
- **outcome:** Иметь измеримую и проверяемую способность: готовые маркированные удобрения по анализу и этикетке
- **safety_class:** S2_TRAINED_SUPERVISED
