...
id: "TD-AGRI-LOSS"
kind: "technology"
title: "Измерение потерь при хранении"
...
- **node_id:** TD-AGRI-LOSS
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Измерение потерь при хранении
- **outcome:** Иметь измеримую и проверяемую способность: измерение потерь при хранении
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
