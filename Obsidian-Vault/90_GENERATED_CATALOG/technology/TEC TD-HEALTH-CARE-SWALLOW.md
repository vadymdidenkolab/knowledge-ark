---
id: "TD-HEALTH-CARE-SWALLOW"
kind: "technology"
title: "Безопасное питание; глотание и риск аспирации"
...
# Безопасное питание; глотание и риск аспирации
...
- **node_id:** TD-HEALTH-CARE-SWALLOW
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Безопасное питание; глотание и риск аспирации
- **outcome:** Иметь измеримую и проверяемую способность: безопасное питание; глотание и риск аспирации
- **safety_class:** S3_LICENSED_PROFESSIONAL
