---
id: "TD-AGRI-PERENNIALS"
kind: "technology"
title: "Многолетние плодовые и орехоплодные"
...
# Многолетние плодовые и орехоплодные
...
- **node_id:** TD-AGRI-PERENNIALS
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Многолетние плодовые и орехоплодные
- **outcome:** Иметь измеримую и проверяемую способность: многолетние плодовые и орехоплодные
- **safety_class:** S2_TRAINED_SUPERVISED
