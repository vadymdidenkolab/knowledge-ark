...
id: "TD-PEOPLE-CHILD"
kind: "technology"
title: "Младенцы; дети и зависимые несовершеннолетние"
...
# Младенцы; дети и зависимые несовершеннолетние
...
- **node_id:** TD-PEOPLE-CHILD
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** GOVERNANCE
- **title_ru:** Младенцы; дети и зависимые несовершеннолетние
- **outcome:** Иметь измеримую и проверяемую способность: младенцы; дети и зависимые несовершеннолетние
- **safety_class:** S2_TRAINED_SUPERVISED
