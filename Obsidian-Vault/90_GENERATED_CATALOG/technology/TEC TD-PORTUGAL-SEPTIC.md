---
id: "TD-PORTUGAL-SEPTIC"
kind: "technology"
title: "Канализация; fossa séptica и санитарные нормы"
...
# Канализация; fossa séptica и санитарные нормы
...
- **node_id:** TD-PORTUGAL-SEPTIC
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Канализация; fossa séptica и санитарные нормы
- **outcome:** Иметь измеримую и проверяемую способность: канализация; fossa séptica и санитарные нормы
- **safety_class:** S3_LICENSED_PROFESSIONAL
