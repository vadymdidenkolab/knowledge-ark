---
id: "TD-COMMS-CONTACTS-PAPER"
kind: "technology"
title: "Бумажные контакты и точки помощи"
...
# Бумажные контакты и точки помощи
...
- **node_id:** TD-COMMS-CONTACTS-PAPER
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** MATERIAL
- **title_ru:** Бумажные контакты и точки помощи
- **outcome:** Иметь измеримую и проверяемую способность: бумажные контакты и точки помощи
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
