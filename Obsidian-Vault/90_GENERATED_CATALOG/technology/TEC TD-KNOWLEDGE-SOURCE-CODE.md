---
id: "TD-KNOWLEDGE-SOURCE-CODE"
kind: "technology"
title: "Исходный код критических инструментов"
...
# Исходный код критических инструментов
...
- **node_id:** TD-KNOWLEDGE-SOURCE-CODE
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** KNOWLEDGE
- **title_ru:** Исходный код критических инструментов
- **outcome:** Иметь измеримую и проверяемую способность: исходный код критических инструментов
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
