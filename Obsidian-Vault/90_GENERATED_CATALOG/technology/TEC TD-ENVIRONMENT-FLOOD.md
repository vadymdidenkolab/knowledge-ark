---
id: "TD-ENVIRONMENT-FLOOD"
kind: "technology"
title: "Наводнение и поверхностный сток"
...
# Наводнение и поверхностный сток
...
- **node_id:** TD-ENVIRONMENT-FLOOD
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** SITE_DATA
- **title_ru:** Наводнение и поверхностный сток
- **outcome:** Иметь измеримую и проверяемую способность: наводнение и поверхностный сток
- **safety_class:** S2_TRAINED_SUPERVISED
