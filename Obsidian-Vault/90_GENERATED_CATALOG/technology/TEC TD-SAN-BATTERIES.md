...
id: "TD-SAN-BATTERIES"
kind: "technology"
title: "Отработанные батареи и аккумуляторы"
...
- **node_id:** TD-SAN-BATTERIES
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Отработанные батареи и аккумуляторы
- **outcome:** Иметь измеримую и проверяемую способность: отработанные батареи и аккумуляторы
- **safety_class:** S3_LICENSED_PROFESSIONAL
