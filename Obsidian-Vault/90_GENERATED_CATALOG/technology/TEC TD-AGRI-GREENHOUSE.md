---
id: "TD-AGRI-GREENHOUSE"
kind: "technology"
title: "Теплица; вентиляция и перегрев"
...
- **node_id:** TD-AGRI-GREENHOUSE
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Теплица; вентиляция и перегрев
- **outcome:** Иметь измеримую и проверяемую способность: теплица; вентиляция и перегрев
- **safety_class:** S2_TRAINED_SUPERVISED
