...
id: "TD-WORKSHOP-MARK"
kind: "technology"
title: "Разметка и reference surfaces"
...
- **node_id:** TD-WORKSHOP-MARK
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Разметка и reference surfaces
- **outcome:** Иметь измеримую и проверяемую способность: разметка и reference surfaces
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
