---
id: "TD-ENVIRONMENT-WEATHER"
kind: "technology"
title: "Погода и локальные наблюдения"
...
- **node_id:** TD-ENVIRONMENT-WEATHER
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** SITE_DATA
- **title_ru:** Погода и локальные наблюдения
- **outcome:** Иметь измеримую и проверяемую способность: погода и локальные наблюдения
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
