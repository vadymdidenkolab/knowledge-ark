---
id: "TD-PEOPLE-CONSENT"
kind: "technology"
title: "Контакты; согласия; доверенные лица и приватность"
...
# Контакты; согласия; доверенные лица и приватность
...
- **node_id:** TD-PEOPLE-CONSENT
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** GOVERNANCE
- **title_ru:** Контакты; согласия; доверенные лица и приватность
- **outcome:** Иметь измеримую и проверяемую способность: контакты; согласия; доверенные лица и приватность
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
