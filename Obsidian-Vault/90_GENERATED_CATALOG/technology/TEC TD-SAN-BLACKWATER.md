---
id: "TD-SAN-BLACKWATER"
kind: "technology"
title: "Чёрные стоки и фекальные загрязнения"
...
# Чёрные стоки и фекальные загрязнения
...
- **node_id:** TD-SAN-BLACKWATER
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Чёрные стоки и фекальные загрязнения
- **outcome:** Иметь измеримую и проверяемую способность: чёрные стоки и фекальные загрязнения
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
