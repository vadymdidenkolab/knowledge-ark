---
id: "TD-TRANSPORT-BRAKES"
kind: "technology"
title: "Тормоза и критерий запрета движения"
...
# Тормоза и критерий запрета движения
...
- **node_id:** TD-TRANSPORT-BRAKES
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** MAINTENANCE
- **title_ru:** Тормоза и критерий запрета движения
- **outcome:** Иметь измеримую и проверяемую способность: тормоза и критерий запрета движения
- **safety_class:** S3_LICENSED_PROFESSIONAL
