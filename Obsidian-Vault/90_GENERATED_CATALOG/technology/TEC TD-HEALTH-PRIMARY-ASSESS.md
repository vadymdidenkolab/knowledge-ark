---
id: "TD-HEALTH-PRIMARY-ASSESS"
kind: "technology"
title: "Первичная оценка; наблюдение и передача информации"
...
# Первичная оценка; наблюдение и передача информации
...
- **node_id:** TD-HEALTH-PRIMARY-ASSESS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Первичная оценка; наблюдение и передача информации
- **outcome:** Иметь измеримую и проверяемую способность: первичная оценка; наблюдение и передача информации
- **safety_class:** S2_TRAINED_SUPERVISED
