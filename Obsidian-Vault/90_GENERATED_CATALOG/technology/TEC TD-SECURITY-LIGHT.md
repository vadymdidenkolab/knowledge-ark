---
id: "TD-SECURITY-LIGHT"
kind: "technology"
title: "Освещение; обзор и устранение скрытых опасных зон"
...
# Освещение; обзор и устранение скрытых опасных зон
...
- **node_id:** TD-SECURITY-LIGHT
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** PROCESS
- **title_ru:** Освещение; обзор и устранение скрытых опасных зон
- **outcome:** Иметь измеримую и проверяемую способность: освещение; обзор и устранение скрытых опасных зон
- **safety_class:** S2_TRAINED_SUPERVISED
