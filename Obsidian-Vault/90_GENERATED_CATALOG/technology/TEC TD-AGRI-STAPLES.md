...
id: "TD-AGRI-STAPLES"
kind: "technology"
title: "Калорийные основные культуры"
...
- **node_id:** TD-AGRI-STAPLES
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Калорийные основные культуры
- **outcome:** Иметь измеримую и проверяемую способность: калорийные основные культуры
- **safety_class:** S2_TRAINED_SUPERVISED
