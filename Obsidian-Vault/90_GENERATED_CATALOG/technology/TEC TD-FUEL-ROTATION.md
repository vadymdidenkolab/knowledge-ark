...
id: "TD-FUEL-ROTATION"
kind: "technology"
title: "Ротация и срок хранения готового топлива"
...
# Ротация и срок хранения готового топлива
...
- **node_id:** TD-FUEL-ROTATION
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** MAINTENANCE
- **title_ru:** Ротация и срок хранения готового топлива
- **outcome:** Иметь измеримую и проверяемую способность: ротация и срок хранения готового топлива
- **safety_class:** S2_TRAINED_SUPERVISED
