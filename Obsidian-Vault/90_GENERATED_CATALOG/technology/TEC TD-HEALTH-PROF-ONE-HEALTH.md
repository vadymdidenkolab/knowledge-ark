---
id: "TD-HEALTH-PROF-ONE-HEALTH"
kind: "technology"
title: "Ветеринарная медицина и One Health"
...
# Ветеринарная медицина и One Health
...
- **node_id:** TD-HEALTH-PROF-ONE-HEALTH
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Ветеринарная медицина и One Health
- **outcome:** Иметь измеримую и проверяемую способность: ветеринарная медицина и one health
- **safety_class:** S3_LICENSED_PROFESSIONAL
