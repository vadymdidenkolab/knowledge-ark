---
id: "TD-HEALTH-P4-GUIDELINE"
kind: "technology"
title: "Guideline governance; evidence synthesis и pharmacovigilance"
...
# Guideline governance; evidence synthesis и pharmacovigilance
...
- **node_id:** TD-HEALTH-P4-GUIDELINE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Guideline governance; evidence synthesis и pharmacovigilance
- **outcome:** Иметь измеримую и проверяемую способность: guideline governance; evidence synthesis и pharmacovigilance
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
