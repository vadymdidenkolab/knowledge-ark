---
id: "TD-HEALTH-SKILL-MATRIX"
kind: "technology"
title: "Матрица first-aid/caregiver навыков и currency"
...
# Матрица first-aid/caregiver навыков и currency
...
- **node_id:** TD-HEALTH-SKILL-MATRIX
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Матрица first-aid/caregiver навыков и currency
- **outcome:** Иметь измеримую и проверяемую способность: матрица first-aid/caregiver навыков и currency
- **safety_class:** S2_TRAINED_SUPERVISED
