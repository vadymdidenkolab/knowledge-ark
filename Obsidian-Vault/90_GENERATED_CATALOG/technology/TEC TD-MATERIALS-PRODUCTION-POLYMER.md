---
id: "TD-MATERIALS-PRODUCTION-POLYMER"
kind: "technology"
title: "Полимеры; резина и совместимость"
...
# Полимеры; резина и совместимость
...
- **node_id:** TD-MATERIALS-PRODUCTION-POLYMER
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** MATERIAL
- **title_ru:** Полимеры; резина и совместимость
- **outcome:** Иметь измеримую и проверяемую способность: полимеры; резина и совместимость
- **safety_class:** S3_LICENSED_PROFESSIONAL
