...
id: "TD-SAN-GREYWATER"
kind: "technology"
title: "Серые воды и законный сброс/повторное использование"
...
# Серые воды и законный сброс/повторное использование
...
- **node_id:** TD-SAN-GREYWATER
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Серые воды и законный сброс/повторное использование
- **outcome:** Иметь измеримую и проверяемую способность: серые воды и законный сброс/повторное использование
- **safety_class:** S3_LICENSED_PROFESSIONAL
