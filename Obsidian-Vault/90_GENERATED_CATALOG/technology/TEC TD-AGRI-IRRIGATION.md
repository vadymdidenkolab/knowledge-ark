---
id: "TD-AGRI-IRRIGATION"
kind: "technology"
title: "Орошение и обслуживание"
...
- **node_id:** TD-AGRI-IRRIGATION
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Орошение и обслуживание
- **outcome:** Иметь измеримую и проверяемую способность: орошение и обслуживание
- **safety_class:** S2_TRAINED_SUPERVISED
