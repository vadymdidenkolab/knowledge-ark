...
id: "TD-PEOPLE-REST"
kind: "technology"
title: "Сон; смены; усталость и безопасная нагрузка"
...
# Сон; смены; усталость и безопасная нагрузка
...
- **node_id:** TD-PEOPLE-REST
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** PROCESS
- **title_ru:** Сон; смены; усталость и безопасная нагрузка
- **outcome:** Иметь измеримую и проверяемую способность: сон; смены; усталость и безопасная нагрузка
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
