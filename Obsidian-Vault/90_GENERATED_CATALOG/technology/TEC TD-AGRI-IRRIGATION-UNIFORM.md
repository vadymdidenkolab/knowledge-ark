---
id: "TD-AGRI-IRRIGATION-UNIFORM"
kind: "technology"
title: "Равномерность полива"
...
- **node_id:** TD-AGRI-IRRIGATION-UNIFORM
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Равномерность полива
- **outcome:** Иметь измеримую и проверяемую способность: равномерность полива
- **safety_class:** S2_TRAINED_SUPERVISED
