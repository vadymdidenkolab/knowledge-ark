---
id: "TD-HEALTH-TEAM-ROLES"
kind: "technology"
title: "Командные роли N2–N7 при неотложной помощи"
...
# Командные роли N2–N7 при неотложной помощи
...
- **node_id:** TD-HEALTH-TEAM-ROLES
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Командные роли N2–N7 при неотложной помощи
- **outcome:** Иметь измеримую и проверяемую способность: командные роли n2–n7 при неотложной помощи
- **safety_class:** S2_TRAINED_SUPERVISED
