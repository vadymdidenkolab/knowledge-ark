---
id: "TD-HEALTH-P4-LEGACY"
kind: "technology"
title: "Устаревшие медицинские методы вне оперативного поиска"
...
# Устаревшие медицинские методы вне оперативного поиска
...
- **node_id:** TD-HEALTH-P4-LEGACY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Устаревшие медицинские методы вне оперативного поиска
- **outcome:** Иметь измеримую и проверяемую способность: устаревшие медицинские методы вне оперативного поиска
- **safety_class:** S0_OBSERVE_READ
