---
id: "TD-AGRI-SWEET-POTATO"
kind: "technology"
title: "Батат и вегетативное размножение"
...
# Батат и вегетативное размножение
...
- **node_id:** TD-AGRI-SWEET-POTATO
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Батат и вегетативное размножение
- **outcome:** Иметь измеримую и проверяемую способность: батат и вегетативное размножение
- **safety_class:** S2_TRAINED_SUPERVISED
