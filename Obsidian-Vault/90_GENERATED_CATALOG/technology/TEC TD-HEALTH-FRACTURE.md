---
id: "TD-HEALTH-FRACTURE"
kind: "technology"
title: "Перелом; вывих и повреждение конечности"
...
# Перелом; вывих и повреждение конечности
...
- **node_id:** TD-HEALTH-FRACTURE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Перелом; вывих и повреждение конечности
- **outcome:** Иметь измеримую и проверяемую способность: перелом; вывих и повреждение конечности
- **safety_class:** S2_TRAINED_SUPERVISED
