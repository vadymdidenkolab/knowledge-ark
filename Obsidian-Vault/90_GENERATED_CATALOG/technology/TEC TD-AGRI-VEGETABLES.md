---
id: "TD-AGRI-VEGETABLES"
kind: "technology"
title: "Овощные культуры и нутриентное разнообразие"
...
# Овощные культуры и нутриентное разнообразие
...
- **node_id:** TD-AGRI-VEGETABLES
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Овощные культуры и нутриентное разнообразие
- **outcome:** Иметь измеримую и проверяемую способность: овощные культуры и нутриентное разнообразие
- **safety_class:** S2_TRAINED_SUPERVISED
