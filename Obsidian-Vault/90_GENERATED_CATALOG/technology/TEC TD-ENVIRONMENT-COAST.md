---
id: "TD-ENVIRONMENT-COAST"
kind: "technology"
title: "Побережье; штормовой нагон и цунами"
...
# Побережье; штормовой нагон и цунами
...
- **node_id:** TD-ENVIRONMENT-COAST
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** SITE_DATA
- **title_ru:** Побережье; штормовой нагон и цунами
- **outcome:** Иметь измеримую и проверяемую способность: побережье; штормовой нагон и цунами
- **safety_class:** S3_LICENSED_PROFESSIONAL
