---
id: "TD-WORKSHOP-SPACE"
kind: "technology"
title: "Рабочее пространство; проходы и уборка"
...
# Рабочее пространство; проходы и уборка
...
- **node_id:** TD-WORKSHOP-SPACE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** SITE_DATA
- **title_ru:** Рабочее пространство; проходы и уборка
- **outcome:** Иметь измеримую и проверяемую способность: рабочее пространство; проходы и уборка
- **safety_class:** S2_TRAINED_SUPERVISED
