---
id: "TD-MATERIALS-PRODUCTION-CARD"
kind: "technology"
title: "Очистка и кардование волокон"
...
- **node_id:** TD-MATERIALS-PRODUCTION-CARD
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Очистка и кардование волокон
- **outcome:** Иметь измеримую и проверяемую способность: очистка и кардование волокон
- **safety_class:** S2_TRAINED_SUPERVISED
