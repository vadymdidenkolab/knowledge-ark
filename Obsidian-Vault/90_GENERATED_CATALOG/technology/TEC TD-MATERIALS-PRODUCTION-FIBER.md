---
id: "TD-MATERIALS-PRODUCTION-FIBER"
kind: "technology"
title: "Растительные и животные волокна"
...
- **node_id:** TD-MATERIALS-PRODUCTION-FIBER
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** MATERIAL
- **title_ru:** Растительные и животные волокна
- **outcome:** Иметь измеримую и проверяемую способность: растительные и животные волокна
- **safety_class:** S2_TRAINED_SUPERVISED
