...
id: "TD-FUEL-ETHANOL"
kind: "technology"
title: "Топливный этанол и перегонка"
...
- **node_id:** TD-FUEL-ETHANOL
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Топливный этанол и перегонка
- **outcome:** Preserve regulatory and industrial overview without home distillation or fuel blending
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
- **execution_policy:** REFERENCE_ONLY_NO_BUILD
- **prerequisite_node_ids:** [[TEC TD-BASE-SAFETY|TD-BASE-SAFETY]]
- **source_package_ids:** не заполнено
- **materials_tools_state:** NO_DISTILLATION_OR_FUEL_BLEND
- **instrument_ids:** не заполнено
- **measurement_acceptance:** No-build; product identification; legal storage and fire response only
- **calibration_reference:** Competent excise; fire and process authorities
- **drawings_bom_state:** NO_STILL_OR_PROCESS_DRAWINGS
- **localization_state:** PORTUGAL_EXCISE_FIRE_AND_ENVIRONMENT_RULES_REQUIRED
- **waste_storage:** Licensed alcohol and contaminated-waste routes
- **stop_conditions:** Flammable vapor; fire; toxic contamination; pressure; hot still; illegal production
- **maintenance_spares:** Industrial controls only
- **successor_proof:** Преемник recognizes no-go and uses legal supplier
...
- **notes:** No mash; distillation; dehydration or blend recipe
