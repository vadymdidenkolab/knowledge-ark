...
- **node_id:** TD-PORTUGAL-112
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** 112 и экстренные службы
- **outcome:** Иметь измеримую и проверяемую способность: 112 и экстренные службы
- **safety_class:** S0_OBSERVE_READ
