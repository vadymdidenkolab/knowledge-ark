...
id: "TD-ANIMALS-BEES"
kind: "technology"
title: "Пчёлы; опыление и продукты пчеловодства"
...
# Пчёлы; опыление и продукты пчеловодства
...
- **node_id:** TD-ANIMALS-BEES
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** PROCESS
- **title_ru:** Пчёлы; опыление и продукты пчеловодства
- **outcome:** Иметь измеримую и проверяемую способность: пчёлы; опыление и продукты пчеловодства
- **safety_class:** S3_LICENSED_PROFESSIONAL
