---
id: "TD-CONSTRUCTION-SANITATION"
kind: "technology"
title: "Канализация; septic и санитарные разрывы"
...
# Канализация; septic и санитарные разрывы
...
- **node_id:** TD-CONSTRUCTION-SANITATION
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Канализация; septic и санитарные разрывы
- **outcome:** Иметь измеримую и проверяемую способность: канализация; septic и санитарные разрывы
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
