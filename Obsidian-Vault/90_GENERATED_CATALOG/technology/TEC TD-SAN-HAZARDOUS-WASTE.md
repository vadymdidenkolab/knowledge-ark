---
id: "TD-SAN-HAZARDOUS-WASTE"
kind: "technology"
title: "Опасные химические отходы"
...
- **node_id:** TD-SAN-HAZARDOUS-WASTE
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Опасные химические отходы
- **outcome:** Иметь измеримую и проверяемую способность: опасные химические отходы
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
