...
id: "TD-WORKSHOP-PPE"
kind: "technology"
title: "PPE по конкретной операции"
...
- **node_id:** TD-WORKSHOP-PPE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** MATERIAL
- **title_ru:** PPE по конкретной операции
- **outcome:** Иметь измеримую и проверяемую способность: ppe по конкретной операции
- **safety_class:** S2_TRAINED_SUPERVISED
