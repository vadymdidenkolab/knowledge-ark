---
id: "TD-MATERIALS-PRODUCTION-FLAX"
kind: "technology"
title: "Лён и локально допустимые волокнистые культуры"
...
# Лён и локально допустимые волокнистые культуры
...
- **node_id:** TD-MATERIALS-PRODUCTION-FLAX
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Лён и локально допустимые волокнистые культуры
- **outcome:** Иметь измеримую и проверяемую способность: лён и локально допустимые волокнистые культуры
- **safety_class:** S2_TRAINED_SUPERVISED
