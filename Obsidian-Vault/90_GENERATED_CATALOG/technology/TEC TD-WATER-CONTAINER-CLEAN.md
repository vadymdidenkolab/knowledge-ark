---
id: "TD-WATER-CONTAINER-CLEAN"
kind: "technology"
title: "Очистка; ротация и браковка ёмкостей"
...
# Очистка; ротация и браковка ёмкостей
...
- **node_id:** TD-WATER-CONTAINER-CLEAN
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** MAINTENANCE
- **title_ru:** Очистка; ротация и браковка ёмкостей
- **outcome:** Иметь измеримую и проверяемую способность: очистка; ротация и браковка ёмкостей
- **safety_class:** S2_TRAINED_SUPERVISED
