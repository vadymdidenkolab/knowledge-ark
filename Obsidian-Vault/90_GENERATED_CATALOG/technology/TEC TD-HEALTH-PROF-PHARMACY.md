---
id: "TD-HEALTH-PROF-PHARMACY"
kind: "technology"
title: "Фармация; medication safety и lawful formulary"
...
# Фармация; medication safety и lawful formulary
...
- **node_id:** TD-HEALTH-PROF-PHARMACY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Фармация; medication safety и lawful formulary
- **outcome:** Иметь измеримую и проверяемую способность: фармация; medication safety и lawful formulary
- **safety_class:** S3_LICENSED_PROFESSIONAL
