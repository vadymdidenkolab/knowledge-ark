---
id: "TD-PORTUGAL-WASTE"
kind: "technology"
title: "Лицензированные операторы отходов"
...
# Лицензированные операторы отходов
...
- **node_id:** TD-PORTUGAL-WASTE
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** SITE_DATA
- **title_ru:** Лицензированные операторы отходов
- **outcome:** Иметь измеримую и проверяемую способность: лицензированные операторы отходов
- **safety_class:** S0_OBSERVE_READ
