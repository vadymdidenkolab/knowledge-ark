---
id: "TD-WORKSHOP-ADHESIVE"
kind: "technology"
title: "Клеевые соединения по маркировке и совместимости"
...
# Клеевые соединения по маркировке и совместимости
...
- **node_id:** TD-WORKSHOP-ADHESIVE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Клеевые соединения по маркировке и совместимости
- **outcome:** Иметь измеримую и проверяемую способность: клеевые соединения по маркировке и совместимости
- **safety_class:** S2_TRAINED_SUPERVISED
