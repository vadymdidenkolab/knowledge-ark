---
id: "TD-PEOPLE-PROFILE"
kind: "technology"
title: "Профиль каждого человека"
...
- **node_id:** TD-PEOPLE-PROFILE
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** SITE_DATA
- **title_ru:** Профиль каждого человека
- **outcome:** Иметь измеримую и проверяемую способность: профиль каждого человека
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
