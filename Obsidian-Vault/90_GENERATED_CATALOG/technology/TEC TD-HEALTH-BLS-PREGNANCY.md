---
id: "TD-HEALTH-BLS-PREGNANCY"
kind: "technology"
title: "Особенности BLS при беременности по очному курсу"
...
# Особенности BLS при беременности по очному курсу
...
- **node_id:** TD-HEALTH-BLS-PREGNANCY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Особенности BLS при беременности по очному курсу
- **outcome:** Иметь измеримую и проверяемую способность: особенности bls при беременности по очному курсу
- **safety_class:** S2_TRAINED_SUPERVISED
