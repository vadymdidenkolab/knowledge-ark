---
id: "TD-PORTUGAL-SEEDS"
kind: "technology"
title: "Семена; сорта; plant health и pesticides"
...
# Семена; сорта; plant health и pesticides
...
- **node_id:** TD-PORTUGAL-SEEDS
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Семена; сорта; plant health и pesticides
- **outcome:** Иметь измеримую и проверяемую способность: семена; сорта; plant health и pesticides
- **safety_class:** S3_LICENSED_PROFESSIONAL
