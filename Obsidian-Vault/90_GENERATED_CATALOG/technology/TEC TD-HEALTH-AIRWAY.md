...
id: "TD-HEALTH-AIRWAY"
kind: "technology"
title: "Удушье и острая непроходимость дыхательных путей"
...
# Удушье и острая непроходимость дыхательных путей
...
- **node_id:** TD-HEALTH-AIRWAY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Удушье и острая непроходимость дыхательных путей
- **outcome:** Иметь измеримую и проверяемую способность: удушье и острая непроходимость дыхательных путей
- **safety_class:** S2_TRAINED_SUPERVISED
