---
id: "TD-SECURITY-CONFLICT"
kind: "technology"
title: "Конфликт интересов; жалоба и независимый review"
...
# Конфликт интересов; жалоба и независимый review
...
- **node_id:** TD-SECURITY-CONFLICT
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** GOVERNANCE
- **title_ru:** Конфликт интересов; жалоба и независимый review
- **outcome:** Иметь измеримую и проверяемую способность: конфликт интересов; жалоба и независимый review
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
