---
id: "TD-METRO-CO-SMOKE"
kind: "technology"
title: "CO и дым штатными извещателями"
...
# CO и дым штатными извещателями
...
- **node_id:** TD-METRO-CO-SMOKE
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** CO и дым штатными извещателями
- **outcome:** Иметь измеримую и проверяемую способность: co и дым штатными извещателями
- **safety_class:** S2_TRAINED_SUPERVISED
