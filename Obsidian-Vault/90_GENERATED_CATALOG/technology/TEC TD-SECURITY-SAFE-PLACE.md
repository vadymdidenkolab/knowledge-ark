---
id: "TD-SECURITY-SAFE-PLACE"
kind: "technology"
title: "Заранее выбранное безопасное место"
...
# Заранее выбранное безопасное место
...
- **node_id:** TD-SECURITY-SAFE-PLACE
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** SITE_DATA
- **title_ru:** Заранее выбранное безопасное место
- **outcome:** Иметь измеримую и проверяемую способность: заранее выбранное безопасное место
- **safety_class:** S2_TRAINED_SUPERVISED
