---
id: "TD-WATER-PORTFOLIO"
kind: "technology"
title: "Портфель независимых источников воды"
...
# Портфель независимых источников воды
...
- **node_id:** TD-WATER-PORTFOLIO
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** OUTCOME
- **title_ru:** Портфель независимых источников воды
- **outcome:** Иметь измеримую и проверяемую способность: портфель независимых источников воды
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
