---
id: "TD-FOOD-COOK-WATER"
kind: "technology"
title: "Питьевая вода для приготовления пищи"
...
- **node_id:** TD-FOOD-COOK-WATER
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Питьевая вода для приготовления пищи
- **outcome:** Иметь измеримую и проверяемую способность: питьевая вода для приготовления пищи
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
