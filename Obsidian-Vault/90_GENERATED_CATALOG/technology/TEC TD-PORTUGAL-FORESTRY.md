---
id: "TD-PORTUGAL-FORESTRY"
kind: "technology"
title: "Лесопользование и расчистка растительности"
...
# Лесопользование и расчистка растительности
...
- **node_id:** TD-PORTUGAL-FORESTRY
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Лесопользование и расчистка растительности
- **outcome:** Иметь измеримую и проверяемую способность: лесопользование и расчистка растительности
- **safety_class:** S3_LICENSED_PROFESSIONAL
