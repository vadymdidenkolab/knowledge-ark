---
id: "TD-METRO-PRESSURE"
kind: "technology"
title: "Давление без вмешательства в опасную систему"
...
# Давление без вмешательства в опасную систему
...
- **node_id:** TD-METRO-PRESSURE
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Давление без вмешательства в опасную систему
- **outcome:** Иметь измеримую и проверяемую способность: давление без вмешательства в опасную систему
- **safety_class:** S3_LICENSED_PROFESSIONAL
