---
id: "TD-METRO-ELECTRIC"
kind: "technology"
title: "Низковольтные V; A; ohm; W и Wh"
...
- **node_id:** TD-METRO-ELECTRIC
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Низковольтные V; A; ohm; W и Wh
- **outcome:** Иметь измеримую и проверяемую способность: низковольтные v; a; ohm; w и wh
- **safety_class:** S2_TRAINED_SUPERVISED
