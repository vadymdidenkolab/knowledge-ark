---
id: "TD-TRANSPORT-RANGE"
kind: "technology"
title: "Дальность; запас и точки возврата"
...
# Дальность; запас и точки возврата
...
- **node_id:** TD-TRANSPORT-RANGE
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TEST
- **title_ru:** Дальность; запас и точки возврата
- **outcome:** Иметь измеримую и проверяемую способность: дальность; запас и точки возврата
- **safety_class:** S2_TRAINED_SUPERVISED
