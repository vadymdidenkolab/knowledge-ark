...
id: "TD-FERT-RESIDUES"
kind: "technology"
title: "Возврат известных растительных остатков"
...
# Возврат известных растительных остатков
...
- **node_id:** TD-FERT-RESIDUES
- **parent_id:** [[TEC TD-FERTILIZERS|TD-FERTILIZERS]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Возврат известных растительных остатков
- **outcome:** Иметь измеримую и проверяемую способность: возврат известных растительных остатков
- **safety_class:** S2_TRAINED_SUPERVISED
