---
id: "TD-HEALTH-TRAUMA-CHEST"
kind: "technology"
title: "Тяжёлая травма груди"
...
- **node_id:** TD-HEALTH-TRAUMA-CHEST
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Тяжёлая травма груди
- **outcome:** Иметь измеримую и проверяемую способность: тяжёлая травма груди
- **safety_class:** S3_LICENSED_PROFESSIONAL
