---
id: "TD-HEALTH-PROF-INTERNAL"
kind: "technology"
title: "Внутренняя медицина и NCD"
...
- **node_id:** TD-HEALTH-PROF-INTERNAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Внутренняя медицина и NCD
- **outcome:** Иметь измеримую и проверяемую способность: внутренняя медицина и ncd
- **safety_class:** S3_LICENSED_PROFESSIONAL
