---
id: "TD-WORKSHOP-ABRASIVE"
kind: "technology"
title: "Абразивная обработка и контроль пыли"
...
# Абразивная обработка и контроль пыли
...
- **node_id:** TD-WORKSHOP-ABRASIVE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Абразивная обработка и контроль пыли
- **outcome:** Иметь измеримую и проверяемую способность: абразивная обработка и контроль пыли
- **safety_class:** S3_LICENSED_PROFESSIONAL
