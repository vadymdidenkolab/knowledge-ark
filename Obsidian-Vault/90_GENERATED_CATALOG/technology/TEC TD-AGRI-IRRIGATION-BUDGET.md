---
id: "TD-AGRI-IRRIGATION-BUDGET"
kind: "technology"
title: "Водный бюджет орошения"
...
- **node_id:** TD-AGRI-IRRIGATION-BUDGET
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Водный бюджет орошения
- **outcome:** Иметь измеримую и проверяемую способность: водный бюджет орошения
- **safety_class:** S2_TRAINED_SUPERVISED
