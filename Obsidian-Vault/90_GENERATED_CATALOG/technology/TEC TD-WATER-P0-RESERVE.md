---
id: "TD-WATER-P0-RESERVE"
kind: "technology"
title: "Закрытый запас питьевой воды на первые 72 часа"
...
# Закрытый запас питьевой воды на первые 72 часа
...
- **node_id:** TD-WATER-P0-RESERVE
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** MATERIAL
- **title_ru:** Закрытый запас питьевой воды на первые 72 часа
- **outcome:** Иметь измеримую и проверяемую способность: закрытый запас питьевой воды на первые 72 часа
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
