...
id: "TD-WATER-LAB"
kind: "technology"
title: "Маршрут лабораторного анализа воды"
...
# Маршрут лабораторного анализа воды
...
- **node_id:** TD-WATER-LAB
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Маршрут лабораторного анализа воды
- **outcome:** Иметь измеримую и проверяемую способность: маршрут лабораторного анализа воды
- **safety_class:** S3_LICENSED_PROFESSIONAL
