---
id: "TD-SECURITY-SAFE-DIRECTION"
kind: "technology"
title: "Распознать опасность; уйти; создать дистанцию"
...
# Распознать опасность; уйти; создать дистанцию
...
- **node_id:** TD-SECURITY-SAFE-DIRECTION
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** TRAINING
- **title_ru:** Распознать опасность; уйти; создать дистанцию
- **outcome:** Иметь измеримую и проверяемую способность: распознать опасность; уйти; создать дистанцию
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
