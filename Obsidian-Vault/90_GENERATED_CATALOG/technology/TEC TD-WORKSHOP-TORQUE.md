---
id: "TD-WORKSHOP-TORQUE"
kind: "technology"
title: "Момент затяжки и критические соединения"
...
# Момент затяжки и критические соединения
...
- **node_id:** TD-WORKSHOP-TORQUE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** TEST
- **title_ru:** Момент затяжки и критические соединения
- **outcome:** Иметь измеримую и проверяемую способность: момент затяжки и критические соединения
- **safety_class:** S3_LICENSED_PROFESSIONAL
