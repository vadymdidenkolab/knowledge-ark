---
id: "TD-MATERIALS-PRODUCTION-POLYMER-MAKE"
kind: "technology"
title: "Промышленное производство полимеров"
...
# Промышленное производство полимеров
...
- **node_id:** TD-MATERIALS-PRODUCTION-POLYMER-MAKE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Промышленное производство полимеров
- **outcome:** Иметь измеримую и проверяемую способность: промышленное производство полимеров
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
