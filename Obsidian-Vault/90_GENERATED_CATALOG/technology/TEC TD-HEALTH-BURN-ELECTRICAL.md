---
id: "TD-HEALTH-BURN-ELECTRICAL"
kind: "technology"
title: "Электрический ожог и скрытый риск"
...
# Электрический ожог и скрытый риск
...
- **node_id:** TD-HEALTH-BURN-ELECTRICAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Электрический ожог и скрытый риск
- **outcome:** Иметь измеримую и проверяемую способность: электрический ожог и скрытый риск
- **safety_class:** S3_LICENSED_PROFESSIONAL
