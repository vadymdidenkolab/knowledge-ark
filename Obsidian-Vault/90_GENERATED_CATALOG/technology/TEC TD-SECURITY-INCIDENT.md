---
id: "TD-SECURITY-INCIDENT"
kind: "technology"
title: "Журнал инцидентов с минимизацией персональных данных"
...
# Журнал инцидентов с минимизацией персональных данных
...
- **node_id:** TD-SECURITY-INCIDENT
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** GOVERNANCE
- **title_ru:** Журнал инцидентов с минимизацией персональных данных
- **outcome:** Иметь измеримую и проверяемую способность: журнал инцидентов с минимизацией персональных данных
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
