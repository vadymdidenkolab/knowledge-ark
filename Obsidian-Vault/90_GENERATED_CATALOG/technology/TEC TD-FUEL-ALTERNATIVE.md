---
id: "TD-FUEL-ALTERNATIVE"
kind: "technology"
title: "Резервная более безопасная альтернатива функции"
...
# Резервная более безопасная альтернатива функции
...
- **node_id:** TD-FUEL-ALTERNATIVE
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** GOVERNANCE
- **title_ru:** Резервная более безопасная альтернатива функции
- **outcome:** Иметь измеримую и проверяемую способность: резервная более безопасная альтернатива функции
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
