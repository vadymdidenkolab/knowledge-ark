---
id: "TD-AGRI-CROP-FAIL"
kind: "technology"
title: "Резерв при неурожае и повторный сезон"
...
# Резерв при неурожае и повторный сезон
...
- **node_id:** TD-AGRI-CROP-FAIL
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** GOVERNANCE
- **title_ru:** Резерв при неурожае и повторный сезон
- **outcome:** Иметь измеримую и проверяемую способность: резерв при неурожае и повторный сезон
- **safety_class:** S2_TRAINED_SUPERVISED
