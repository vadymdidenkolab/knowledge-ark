---
id: "TD-ENERGY-FAILURE"
kind: "technology"
title: "Отказ; изоляция и восстановление критических нагрузок"
...
# Отказ; изоляция и восстановление критических нагрузок
...
- **node_id:** TD-ENERGY-FAILURE
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** TEST
- **title_ru:** Отказ; изоляция и восстановление критических нагрузок
- **outcome:** Иметь измеримую и проверяемую способность: отказ; изоляция и восстановление критических нагрузок
- **safety_class:** S2_TRAINED_SUPERVISED
