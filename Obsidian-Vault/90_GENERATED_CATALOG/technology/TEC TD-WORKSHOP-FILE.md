...
id: "TD-WORKSHOP-FILE"
kind: "technology"
title: "Опиливание и снятие заусенцев"
...
- **node_id:** TD-WORKSHOP-FILE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** TRAINING
- **title_ru:** Опиливание и снятие заусенцев
- **outcome:** Иметь измеримую и проверяемую способность: опиливание и снятие заусенцев
- **safety_class:** S2_TRAINED_SUPERVISED
