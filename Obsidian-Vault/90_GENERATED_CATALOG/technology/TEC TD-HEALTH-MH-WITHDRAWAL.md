---
id: "TD-HEALTH-MH-WITHDRAWAL"
kind: "technology"
title: "Опасная отмена алкоголя или веществ"
...
# Опасная отмена алкоголя или веществ
...
- **node_id:** TD-HEALTH-MH-WITHDRAWAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Опасная отмена алкоголя или веществ
- **outcome:** Иметь измеримую и проверяемую способность: опасная отмена алкоголя или веществ
- **safety_class:** S3_LICENSED_PROFESSIONAL
