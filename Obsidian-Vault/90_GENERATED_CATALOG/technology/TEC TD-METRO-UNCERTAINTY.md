---
id: "TD-METRO-UNCERTAINTY"
kind: "technology"
title: "Неопределённость и decision rule"
...
# Неопределённость и decision rule
...
- **node_id:** TD-METRO-UNCERTAINTY
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** KNOWLEDGE
- **title_ru:** Неопределённость и decision rule
- **outcome:** Иметь измеримую и проверяемую способность: неопределённость и decision rule
- **safety_class:** S2_TRAINED_SUPERVISED
