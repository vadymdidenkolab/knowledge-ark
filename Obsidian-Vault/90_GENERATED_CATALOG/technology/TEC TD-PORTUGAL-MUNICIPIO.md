---
id: "TD-PORTUGAL-MUNICIPIO"
kind: "technology"
title: "Конкретные município; freguesia; адрес и checked date"
...
# Конкретные município; freguesia; адрес и checked date
...
- **node_id:** TD-PORTUGAL-MUNICIPIO
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** SITE_DATA
- **title_ru:** Конкретные município; freguesia; адрес и checked date
- **outcome:** Иметь измеримую и проверяемую способность: конкретные município; freguesia; адрес и checked date
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
...
- **capacity_model:** AUTHORITY_JURISDICTION_VERSION_COVERAGE_AND_CHECKED_DATE
