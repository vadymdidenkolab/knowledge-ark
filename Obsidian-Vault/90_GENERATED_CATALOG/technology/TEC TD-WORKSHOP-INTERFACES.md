---
id: "TD-WORKSHOP-INTERFACES"
kind: "technology"
title: "Стандартизация размеров; резьб; напряжений и разъёмов"
...
# Стандартизация размеров; резьб; напряжений и разъёмов
...
- **node_id:** TD-WORKSHOP-INTERFACES
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** GOVERNANCE
- **title_ru:** Стандартизация размеров; резьб; напряжений и разъёмов
- **outcome:** Иметь измеримую и проверяемую способность: стандартизация размеров; резьб; напряжений и разъёмов
- **safety_class:** S2_TRAINED_SUPERVISED
