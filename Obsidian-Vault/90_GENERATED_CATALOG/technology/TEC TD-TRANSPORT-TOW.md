...
id: "TD-TRANSPORT-TOW"
kind: "technology"
title: "Буксировка; точки крепления и правовая граница"
...
# Буксировка; точки крепления и правовая граница
...
- **node_id:** TD-TRANSPORT-TOW
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** PROCESS
- **title_ru:** Буксировка; точки крепления и правовая граница
- **outcome:** Иметь измеримую и проверяемую способность: буксировка; точки крепления и правовая граница
- **safety_class:** S3_LICENSED_PROFESSIONAL
