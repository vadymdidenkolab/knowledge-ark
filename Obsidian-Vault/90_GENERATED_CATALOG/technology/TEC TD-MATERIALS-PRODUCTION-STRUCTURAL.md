---
id: "TD-MATERIALS-PRODUCTION-STRUCTURAL"
kind: "technology"
title: "Конструктивное применение материалов"
...
# Конструктивное применение материалов
...
- **node_id:** TD-MATERIALS-PRODUCTION-STRUCTURAL
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Конструктивное применение материалов
- **outcome:** Иметь измеримую и проверяемую способность: конструктивное применение материалов
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
