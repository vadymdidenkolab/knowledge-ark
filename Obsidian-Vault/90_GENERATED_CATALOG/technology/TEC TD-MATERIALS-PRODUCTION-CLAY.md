---
id: "TD-MATERIALS-PRODUCTION-CLAY"
kind: "technology"
title: "Идентификация и подготовка глины"
...
# Идентификация и подготовка глины
...
- **node_id:** TD-MATERIALS-PRODUCTION-CLAY
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Идентификация и подготовка глины
- **outcome:** Иметь измеримую и проверяемую способность: идентификация и подготовка глины
- **safety_class:** S3_LICENSED_PROFESSIONAL
