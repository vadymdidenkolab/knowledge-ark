---
id: "TD-HEALTH-BLS-ADULT"
kind: "technology"
title: "BLS/AED для взрослого по очному курсу"
...
# BLS/AED для взрослого по очному курсу
...
- **node_id:** TD-HEALTH-BLS-ADULT
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** BLS/AED для взрослого по очному курсу
- **outcome:** Иметь измеримую и проверяемую способность: bls/aed для взрослого по очному курсу
- **safety_class:** S2_TRAINED_SUPERVISED
