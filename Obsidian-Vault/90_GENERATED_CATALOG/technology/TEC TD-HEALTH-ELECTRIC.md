---
id: "TD-HEALTH-ELECTRIC"
kind: "technology"
title: "Электротравма и молния"
...
- **node_id:** TD-HEALTH-ELECTRIC
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Электротравма и молния
- **outcome:** Иметь измеримую и проверяемую способность: электротравма и молния
- **safety_class:** S2_TRAINED_SUPERVISED
