---
id: "TD-PEOPLE-PREGNANCY"
kind: "technology"
title: "Беременность; новорождённые и репродуктивные потребности"
...
# Беременность; новорождённые и репродуктивные потребности
...
- **node_id:** TD-PEOPLE-PREGNANCY
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** SITE_DATA
- **title_ru:** Беременность; новорождённые и репродуктивные потребности
- **outcome:** Иметь измеримую и проверяемую способность: беременность; новорождённые и репродуктивные потребности
- **safety_class:** S3_LICENSED_PROFESSIONAL
