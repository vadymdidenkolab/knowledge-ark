...
id: "TD-GOV-WAREHOUSE"
kind: "technology"
title: "Склад; зоны совместимости и доступ"
...
# Склад; зоны совместимости и доступ
...
- **node_id:** TD-GOV-WAREHOUSE
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** SITE_DATA
- **title_ru:** Склад; зоны совместимости и доступ
- **outcome:** Иметь измеримую и проверяемую способность: склад; зоны совместимости и доступ
- **safety_class:** S2_TRAINED_SUPERVISED
