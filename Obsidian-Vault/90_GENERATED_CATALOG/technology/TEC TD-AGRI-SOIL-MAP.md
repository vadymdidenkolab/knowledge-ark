...
id: "TD-AGRI-SOIL-MAP"
kind: "technology"
title: "Карта почв и неоднородности"
...
- **node_id:** TD-AGRI-SOIL-MAP
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** SITE_DATA
- **title_ru:** Карта почв и неоднородности
- **outcome:** Иметь измеримую и проверяемую способность: карта почв и неоднородности
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
