---
id: "TD-HEALTH-MED-WASTE"
kind: "technology"
title: "Острые и загрязнённые медицинские отходы"
...
# Острые и загрязнённые медицинские отходы
...
- **node_id:** TD-HEALTH-MED-WASTE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Острые и загрязнённые медицинские отходы
- **outcome:** Иметь измеримую и проверяемую способность: острые и загрязнённые медицинские отходы
- **safety_class:** S3_LICENSED_PROFESSIONAL
