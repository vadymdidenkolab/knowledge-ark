---
id: "TD-GOV-VULNERABLE"
kind: "technology"
title: "Защита уязвимых и зависимых участников"
...
# Защита уязвимых и зависимых участников
...
- **node_id:** TD-GOV-VULNERABLE
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** GOVERNANCE
- **title_ru:** Защита уязвимых и зависимых участников
- **outcome:** Иметь измеримую и проверяемую способность: защита уязвимых и зависимых участников
- **safety_class:** S2_TRAINED_SUPERVISED
