---
id: "TD-HEALTH-CONTACTS"
kind: "technology"
title: "112; SNS 24; CIAV и структурированный вызов"
...
# 112; SNS 24; CIAV и структурированный вызов
...
- **node_id:** TD-HEALTH-CONTACTS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** 112; SNS 24; CIAV и структурированный вызов
- **outcome:** Иметь измеримую и проверяемую способность: 112; sns 24; ciav и структурированный вызов
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
