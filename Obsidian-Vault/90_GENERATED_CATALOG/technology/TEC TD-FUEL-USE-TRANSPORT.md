---
id: "TD-FUEL-USE-TRANSPORT"
kind: "technology"
title: "Топливо для транспорта"
...
- **node_id:** TD-FUEL-USE-TRANSPORT
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** PROCESS
- **title_ru:** Топливо для транспорта
- **outcome:** Иметь измеримую и проверяемую способность: топливо для транспорта
- **safety_class:** S3_LICENSED_PROFESSIONAL
