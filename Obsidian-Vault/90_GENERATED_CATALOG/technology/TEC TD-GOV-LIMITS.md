...
id: "TD-GOV-LIMITS"
kind: "technology"
title: "Ограничение чрезвычайных полномочий и сроков"
...
# Ограничение чрезвычайных полномочий и сроков
...
- **node_id:** TD-GOV-LIMITS
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** GOVERNANCE
- **title_ru:** Ограничение чрезвычайных полномочий и сроков
- **outcome:** Иметь измеримую и проверяемую способность: ограничение чрезвычайных полномочий и сроков
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
