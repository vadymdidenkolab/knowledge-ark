---
id: "TD-HEALTH-P4-EDUCATION"
kind: "technology"
title: "Профессиональная медицинская образовательная линия"
...
# Профессиональная медицинская образовательная линия
...
- **node_id:** TD-HEALTH-P4-EDUCATION
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Профессиональная медицинская образовательная линия
- **outcome:** Иметь измеримую и проверяемую способность: профессиональная медицинская образовательная линия
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
