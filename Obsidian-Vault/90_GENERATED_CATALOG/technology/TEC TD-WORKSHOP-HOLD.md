...
id: "TD-WORKSHOP-HOLD"
kind: "technology"
title: "Удержание детали и workholding"
...
# Удержание детали и workholding
...
- **node_id:** TD-WORKSHOP-HOLD
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** TOOL
- **title_ru:** Удержание детали и workholding
- **outcome:** Иметь измеримую и проверяемую способность: удержание детали и workholding
- **safety_class:** S2_TRAINED_SUPERVISED
