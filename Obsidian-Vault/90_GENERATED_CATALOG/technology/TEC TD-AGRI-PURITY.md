...
id: "TD-AGRI-PURITY"
kind: "technology"
title: "Сортовая идентичность и чистота"
...
# Сортовая идентичность и чистота
...
- **node_id:** TD-AGRI-PURITY
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TEST
- **title_ru:** Сортовая идентичность и чистота
- **outcome:** Иметь измеримую и проверяемую способность: сортовая идентичность и чистота
- **safety_class:** S2_TRAINED_SUPERVISED
