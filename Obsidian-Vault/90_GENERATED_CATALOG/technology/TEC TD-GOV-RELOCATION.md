---
id: "TD-GOV-RELOCATION"
kind: "technology"
title: "Законный перенос людей; архивов и функций"
...
# Законный перенос людей; архивов и функций
...
- **node_id:** TD-GOV-RELOCATION
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** PROCESS
- **title_ru:** Законный перенос людей; архивов и функций
- **outcome:** Иметь измеримую и проверяемую способность: законный перенос людей; архивов и функций
- **safety_class:** S2_TRAINED_SUPERVISED
