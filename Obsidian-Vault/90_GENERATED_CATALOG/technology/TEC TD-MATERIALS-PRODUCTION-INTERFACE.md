---
id: "TD-MATERIALS-PRODUCTION-INTERFACE"
kind: "technology"
title: "Стандартизация интерфейсов и взаимозаменяемость"
...
# Стандартизация интерфейсов и взаимозаменяемость
...
- **node_id:** TD-MATERIALS-PRODUCTION-INTERFACE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** GOVERNANCE
- **title_ru:** Стандартизация интерфейсов и взаимозаменяемость
- **outcome:** Иметь измеримую и проверяемую способность: стандартизация интерфейсов и взаимозаменяемость
- **safety_class:** S2_TRAINED_SUPERVISED
