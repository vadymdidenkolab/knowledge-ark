---
id: "TD-COMMS-WARNINGS"
kind: "technology"
title: "Официальный приём предупреждений"
...
# Официальный приём предупреждений
...
- **node_id:** TD-COMMS-WARNINGS
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** PROCESS
- **title_ru:** Официальный приём предупреждений
- **outcome:** Иметь измеримую и проверяемую способность: официальный приём предупреждений
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
