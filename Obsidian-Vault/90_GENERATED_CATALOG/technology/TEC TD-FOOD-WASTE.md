...
id: "TD-FOOD-WASTE"
kind: "technology"
title: "Пищевые отходы без загрязнения воды и хранилища"
...
# Пищевые отходы без загрязнения воды и хранилища
...
- **node_id:** TD-FOOD-WASTE
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Пищевые отходы без загрязнения воды и хранилища
- **outcome:** Иметь измеримую и проверяемую способность: пищевые отходы без загрязнения воды и хранилища
- **safety_class:** S2_TRAINED_SUPERVISED
