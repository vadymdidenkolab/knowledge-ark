---
id: "TD-CONSTRUCTION-TEMP"
kind: "technology"
title: "Временные сооружения и пределы нагрузки"
...
# Временные сооружения и пределы нагрузки
...
- **node_id:** TD-CONSTRUCTION-TEMP
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Временные сооружения и пределы нагрузки
- **outcome:** Иметь измеримую и проверяемую способность: временные сооружения и пределы нагрузки
- **safety_class:** S3_LICENSED_PROFESSIONAL
