---
id: "TD-HEALTH-SCENE-PPE"
kind: "technology"
title: "Безопасность места происшествия и PPE"
...
# Безопасность места происшествия и PPE
...
- **node_id:** TD-HEALTH-SCENE-PPE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Безопасность места происшествия и PPE
- **outcome:** Иметь измеримую и проверяемую способность: безопасность места происшествия и ppe
- **safety_class:** S2_TRAINED_SUPERVISED
