---
id: "TD-HEALTH-LONE-PERSON"
kind: "technology"
title: "Самопомощь; SOS и check-in для одного человека"
...
# Самопомощь; SOS и check-in для одного человека
...
- **node_id:** TD-HEALTH-LONE-PERSON
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Самопомощь; SOS и check-in для одного человека
- **outcome:** Иметь измеримую и проверяемую способность: самопомощь; sos и check-in для одного человека
- **safety_class:** S2_TRAINED_SUPERVISED
