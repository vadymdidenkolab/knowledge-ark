---
id: "TD-SAN-INCONTINENCE"
kind: "technology"
title: "Недержание и caregiver hygiene"
...
# Недержание и caregiver hygiene
...
- **node_id:** TD-SAN-INCONTINENCE
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Недержание и caregiver hygiene
- **outcome:** Иметь измеримую и проверяемую способность: недержание и caregiver hygiene
- **safety_class:** S2_TRAINED_SUPERVISED
