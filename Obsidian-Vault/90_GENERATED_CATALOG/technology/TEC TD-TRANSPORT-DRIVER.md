---
id: "TD-TRANSPORT-DRIVER"
kind: "technology"
title: "Водитель; право; навыки и документы"
...
# Водитель; право; навыки и документы
...
- **node_id:** TD-TRANSPORT-DRIVER
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TRAINING
- **title_ru:** Водитель; право; навыки и документы
- **outcome:** Иметь измеримую и проверяемую способность: водитель; право; навыки и документы
- **safety_class:** S3_LICENSED_PROFESSIONAL
