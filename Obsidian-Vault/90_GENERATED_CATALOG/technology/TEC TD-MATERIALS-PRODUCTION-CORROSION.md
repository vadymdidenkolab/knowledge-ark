---
id: "TD-MATERIALS-PRODUCTION-CORROSION"
kind: "technology"
title: "Коррозия; защита и inspection"
...
- **node_id:** TD-MATERIALS-PRODUCTION-CORROSION
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Коррозия; защита и inspection
- **outcome:** Иметь измеримую и проверяемую способность: коррозия; защита и inspection
- **safety_class:** S2_TRAINED_SUPERVISED
