---
id: "TD-HEALTH-AMPUTATION-IMPALED"
kind: "technology"
title: "Ампутация; открытый перелом и застрявший предмет"
...
# Ампутация; открытый перелом и застрявший предмет
...
- **node_id:** TD-HEALTH-AMPUTATION-IMPALED
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Ампутация; открытый перелом и застрявший предмет
- **outcome:** Иметь измеримую и проверяемую способность: ампутация; открытый перелом и застрявший предмет
- **safety_class:** S2_TRAINED_SUPERVISED
