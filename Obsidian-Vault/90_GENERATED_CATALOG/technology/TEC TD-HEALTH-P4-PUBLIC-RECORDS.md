---
id: "TD-HEALTH-P4-PUBLIC-RECORDS"
kind: "technology"
title: "Public-health records; демография и outbreak history"
...
# Public-health records; демография и outbreak history
...
- **node_id:** TD-HEALTH-P4-PUBLIC-RECORDS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Public-health records; демография и outbreak history
- **outcome:** Иметь измеримую и проверяемую способность: public-health records; демография и outbreak history
- **safety_class:** S3_LICENSED_PROFESSIONAL
