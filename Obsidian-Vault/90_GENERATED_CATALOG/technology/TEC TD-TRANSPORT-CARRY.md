---
id: "TD-TRANSPORT-CARRY"
kind: "technology"
title: "Безопасная переноска груза"
...
- **node_id:** TD-TRANSPORT-CARRY
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TRAINING
- **title_ru:** Безопасная переноска груза
- **outcome:** Иметь измеримую и проверяемую способность: безопасная переноска груза
- **safety_class:** S2_TRAINED_SUPERVISED
