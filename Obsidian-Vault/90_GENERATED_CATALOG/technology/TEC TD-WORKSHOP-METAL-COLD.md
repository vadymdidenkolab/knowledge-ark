---
id: "TD-WORKSHOP-METAL-COLD"
kind: "technology"
title: "Холодная обработка металла"
...
- **node_id:** TD-WORKSHOP-METAL-COLD
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Холодная обработка металла
- **outcome:** Иметь измеримую и проверяемую способность: холодная обработка металла
- **safety_class:** S3_LICENSED_PROFESSIONAL
