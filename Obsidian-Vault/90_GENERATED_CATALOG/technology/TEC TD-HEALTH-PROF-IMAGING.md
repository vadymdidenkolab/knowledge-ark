---
id: "TD-HEALTH-PROF-IMAGING"
kind: "technology"
title: "УЗИ; рентген и медицинская визуализация"
...
# УЗИ; рентген и медицинская визуализация
...
- **node_id:** TD-HEALTH-PROF-IMAGING
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** УЗИ; рентген и медицинская визуализация
- **outcome:** Иметь измеримую и проверяемую способность: узи; рентген и медицинская визуализация
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
