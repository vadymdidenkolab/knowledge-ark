...
id: "TD-AGRI-TOPO"
kind: "technology"
title: "Топография; уклоны и зоны стока участка"
...
# Топография; уклоны и зоны стока участка
...
- **node_id:** TD-AGRI-TOPO
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** SITE_DATA
- **title_ru:** Топография; уклоны и зоны стока участка
- **outcome:** Иметь измеримую и проверяемую способность: топография; уклоны и зоны стока участка
- **safety_class:** S2_TRAINED_SUPERVISED
