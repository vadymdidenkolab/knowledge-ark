---
id: "TD-HEALTH-PROF-PALLIATIVE"
kind: "technology"
title: "Паллиативная помощь и конец жизни"
...
# Паллиативная помощь и конец жизни
...
- **node_id:** TD-HEALTH-PROF-PALLIATIVE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Паллиативная помощь и конец жизни
- **outcome:** Иметь измеримую и проверяемую способность: паллиативная помощь и конец жизни
- **safety_class:** S3_LICENSED_PROFESSIONAL
