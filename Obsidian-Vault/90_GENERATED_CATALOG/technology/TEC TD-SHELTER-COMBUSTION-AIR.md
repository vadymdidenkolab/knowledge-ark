---
id: "TD-SHELTER-COMBUSTION-AIR"
kind: "technology"
title: "Вентиляция при готовке и отоплении"
...
# Вентиляция при готовке и отоплении
...
- **node_id:** TD-SHELTER-COMBUSTION-AIR
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** PROCESS
- **title_ru:** Вентиляция при готовке и отоплении
- **outcome:** Иметь измеримую и проверяемую способность: вентиляция при готовке и отоплении
- **safety_class:** S3_LICENSED_PROFESSIONAL
