---
id: "TD-HEALTH-MH-PSYCHOSIS"
kind: "technology"
title: "Психоз и безопасная маршрутизация"
...
# Психоз и безопасная маршрутизация
...
- **node_id:** TD-HEALTH-MH-PSYCHOSIS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Психоз и безопасная маршрутизация
- **outcome:** Иметь измеримую и проверяемую способность: психоз и безопасная маршрутизация
- **safety_class:** S3_LICENSED_PROFESSIONAL
