...
id: "TD-HEALTH-RESP"
kind: "technology"
title: "Острая дыхательная проблема; астма и COPD"
...
# Острая дыхательная проблема; астма и COPD
...
- **node_id:** TD-HEALTH-RESP
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Острая дыхательная проблема; астма и COPD
- **outcome:** Иметь измеримую и проверяемую способность: острая дыхательная проблема; астма и copd
- **safety_class:** S3_LICENSED_PROFESSIONAL
