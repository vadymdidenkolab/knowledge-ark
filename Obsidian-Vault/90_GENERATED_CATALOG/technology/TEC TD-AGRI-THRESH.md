...
id: "TD-AGRI-THRESH"
kind: "technology"
title: "Обмолот и отделение семян"
...
- **node_id:** TD-AGRI-THRESH
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Обмолот и отделение семян
- **outcome:** Иметь измеримую и проверяемую способность: обмолот и отделение семян
- **safety_class:** S2_TRAINED_SUPERVISED
