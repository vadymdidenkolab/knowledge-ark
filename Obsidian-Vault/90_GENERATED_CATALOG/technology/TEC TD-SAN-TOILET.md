...
id: "TD-SAN-TOILET"
kind: "technology"
title: "Аварийный туалет и пропускная способность"
...
# Аварийный туалет и пропускная способность
...
- **node_id:** TD-SAN-TOILET
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Аварийный туалет и пропускная способность
- **outcome:** Иметь измеримую и проверяемую способность: аварийный туалет и пропускная способность
- **safety_class:** S2_TRAINED_SUPERVISED
