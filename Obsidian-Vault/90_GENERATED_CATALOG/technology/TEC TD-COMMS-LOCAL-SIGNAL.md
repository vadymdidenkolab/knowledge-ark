---
id: "TD-COMMS-LOCAL-SIGNAL"
kind: "technology"
title: "Локальные визуальные и звуковые сигналы"
...
# Локальные визуальные и звуковые сигналы
...
- **node_id:** TD-COMMS-LOCAL-SIGNAL
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** PROCESS
- **title_ru:** Локальные визуальные и звуковые сигналы
- **outcome:** Иметь измеримую и проверяемую способность: локальные визуальные и звуковые сигналы
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
