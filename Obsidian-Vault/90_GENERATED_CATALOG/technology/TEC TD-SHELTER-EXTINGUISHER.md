---
id: "TD-SHELTER-EXTINGUISHER"
kind: "technology"
title: "Сертифицированный огнетушитель и предел применения"
...
# Сертифицированный огнетушитель и предел применения
...
- **node_id:** TD-SHELTER-EXTINGUISHER
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** TRAINING
- **title_ru:** Сертифицированный огнетушитель и предел применения
- **outcome:** Иметь измеримую и проверяемую способность: сертифицированный огнетушитель и предел применения
- **safety_class:** S2_TRAINED_SUPERVISED
