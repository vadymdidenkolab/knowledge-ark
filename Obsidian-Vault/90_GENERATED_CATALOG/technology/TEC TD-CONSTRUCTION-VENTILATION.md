---
id: "TD-CONSTRUCTION-VENTILATION"
kind: "technology"
title: "Расчёт и обслуживание вентиляции"
...
# Расчёт и обслуживание вентиляции
...
- **node_id:** TD-CONSTRUCTION-VENTILATION
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Расчёт и обслуживание вентиляции
- **outcome:** Иметь измеримую и проверяемую способность: расчёт и обслуживание вентиляции
- **safety_class:** S3_LICENSED_PROFESSIONAL
