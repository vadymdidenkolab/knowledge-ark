---
id: "TD-HEALTH-PROF-BLOOD"
kind: "technology"
title: "Кровь; совместимость и трансфузия"
...
# Кровь; совместимость и трансфузия
...
- **node_id:** TD-HEALTH-PROF-BLOOD
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Кровь; совместимость и трансфузия
- **outcome:** Иметь измеримую и проверяемую способность: кровь; совместимость и трансфузия
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
