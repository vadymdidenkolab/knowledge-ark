---
id: "TD-ANIMALS-HANDLER"
kind: "technology"
title: "Дублёр handler и безопасное обращение"
...
# Дублёр handler и безопасное обращение
...
- **node_id:** TD-ANIMALS-HANDLER
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** TRAINING
- **title_ru:** Дублёр handler и безопасное обращение
- **outcome:** Иметь измеримую и проверяемую способность: дублёр handler и безопасное обращение
- **safety_class:** S2_TRAINED_SUPERVISED
