---
id: "TD-TRANSPORT-PUMP"
kind: "technology"
title: "Насос; манометр и переходники"
...
- **node_id:** TD-TRANSPORT-PUMP
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** TOOL
- **title_ru:** Насос; манометр и переходники
- **outcome:** Иметь измеримую и проверяемую способность: насос; манометр и переходники
- **safety_class:** S2_TRAINED_SUPERVISED
