...
id: "TD-AGRI-DRAINAGE"
kind: "technology"
title: "Дренаж; эрозия и заболачивание"
...
- **node_id:** TD-AGRI-DRAINAGE
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Дренаж; эрозия и заболачивание
- **outcome:** Иметь измеримую и проверяемую способность: дренаж; эрозия и заболачивание
- **safety_class:** S2_TRAINED_SUPERVISED
