...
id: "TD-FUEL-USE-COOK"
kind: "technology"
title: "Топливо для готовки и измеренный расход"
...
# Топливо для готовки и измеренный расход
...
- **node_id:** TD-FUEL-USE-COOK
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** PROCESS
- **title_ru:** Топливо для готовки и измеренный расход
- **outcome:** Иметь измеримую и проверяемую способность: топливо для готовки и измеренный расход
- **safety_class:** S2_TRAINED_SUPERVISED
