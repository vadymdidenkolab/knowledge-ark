---
id: "TD-EDUCATION-NUMERACY"
kind: "technology"
title: "Арифметика; единицы и пропорции"
...
# Арифметика; единицы и пропорции
...
- **node_id:** TD-EDUCATION-NUMERACY
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** TRAINING
- **title_ru:** Арифметика; единицы и пропорции
- **outcome:** Иметь измеримую и проверяемую способность: арифметика; единицы и пропорции
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
