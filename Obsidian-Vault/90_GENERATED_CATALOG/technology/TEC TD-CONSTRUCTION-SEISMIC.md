---
id: "TD-CONSTRUCTION-SEISMIC"
kind: "technology"
title: "Сейсмическая оценка"
...
- **node_id:** TD-CONSTRUCTION-SEISMIC
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Сейсмическая оценка
- **outcome:** Иметь измеримую и проверяемую способность: сейсмическая оценка
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
