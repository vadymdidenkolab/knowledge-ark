...
id: "TD-GOV-TRADE"
kind: "technology"
title: "Законный обмен; специализация и договорённости"
...
# Законный обмен; специализация и договорённости
...
- **node_id:** TD-GOV-TRADE
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** GOVERNANCE
- **title_ru:** Законный обмен; специализация и договорённости
- **outcome:** Иметь измеримую и проверяемую способность: законный обмен; специализация и договорённости
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
