---
id: "TD-PORTUGAL-RAIN-REUSE"
kind: "technology"
title: "Дождевая вода и повторное использование"
...
# Дождевая вода и повторное использование
...
- **node_id:** TD-PORTUGAL-RAIN-REUSE
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Дождевая вода и повторное использование
- **outcome:** Иметь измеримую и проверяемую способность: дождевая вода и повторное использование
- **safety_class:** S3_LICENSED_PROFESSIONAL
