---
id: "TD-FOOD-HAND-TOOLS"
kind: "technology"
title: "Ручной открыватель; посуда и базовые кухонные инструменты"
...
# Ручной открыватель; посуда и базовые кухонные инструменты
...
- **node_id:** TD-FOOD-HAND-TOOLS
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** TOOL
- **title_ru:** Ручной открыватель; посуда и базовые кухонные инструменты
- **outcome:** Иметь измеримую и проверяемую способность: ручной открыватель; посуда и базовые кухонные инструменты
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
