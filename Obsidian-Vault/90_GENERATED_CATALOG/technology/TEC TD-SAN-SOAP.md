...
id: "TD-SAN-SOAP"
kind: "technology"
title: "Мыло; расходники и ротация"
...
- **domain:** WATER_WASH
- **node_type:** MATERIAL
- **title_ru:** Мыло; расходники и ротация
- **outcome:** Иметь измеримую и проверяемую способность: мыло; расходники и ротация
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
