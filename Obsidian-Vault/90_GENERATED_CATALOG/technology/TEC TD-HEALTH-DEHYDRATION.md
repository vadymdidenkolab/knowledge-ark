---
id: "TD-HEALTH-DEHYDRATION"
kind: "technology"
title: "Обезвоживание; диарея и рвота"
...
- **node_id:** TD-HEALTH-DEHYDRATION
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Обезвоживание; диарея и рвота
- **outcome:** Иметь измеримую и проверяемую способность: обезвоживание; диарея и рвота
- **safety_class:** S2_TRAINED_SUPERVISED
