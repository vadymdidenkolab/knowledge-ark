---
id: "TD-EDUCATION-INSTRUCTOR"
kind: "technology"
title: "Преемственность инструкторов"
...
- **node_id:** TD-EDUCATION-INSTRUCTOR
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** GOVERNANCE
- **title_ru:** Преемственность инструкторов
- **outcome:** Иметь измеримую и проверяемую способность: преемственность инструкторов
- **safety_class:** S2_TRAINED_SUPERVISED
