---
id: "TD-TRANSPORT-ROUTE"
kind: "technology"
title: "Маршрут; высота; покрытие и сезон"
...
# Маршрут; высота; покрытие и сезон
...
- **node_id:** TD-TRANSPORT-ROUTE
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** DRAWING
- **title_ru:** Маршрут; высота; покрытие и сезон
- **outcome:** Иметь измеримую и проверяемую способность: маршрут; высота; покрытие и сезон
- **safety_class:** S2_TRAINED_SUPERVISED
