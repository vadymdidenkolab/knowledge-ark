---
id: "TD-EDUCATION-RECERT"
kind: "technology"
title: "Переоценка; срок навыка и recertification"
...
# Переоценка; срок навыка и recertification
...
- **node_id:** TD-EDUCATION-RECERT
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** MAINTENANCE
- **title_ru:** Переоценка; срок навыка и recertification
- **outcome:** Иметь измеримую и проверяемую способность: переоценка; срок навыка и recertification
- **safety_class:** S2_TRAINED_SUPERVISED
