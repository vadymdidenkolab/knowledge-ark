...
- **node_id:** TD-ENERGY-COMMS
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** OUTCOME
- **title_ru:** Заряд и питание связи
- **outcome:** Иметь измеримую и проверяемую способность: заряд и питание связи
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
