---
id: "TD-HEALTH-PROF-OCCUPATIONAL"
kind: "technology"
title: "Профессиональная медицина"
...
- **node_id:** TD-HEALTH-PROF-OCCUPATIONAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Профессиональная медицина
- **outcome:** Иметь измеримую и проверяемую способность: профессиональная медицина
- **safety_class:** S3_LICENSED_PROFESSIONAL
