---
id: "TD-METRO-POSITION"
kind: "technology"
title: "Координаты; азимут и высота"
...
- **node_id:** TD-METRO-POSITION
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Координаты; азимут и высота
- **outcome:** Иметь измеримую и проверяемую способность: координаты; азимут и высота
- **safety_class:** S2_TRAINED_SUPERVISED
