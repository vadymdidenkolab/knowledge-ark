---
id: "TD-HEALTH-CARE-HANDOVER"
kind: "technology"
title: "Смена caregiver и журнал наблюдения"
...
# Смена caregiver и журнал наблюдения
...
- **node_id:** TD-HEALTH-CARE-HANDOVER
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Смена caregiver и журнал наблюдения
- **outcome:** Иметь измеримую и проверяемую способность: смена caregiver и журнал наблюдения
- **safety_class:** S2_TRAINED_SUPERVISED
