---
id: "TD-PEOPLE-ANIMALS"
kind: "technology"
title: "Домашние и сельскохозяйственные животные в составе"
...
# Домашние и сельскохозяйственные животные в составе
...
- **node_id:** TD-PEOPLE-ANIMALS
- **parent_id:** [[TEC TD-PEOPLE|TD-PEOPLE]]
- **domain:** PEOPLE_CARE
- **node_type:** SITE_DATA
- **title_ru:** Домашние и сельскохозяйственные животные в составе
- **outcome:** Иметь измеримую и проверяемую способность: домашние и сельскохозяйственные животные в составе
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
