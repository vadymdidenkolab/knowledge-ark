---
id: "TD-ENVIRONMENT-SOIL-DEGRADE"
kind: "technology"
title: "Эрозия; уплотнение и деградация почвы"
...
# Эрозия; уплотнение и деградация почвы
...
- **node_id:** TD-ENVIRONMENT-SOIL-DEGRADE
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** TEST
- **title_ru:** Эрозия; уплотнение и деградация почвы
- **outcome:** Иметь измеримую и проверяемую способность: эрозия; уплотнение и деградация почвы
- **safety_class:** S2_TRAINED_SUPERVISED
