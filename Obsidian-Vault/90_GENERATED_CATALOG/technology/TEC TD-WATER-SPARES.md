...
id: "TD-WATER-SPARES"
kind: "technology"
title: "Запас фитингов; уплотнений и ремонтных деталей"
...
# Запас фитингов; уплотнений и ремонтных деталей
...
- **node_id:** TD-WATER-SPARES
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** MAINTENANCE
- **title_ru:** Запас фитингов; уплотнений и ремонтных деталей
- **outcome:** Иметь измеримую и проверяемую способность: запас фитингов; уплотнений и ремонтных деталей
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
