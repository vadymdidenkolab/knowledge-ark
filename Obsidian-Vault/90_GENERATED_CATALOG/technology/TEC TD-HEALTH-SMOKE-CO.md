---
id: "TD-HEALTH-SMOKE-CO"
kind: "technology"
title: "Дым; CO и ингаляционное поражение"
...
# Дым; CO и ингаляционное поражение
...
- **node_id:** TD-HEALTH-SMOKE-CO
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Дым; CO и ингаляционное поражение
- **outcome:** Иметь измеримую и проверяемую способность: дым; co и ингаляционное поражение
- **safety_class:** S2_TRAINED_SUPERVISED
