---
id: "TD-WORKSHOP-SHARPEN"
kind: "technology"
title: "Заточка и проверка режущего инструмента"
...
# Заточка и проверка режущего инструмента
...
- **node_id:** TD-WORKSHOP-SHARPEN
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Заточка и проверка режущего инструмента
- **outcome:** Иметь измеримую и проверяемую способность: заточка и проверка режущего инструмента
- **safety_class:** S2_TRAINED_SUPERVISED
