---
id: "TD-SECURITY-DEESCALATION"
kind: "technology"
title: "Деэскалация и отказ от самоуправства"
...
# Деэскалация и отказ от самоуправства
...
- **node_id:** TD-SECURITY-DEESCALATION
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** TRAINING
- **title_ru:** Деэскалация и отказ от самоуправства
- **outcome:** Иметь измеримую и проверяемую способность: деэскалация и отказ от самоуправства
- **safety_class:** S2_TRAINED_SUPERVISED
