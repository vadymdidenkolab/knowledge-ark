...
id: "TD-ENERGY-SPARES"
kind: "technology"
title: "Предохранители; кабели; адаптеры и запасные части"
...
# Предохранители; кабели; адаптеры и запасные части
...
- **node_id:** TD-ENERGY-SPARES
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** MAINTENANCE
- **title_ru:** Предохранители; кабели; адаптеры и запасные части
- **outcome:** Иметь измеримую и проверяемую способность: предохранители; кабели; адаптеры и запасные части
- **safety_class:** S2_TRAINED_SUPERVISED
