---
id: "TD-MATERIALS-PRODUCTION-CRITICAL-PART"
kind: "technology"
title: "Ответственные детали транспорта; давления; медицины и PPE"
...
# Ответственные детали транспорта; давления; медицины и PPE
...
- **node_id:** TD-MATERIALS-PRODUCTION-CRITICAL-PART
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Ответственные детали транспорта; давления; медицины и PPE
- **outcome:** Иметь измеримую и проверяемую способность: ответственные детали транспорта; давления; медицины и ppe
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
