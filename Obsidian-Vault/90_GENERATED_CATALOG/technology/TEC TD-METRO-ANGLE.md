...
- **node_id:** TD-METRO-ANGLE
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Угол; уровень и уклон
- **outcome:** Иметь измеримую и проверяемую способность: угол; уровень и уклон
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
