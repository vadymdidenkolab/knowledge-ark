...
- **node_id:** TD-METRO-SOIL
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Полевые измерения почвы
- **outcome:** Иметь измеримую и проверяемую способность: полевые измерения почвы
- **safety_class:** S2_TRAINED_SUPERVISED
