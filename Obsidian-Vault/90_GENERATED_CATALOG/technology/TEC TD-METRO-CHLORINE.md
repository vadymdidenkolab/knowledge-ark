---
id: "TD-METRO-CHLORINE"
kind: "technology"
title: "Остаточный хлор по точному методу"
...
# Остаточный хлор по точному методу
...
- **node_id:** TD-METRO-CHLORINE
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Остаточный хлор по точному методу
- **outcome:** Иметь измеримую и проверяемую способность: остаточный хлор по точному методу
- **safety_class:** S2_TRAINED_SUPERVISED
