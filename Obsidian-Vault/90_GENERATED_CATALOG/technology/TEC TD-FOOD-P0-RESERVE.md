---
id: "TD-FOOD-P0-RESERVE"
kind: "technology"
title: "Пищевой запас на первые 72 часа"
...
# Пищевой запас на первые 72 часа
...
- **node_id:** TD-FOOD-P0-RESERVE
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Пищевой запас на первые 72 часа
- **outcome:** Иметь измеримую и проверяемую способность: пищевой запас на первые 72 часа
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
