---
id: "TD-FUEL-PRODUCER-GAS"
kind: "technology"
title: "Газификация; producer gas and syngas"
...
# Газификация; producer gas and syngas
...
- **node_id:** TD-FUEL-PRODUCER-GAS
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Газификация; producer gas and syngas
- **outcome:** Preserve conceptual industrial knowledge while blocking lethal CO and fire hazards
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
- **execution_policy:** REFERENCE_ONLY_NO_BUILD
- **prerequisite_node_ids:** [[TEC TD-BASE-SAFETY|TD-BASE-SAFETY]]
- **source_package_ids:** не заполнено
- **materials_tools_state:** NO_GASIFIER
- **instrument_ids:** не заполнено
- **measurement_acceptance:** No-build; recognize CO; tar; hot surfaces and gas leak; evacuate
- **calibration_reference:** Qualified combustion and process safety sources
- **drawings_bom_state:** NO_GASIFIER_DRAWINGS
- **localization_state:** PORTUGAL_FIRE_EMISSIONS_AND_EQUIPMENT_RULES_REQUIRED
- **waste_storage:** Tar; ash and condensate under licensed route
- **stop_conditions:** CO; explosion; backfire; hot char; tar; confined space; unknown fuel
- **maintenance_spares:** Industrial inspection only
- **successor_proof:** Преемник refuses indoor or improvised system and follows CO alarm response
- **evidence_required:** Boundary card; professional sources
- **evidence_state:** BOUNDARY_DEFINED
- **capability_status:** REFERENCE_ONLY
- **release_gate:** REFERENCE_ONLY
- **notes:** No gasifier construction; dimensions; operating conditions or engine feed
