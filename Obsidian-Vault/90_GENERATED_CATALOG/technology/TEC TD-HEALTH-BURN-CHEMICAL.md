---
id: "TD-HEALTH-BURN-CHEMICAL"
kind: "technology"
title: "Химический ожог и идентификация продукта"
...
# Химический ожог и идентификация продукта
...
- **node_id:** TD-HEALTH-BURN-CHEMICAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Химический ожог и идентификация продукта
- **outcome:** Иметь измеримую и проверяемую способность: химический ожог и идентификация продукта
- **safety_class:** S3_LICENSED_PROFESSIONAL
