---
id: "TD-CONSTRUCTION-DOORS"
kind: "technology"
title: "Двери; выход и доступность"
...
- **node_id:** TD-CONSTRUCTION-DOORS
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Двери; выход и доступность
- **outcome:** Иметь измеримую и проверяемую способность: двери; выход и доступность
- **safety_class:** S3_LICENSED_PROFESSIONAL
