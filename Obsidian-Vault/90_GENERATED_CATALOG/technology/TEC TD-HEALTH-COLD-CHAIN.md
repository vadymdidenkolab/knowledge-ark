---
id: "TD-HEALTH-COLD-CHAIN"
kind: "technology"
title: "Холодовая цепь лекарств и медпитания"
...
# Холодовая цепь лекарств и медпитания
...
- **node_id:** TD-HEALTH-COLD-CHAIN
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Холодовая цепь лекарств и медпитания
- **outcome:** Иметь измеримую и проверяемую способность: холодовая цепь лекарств и медпитания
- **safety_class:** S3_LICENSED_PROFESSIONAL
