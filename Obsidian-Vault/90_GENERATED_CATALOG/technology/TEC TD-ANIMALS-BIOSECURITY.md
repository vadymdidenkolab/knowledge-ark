---
id: "TD-ANIMALS-BIOSECURITY"
kind: "technology"
title: "Биобезопасность; карантин и zoonoses"
...
# Биобезопасность; карантин и zoonoses
...
- **node_id:** TD-ANIMALS-BIOSECURITY
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** PROCESS
- **title_ru:** Биобезопасность; карантин и zoonoses
- **outcome:** Иметь измеримую и проверяемую способность: биобезопасность; карантин и zoonoses
- **safety_class:** S3_LICENSED_PROFESSIONAL
