...
id: "TD-AGRI-TWO-LOTS"
kind: "technology"
title: "Два независимых лота критических культур"
...
# Два независимых лота критических культур
...
- **node_id:** TD-AGRI-TWO-LOTS
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Два независимых лота критических культур
- **outcome:** Иметь измеримую и проверяемую способность: два независимых лота критических культур
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
