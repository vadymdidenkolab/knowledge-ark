---
id: "TD-CONSTRUCTION-INSPECTION"
kind: "technology"
title: "Инспекция; дефекты и запрет эксплуатации"
...
# Инспекция; дефекты и запрет эксплуатации
...
- **node_id:** TD-CONSTRUCTION-INSPECTION
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** TEST
- **title_ru:** Инспекция; дефекты и запрет эксплуатации
- **outcome:** Иметь измеримую и проверяемую способность: инспекция; дефекты и запрет эксплуатации
- **safety_class:** S3_LICENSED_PROFESSIONAL
