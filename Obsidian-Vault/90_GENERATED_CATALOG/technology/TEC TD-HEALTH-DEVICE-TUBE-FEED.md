---
id: "TD-HEALTH-DEVICE-TUBE-FEED"
kind: "technology"
title: "Потеря зондового питания или медпитания"
...
# Потеря зондового питания или медпитания
...
- **node_id:** TD-HEALTH-DEVICE-TUBE-FEED
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Потеря зондового питания или медпитания
- **outcome:** Иметь измеримую и проверяемую способность: потеря зондового питания или медпитания
- **safety_class:** S3_LICENSED_PROFESSIONAL
