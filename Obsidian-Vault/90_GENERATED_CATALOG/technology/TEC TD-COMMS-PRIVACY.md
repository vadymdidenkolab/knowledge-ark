...
id: "TD-COMMS-PRIVACY"
kind: "technology"
title: "Защита координат людей; запасов и убежищ"
...
# Защита координат людей; запасов и убежищ
...
- **node_id:** TD-COMMS-PRIVACY
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** GOVERNANCE
- **title_ru:** Защита координат людей; запасов и убежищ
- **outcome:** Иметь измеримую и проверяемую способность: защита координат людей; запасов и убежищ
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
