...
- **node_id:** TD-AGRI-LEGUMES
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Бобовые и пищевой белок
- **outcome:** Иметь измеримую и проверяемую способность: бобовые и пищевой белок
- **safety_class:** S2_TRAINED_SUPERVISED
