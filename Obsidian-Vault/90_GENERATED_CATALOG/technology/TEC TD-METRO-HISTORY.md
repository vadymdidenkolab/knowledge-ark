...
id: "TD-METRO-HISTORY"
kind: "technology"
title: "История калибровок и межприборное сравнение"
...
# История калибровок и межприборное сравнение
...
- **node_id:** TD-METRO-HISTORY
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** GOVERNANCE
- **title_ru:** История калибровок и межприборное сравнение
- **outcome:** Иметь измеримую и проверяемую способность: история калибровок и межприборное сравнение
- **safety_class:** S2_TRAINED_SUPERVISED
