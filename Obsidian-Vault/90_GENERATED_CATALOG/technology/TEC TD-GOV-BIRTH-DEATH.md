---
id: "TD-GOV-BIRTH-DEATH"
kind: "technology"
title: "Записи рождения; смерти и идентичности"
...
# Записи рождения; смерти и идентичности
...
- **node_id:** TD-GOV-BIRTH-DEATH
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** GOVERNANCE
- **title_ru:** Записи рождения; смерти и идентичности
- **outcome:** Иметь измеримую и проверяемую способность: записи рождения; смерти и идентичности
- **safety_class:** S3_LICENSED_PROFESSIONAL
