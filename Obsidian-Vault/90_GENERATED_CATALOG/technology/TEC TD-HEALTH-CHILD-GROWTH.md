---
id: "TD-HEALTH-CHILD-GROWTH"
kind: "technology"
title: "Рост; питание и функциональное состояние детей"
...
# Рост; питание и функциональное состояние детей
...
- **node_id:** TD-HEALTH-CHILD-GROWTH
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TEST
- **title_ru:** Рост; питание и функциональное состояние детей
- **outcome:** Иметь измеримую и проверяемую способность: рост; питание и функциональное состояние детей
- **safety_class:** S3_LICENSED_PROFESSIONAL
