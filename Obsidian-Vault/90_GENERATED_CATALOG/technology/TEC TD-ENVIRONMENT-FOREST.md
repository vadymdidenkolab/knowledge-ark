---
id: "TD-ENVIRONMENT-FOREST"
kind: "technology"
title: "Лес; многолетние культуры и wildfire interface"
...
# Лес; многолетние культуры и wildfire interface
...
- **node_id:** TD-ENVIRONMENT-FOREST
- **parent_id:** [[TEC TD-ENVIRONMENT|TD-ENVIRONMENT]]
- **domain:** ENVIRONMENT
- **node_type:** PROCESS
- **title_ru:** Лес; многолетние культуры и wildfire interface
- **outcome:** Иметь измеримую и проверяемую способность: лес; многолетние культуры и wildfire interface
- **safety_class:** S3_LICENSED_PROFESSIONAL
