---
id: "TD-HEALTH-CONT-TRANSPLANT"
kind: "technology"
title: "Трансплантация и иммуносупрессия"
...
- **node_id:** TD-HEALTH-CONT-TRANSPLANT
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Трансплантация и иммуносупрессия
- **outcome:** Иметь измеримую и проверяемую способность: трансплантация и иммуносупрессия
- **safety_class:** S3_LICENSED_PROFESSIONAL
