...
id: "TD-PORTUGAL-IPMA"
kind: "technology"
title: "IPMA: погода; сейсмика и цунами"
...
- **node_id:** TD-PORTUGAL-IPMA
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** IPMA: погода; сейсмика и цунами
- **outcome:** Иметь измеримую и проверяемую способность: ipma: погода; сейсмика и цунами
- **safety_class:** S0_OBSERVE_READ
