...
id: "TD-METRO-SI"
kind: "technology"
title: "SI; единицы и преобразования"
...
- **domain:** BASE
- **node_type:** KNOWLEDGE
- **title_ru:** SI; единицы и преобразования
- **outcome:** Иметь измеримую и проверяемую способность: si; единицы и преобразования
- **safety_class:** S0_OBSERVE_READ
