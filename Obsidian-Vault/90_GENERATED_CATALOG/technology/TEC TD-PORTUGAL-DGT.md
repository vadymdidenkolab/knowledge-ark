...
id: "TD-PORTUGAL-DGT"
kind: "technology"
title: "DGT/SNIG/CAOP: карты и административные границы"
...
# DGT/SNIG/CAOP: карты и административные границы
...
- **node_id:** TD-PORTUGAL-DGT
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** DGT/SNIG/CAOP: карты и административные границы
- **outcome:** Иметь измеримую и проверяемую способность: dgt/snig/caop: карты и административные границы
- **safety_class:** S0_OBSERVE_READ
