---
id: "TD-HEALTH-SNAKE-MARINE"
kind: "technology"
title: "Змеи и морские животные: запрет импровизации и маршрут"
...
# Змеи и морские животные: запрет импровизации и маршрут
...
- **node_id:** TD-HEALTH-SNAKE-MARINE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Змеи и морские животные: запрет импровизации и маршрут
- **outcome:** Иметь измеримую и проверяемую способность: змеи и морские животные: запрет импровизации и маршрут
- **safety_class:** S3_LICENSED_PROFESSIONAL
