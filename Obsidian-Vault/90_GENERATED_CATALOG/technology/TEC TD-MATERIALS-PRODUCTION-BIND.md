---
id: "TD-MATERIALS-PRODUCTION-BIND"
kind: "technology"
title: "Переплёт и ремонт книг"
...
- **node_id:** TD-MATERIALS-PRODUCTION-BIND
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Переплёт и ремонт книг
- **outcome:** Иметь измеримую и проверяемую способность: переплёт и ремонт книг
- **safety_class:** S2_TRAINED_SUPERVISED
