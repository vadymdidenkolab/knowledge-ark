---
id: "TD-HEALTH-PROF-SUPPLY"
kind: "technology"
title: "Medical supply chain; anti-counterfeit и recalls"
...
# Medical supply chain; anti-counterfeit и recalls
...
- **node_id:** TD-HEALTH-PROF-SUPPLY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Medical supply chain; anti-counterfeit и recalls
- **outcome:** Иметь измеримую и проверяемую способность: medical supply chain; anti-counterfeit и recalls
- **safety_class:** S3_LICENSED_PROFESSIONAL
