---
id: "TD-COMMS-SERVICE-POINTS"
kind: "technology"
title: "Медицина; пожар; вода; укрытие и аптеки"
...
# Медицина; пожар; вода; укрытие и аптеки
...
- **node_id:** TD-COMMS-SERVICE-POINTS
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** SITE_DATA
- **title_ru:** Медицина; пожар; вода; укрытие и аптеки
- **outcome:** Иметь измеримую и проверяемую способность: медицина; пожар; вода; укрытие и аптеки
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
