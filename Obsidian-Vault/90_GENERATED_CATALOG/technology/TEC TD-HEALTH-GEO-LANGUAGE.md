---
id: "TD-HEALTH-GEO-LANGUAGE"
kind: "technology"
title: "Передача геолокации и языковая экстренная карточка"
...
# Передача геолокации и языковая экстренная карточка
...
- **node_id:** TD-HEALTH-GEO-LANGUAGE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Передача геолокации и языковая экстренная карточка
- **outcome:** Иметь измеримую и проверяемую способность: передача геолокации и языковая экстренная карточка
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
