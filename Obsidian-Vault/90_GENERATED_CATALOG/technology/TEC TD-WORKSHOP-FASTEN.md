---
id: "TD-WORKSHOP-FASTEN"
kind: "technology"
title: "Крепёж; резьбы и стандартные размеры"
...
# Крепёж; резьбы и стандартные размеры
...
- **node_id:** TD-WORKSHOP-FASTEN
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Крепёж; резьбы и стандартные размеры
- **outcome:** Иметь измеримую и проверяемую способность: крепёж; резьбы и стандартные размеры
- **safety_class:** S2_TRAINED_SUPERVISED
