---
id: "TD-HEALTH-PROF-OXYGEN"
kind: "technology"
title: "Медицинский кислород и respiratory equipment"
...
# Медицинский кислород и respiratory equipment
...
- **node_id:** TD-HEALTH-PROF-OXYGEN
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Медицинский кислород и respiratory equipment
- **outcome:** Иметь измеримую и проверяемую способность: медицинский кислород и respiratory equipment
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
