---
id: "TD-FUEL-PRODUCT-ID"
kind: "technology"
title: "Идентичность и спецификация готового топлива"
...
# Идентичность и спецификация готового топлива
...
- **node_id:** TD-FUEL-PRODUCT-ID
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** SITE_DATA
- **title_ru:** Идентичность и спецификация готового топлива
- **outcome:** Иметь измеримую и проверяемую способность: идентичность и спецификация готового топлива
- **safety_class:** S2_TRAINED_SUPERVISED
