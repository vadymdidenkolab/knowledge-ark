---
id: "TD-MATERIALS-PRODUCTION-MACHINE-MILL"
kind: "technology"
title: "Фрезерование"
...
- **node_id:** TD-MATERIALS-PRODUCTION-MACHINE-MILL
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Фрезерование
- **outcome:** Иметь измеримую и проверяемую способность: фрезерование
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
