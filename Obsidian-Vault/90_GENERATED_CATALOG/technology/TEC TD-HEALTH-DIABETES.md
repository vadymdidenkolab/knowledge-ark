---
id: "TD-HEALTH-DIABETES"
kind: "technology"
title: "Диабетическая неотложная ситуация"
...
# Диабетическая неотложная ситуация
...
- **node_id:** TD-HEALTH-DIABETES
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Диабетическая неотложная ситуация
- **outcome:** Иметь измеримую и проверяемую способность: диабетическая неотложная ситуация
- **safety_class:** S3_LICENSED_PROFESSIONAL
