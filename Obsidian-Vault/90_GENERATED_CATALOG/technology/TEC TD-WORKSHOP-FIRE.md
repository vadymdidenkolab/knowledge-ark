...
id: "TD-WORKSHOP-FIRE"
kind: "technology"
title: "Пожарная безопасность мастерской"
...
# Пожарная безопасность мастерской
...
- **node_id:** TD-WORKSHOP-FIRE
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Пожарная безопасность мастерской
- **outcome:** Иметь измеримую и проверяемую способность: пожарная безопасность мастерской
- **safety_class:** S2_TRAINED_SUPERVISED
