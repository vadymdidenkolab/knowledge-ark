---
id: "TD-SECURITY-NO-OFFENSE"
kind: "technology"
title: "Запрет наступательных; взрывных и токсичных систем"
...
# Запрет наступательных; взрывных и токсичных систем
...
- **node_id:** TD-SECURITY-NO-OFFENSE
- **parent_id:** [[TEC TD-SECURITY|TD-SECURITY]]
- **domain:** SECURITY
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Запрет наступательных; взрывных и токсичных систем
- **outcome:** Иметь измеримую и проверяемую способность: запрет наступательных; взрывных и токсичных систем
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
