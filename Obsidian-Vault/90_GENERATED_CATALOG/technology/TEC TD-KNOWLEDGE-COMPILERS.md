---
id: "TD-KNOWLEDGE-COMPILERS"
kind: "technology"
title: "Компиляторы; runtimes и reproducible build"
...
# Компиляторы; runtimes и reproducible build
...
- **node_id:** TD-KNOWLEDGE-COMPILERS
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** KNOWLEDGE
- **title_ru:** Компиляторы; runtimes и reproducible build
- **outcome:** Иметь измеримую и проверяемую способность: компиляторы; runtimes и reproducible build
- **safety_class:** S2_TRAINED_SUPERVISED
