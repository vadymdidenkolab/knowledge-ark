---
id: "TD-HEALTH-PROF-PRIMARY"
kind: "technology"
title: "Primary и community medicine"
...
- **node_id:** TD-HEALTH-PROF-PRIMARY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Primary и community medicine
- **outcome:** Иметь измеримую и проверяемую способность: primary и community medicine
- **safety_class:** S3_LICENSED_PROFESSIONAL
