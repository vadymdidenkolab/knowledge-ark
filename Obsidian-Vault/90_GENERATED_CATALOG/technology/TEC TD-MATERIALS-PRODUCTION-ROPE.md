---
id: "TD-MATERIALS-PRODUCTION-ROPE"
kind: "technology"
title: "Канаты и сети; не для life-safety без сертификации"
...
# Канаты и сети; не для life-safety без сертификации
...
- **node_id:** TD-MATERIALS-PRODUCTION-ROPE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Канаты и сети; не для life-safety без сертификации
- **outcome:** Иметь измеримую и проверяемую способность: канаты и сети; не для life-safety без сертификации
- **safety_class:** S3_LICENSED_PROFESSIONAL
