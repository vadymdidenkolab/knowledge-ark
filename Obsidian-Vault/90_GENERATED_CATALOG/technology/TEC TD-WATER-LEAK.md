...
id: "TD-WATER-LEAK"
kind: "technology"
title: "Испытание на утечки и потери"
...
- **node_id:** TD-WATER-LEAK
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** TEST
- **title_ru:** Испытание на утечки и потери
- **outcome:** Иметь измеримую и проверяемую способность: испытание на утечки и потери
- **safety_class:** S2_TRAINED_SUPERVISED
