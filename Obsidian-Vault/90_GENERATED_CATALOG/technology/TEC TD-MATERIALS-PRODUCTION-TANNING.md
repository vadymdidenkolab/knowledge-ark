---
id: "TD-MATERIALS-PRODUCTION-TANNING"
kind: "technology"
title: "Дубление кожи"
...
- **node_id:** TD-MATERIALS-PRODUCTION-TANNING
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Дубление кожи
- **outcome:** Иметь измеримую и проверяемую способность: дубление кожи
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
