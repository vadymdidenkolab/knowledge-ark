---
id: "TD-GOV-DISTRIBUTION"
kind: "technology"
title: "Выдача ресурсов и chain of custody"
...
# Выдача ресурсов и chain of custody
...
- **node_id:** TD-GOV-DISTRIBUTION
- **parent_id:** [[TEC TD-GOV|TD-GOV]]
- **domain:** GOVERNANCE
- **node_type:** PROCESS
- **title_ru:** Выдача ресурсов и chain of custody
- **outcome:** Иметь измеримую и проверяемую способность: выдача ресурсов и chain of custody
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
