---
id: "TD-KNOWLEDGE-EDA-CAD"
kind: "technology"
title: "CAD/EDA и открытые редактируемые форматы"
...
# CAD/EDA и открытые редактируемые форматы
...
- **node_id:** TD-KNOWLEDGE-EDA-CAD
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** KNOWLEDGE
- **title_ru:** CAD/EDA и открытые редактируемые форматы
- **outcome:** Иметь измеримую и проверяемую способность: cad/eda и открытые редактируемые форматы
- **safety_class:** S2_TRAINED_SUPERVISED
