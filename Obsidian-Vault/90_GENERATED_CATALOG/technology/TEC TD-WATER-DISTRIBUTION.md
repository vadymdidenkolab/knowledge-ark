---
id: "TD-WATER-DISTRIBUTION"
kind: "technology"
title: "Распределение воды и точки отбора"
...
# Распределение воды и точки отбора
...
- **node_id:** TD-WATER-DISTRIBUTION
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** DRAWING
- **title_ru:** Распределение воды и точки отбора
- **outcome:** Иметь измеримую и проверяемую способность: распределение воды и точки отбора
- **safety_class:** S2_TRAINED_SUPERVISED
