...
id: "TD-FUEL-ASH"
kind: "technology"
title: "Зола и безопасный маршрут"
...
- **domain:** ENERGY_FUELS
- **node_type:** PROCESS
- **title_ru:** Зола и безопасный маршрут
- **outcome:** Иметь измеримую и проверяемую способность: зола и безопасный маршрут
- **safety_class:** S3_LICENSED_PROFESSIONAL
