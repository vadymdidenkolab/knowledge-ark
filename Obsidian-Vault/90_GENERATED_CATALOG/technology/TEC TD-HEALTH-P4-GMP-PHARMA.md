---
id: "TD-HEALTH-P4-GMP-PHARMA"
kind: "technology"
title: "GMP и регулируемое производство лекарств"
...
# GMP и регулируемое производство лекарств
...
- **node_id:** TD-HEALTH-P4-GMP-PHARMA
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** GMP и регулируемое производство лекарств
- **outcome:** Иметь измеримую и проверяемую способность: gmp и регулируемое производство лекарств
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
