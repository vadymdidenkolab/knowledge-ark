---
id: "TD-HEALTH-OB-BIRTH"
kind: "technology"
title: "Роды до прибытия профессиональной помощи"
...
# Роды до прибытия профессиональной помощи
...
- **node_id:** TD-HEALTH-OB-BIRTH
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Роды до прибытия профессиональной помощи
- **outcome:** Иметь измеримую и проверяемую способность: роды до прибытия профессиональной помощи
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
