---
id: "TD-SHELTER-SHUTOFF-WATER"
kind: "technology"
title: "Штатное отключение воды"
...
- **node_id:** TD-SHELTER-SHUTOFF-WATER
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** TRAINING
- **title_ru:** Штатное отключение воды
- **outcome:** Иметь измеримую и проверяемую способность: штатное отключение воды
- **safety_class:** S2_TRAINED_SUPERVISED
