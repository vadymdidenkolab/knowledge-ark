---
id: "TD-MATERIALS-PRODUCTION-PRINT"
kind: "technology"
title: "Печать и тиражирование"
...
- **node_id:** TD-MATERIALS-PRODUCTION-PRINT
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Печать и тиражирование
- **outcome:** Иметь измеримую и проверяемую способность: печать и тиражирование
- **safety_class:** S2_TRAINED_SUPERVISED
