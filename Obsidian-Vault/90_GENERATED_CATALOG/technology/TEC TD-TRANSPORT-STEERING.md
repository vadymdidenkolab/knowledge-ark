---
id: "TD-TRANSPORT-STEERING"
kind: "technology"
title: "Рулевое и критерий запрета движения"
...
# Рулевое и критерий запрета движения
...
- **node_id:** TD-TRANSPORT-STEERING
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** MAINTENANCE
- **title_ru:** Рулевое и критерий запрета движения
- **outcome:** Иметь измеримую и проверяемую способность: рулевое и критерий запрета движения
- **safety_class:** S3_LICENSED_PROFESSIONAL
