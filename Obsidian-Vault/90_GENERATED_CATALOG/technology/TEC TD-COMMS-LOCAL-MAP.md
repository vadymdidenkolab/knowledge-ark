---
id: "TD-COMMS-LOCAL-MAP"
kind: "technology"
title: "Локальная бумажная и офлайн-карта"
...
# Локальная бумажная и офлайн-карта
...
- **node_id:** TD-COMMS-LOCAL-MAP
- **parent_id:** [[TEC TD-MAPS-COMMS|TD-MAPS-COMMS]]
- **domain:** MAPS_COMMS
- **node_type:** MATERIAL
- **title_ru:** Локальная бумажная и офлайн-карта
- **outcome:** Иметь измеримую и проверяемую способность: локальная бумажная и офлайн-карта
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
