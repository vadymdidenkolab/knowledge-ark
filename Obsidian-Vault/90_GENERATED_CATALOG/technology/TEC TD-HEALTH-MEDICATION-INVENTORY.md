---
id: "TD-HEALTH-MEDICATION-INVENTORY"
kind: "technology"
title: "Инвентаризация назначенных лекарств без изменения назначения"
...
# Инвентаризация назначенных лекарств без изменения назначения
...
- **node_id:** TD-HEALTH-MEDICATION-INVENTORY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** MATERIAL
- **title_ru:** Инвентаризация назначенных лекарств без изменения назначения
- **outcome:** Иметь измеримую и проверяемую способность: инвентаризация назначенных лекарств без изменения назначения
- **safety_class:** S2_TRAINED_SUPERVISED
