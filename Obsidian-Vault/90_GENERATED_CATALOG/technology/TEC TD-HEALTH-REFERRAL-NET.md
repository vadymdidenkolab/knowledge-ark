---
id: "TD-HEALTH-REFERRAL-NET"
kind: "technology"
title: "Сеть врача; аптеки; стоматолога; роддома; лаборатории и транспорта"
...
# Сеть врача; аптеки; стоматолога; роддома; лаборатории и транспорта
...
- **node_id:** TD-HEALTH-REFERRAL-NET
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Сеть врача; аптеки; стоматолога; роддома; лаборатории и транспорта
- **outcome:** Иметь измеримую и проверяемую способность: сеть врача; аптеки; стоматолога; роддома; лаборатории и транспорта
- **safety_class:** S2_TRAINED_SUPERVISED
