---
id: "TD-PORTUGAL-MUNICIPAL-PC"
kind: "technology"
title: "Муниципальная Proteção Civil"
...
- **node_id:** TD-PORTUGAL-MUNICIPAL-PC
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** SITE_DATA
- **title_ru:** Муниципальная Proteção Civil
- **outcome:** Иметь измеримую и проверяемую способность: муниципальная proteção civil
- **safety_class:** S0_OBSERVE_READ
