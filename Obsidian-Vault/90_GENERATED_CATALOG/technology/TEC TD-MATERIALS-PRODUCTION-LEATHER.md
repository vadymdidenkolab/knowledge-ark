---
id: "TD-MATERIALS-PRODUCTION-LEATHER"
kind: "technology"
title: "Кожа; ремонт и обувь"
...
- **node_id:** TD-MATERIALS-PRODUCTION-LEATHER
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Кожа; ремонт и обувь
- **outcome:** Иметь измеримую и проверяемую способность: кожа; ремонт и обувь
- **safety_class:** S3_LICENSED_PROFESSIONAL
