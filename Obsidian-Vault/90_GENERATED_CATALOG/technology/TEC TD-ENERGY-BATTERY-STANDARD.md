---
id: "TD-ENERGY-BATTERY-STANDARD"
kind: "technology"
title: "Стандартные батарейные платформы"
...
# Стандартные батарейные платформы
...
- **node_id:** TD-ENERGY-BATTERY-STANDARD
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** MATERIAL
- **title_ru:** Стандартные батарейные платформы
- **outcome:** Иметь измеримую и проверяемую способность: стандартные батарейные платформы
- **safety_class:** S2_TRAINED_SUPERVISED
