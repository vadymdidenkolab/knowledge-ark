...
id: "TD-METRO-MEDICAL"
kind: "technology"
title: "Разрешённые неинвазивные медицинские измерения"
...
# Разрешённые неинвазивные медицинские измерения
...
- **node_id:** TD-METRO-MEDICAL
- **parent_id:** [[TEC TD-BASE-METROLOGY|TD-BASE-METROLOGY]]
- **domain:** BASE
- **node_type:** INSTRUMENT
- **title_ru:** Разрешённые неинвазивные медицинские измерения
- **outcome:** Иметь измеримую и проверяемую способность: разрешённые неинвазивные медицинские измерения
- **safety_class:** S3_LICENSED_PROFESSIONAL
