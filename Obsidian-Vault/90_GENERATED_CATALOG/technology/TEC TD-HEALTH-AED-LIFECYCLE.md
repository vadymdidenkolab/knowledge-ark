---
id: "TD-HEALTH-AED-LIFECYCLE"
kind: "technology"
title: "AED; батареи; электроды; осмотр и тренажёр"
...
# AED; батареи; электроды; осмотр и тренажёр
...
- **node_id:** TD-HEALTH-AED-LIFECYCLE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** MAINTENANCE
- **title_ru:** AED; батареи; электроды; осмотр и тренажёр
- **outcome:** Иметь измеримую и проверяемую способность: aed; батареи; электроды; осмотр и тренажёр
- **safety_class:** S2_TRAINED_SUPERVISED
