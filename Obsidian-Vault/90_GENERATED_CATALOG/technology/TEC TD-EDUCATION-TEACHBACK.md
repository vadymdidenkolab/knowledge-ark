---
id: "TD-EDUCATION-TEACHBACK"
kind: "technology"
title: "Teach-back и слепое повторение"
...
# Teach-back и слепое повторение
...
- **node_id:** TD-EDUCATION-TEACHBACK
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** TEST
- **title_ru:** Teach-back и слепое повторение
- **outcome:** Иметь измеримую и проверяемую способность: teach-back и слепое повторение
- **safety_class:** S2_TRAINED_SUPERVISED
