---
id: "TD-CONSTRUCTION-FIRE"
kind: "technology"
title: "Пожарные преграды и безопасная эвакуация"
...
# Пожарные преграды и безопасная эвакуация
...
- **node_id:** TD-CONSTRUCTION-FIRE
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Пожарные преграды и безопасная эвакуация
- **outcome:** Иметь измеримую и проверяемую способность: пожарные преграды и безопасная эвакуация
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
