...
id: "TD-PORTUGAL-DGAV"
kind: "technology"
title: "DGAV: животные; корма; растения и здоровье"
...
# DGAV: животные; корма; растения и здоровье
...
- **node_id:** TD-PORTUGAL-DGAV
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** DGAV: животные; корма; растения и здоровье
- **outcome:** Иметь измеримую и проверяемую способность: dgav: животные; корма; растения и здоровье
- **safety_class:** S0_OBSERVE_READ
