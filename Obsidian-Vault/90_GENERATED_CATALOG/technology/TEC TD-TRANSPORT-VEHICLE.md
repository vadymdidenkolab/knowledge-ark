---
id: "TD-TRANSPORT-VEHICLE"
kind: "technology"
title: "Автомобиль; ограничения и эксплуатационный статус"
...
# Автомобиль; ограничения и эксплуатационный статус
...
- **node_id:** TD-TRANSPORT-VEHICLE
- **parent_id:** [[TEC TD-TRANSPORT|TD-TRANSPORT]]
- **domain:** TRANSPORT
- **node_type:** MATERIAL
- **title_ru:** Автомобиль; ограничения и эксплуатационный статус
- **outcome:** Иметь измеримую и проверяемую способность: автомобиль; ограничения и эксплуатационный статус
- **safety_class:** S3_LICENSED_PROFESSIONAL
