...
id: "TD-WATER-RAIN"
kind: "technology"
title: "Дождевая вода; право; first flush и отдельный risk profile"
...
# Дождевая вода; право; first flush и отдельный risk profile
...
- **node_id:** TD-WATER-RAIN
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Дождевая вода; право; first flush и отдельный risk profile
- **outcome:** Иметь измеримую и проверяемую способность: дождевая вода; право; first flush и отдельный risk profile
- **safety_class:** S2_TRAINED_SUPERVISED
