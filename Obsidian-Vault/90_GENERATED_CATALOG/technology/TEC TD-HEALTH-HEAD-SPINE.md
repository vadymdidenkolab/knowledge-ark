---
id: "TD-HEALTH-HEAD-SPINE"
kind: "technology"
title: "Травма головы; шеи и позвоночника"
...
- **node_id:** TD-HEALTH-HEAD-SPINE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Травма головы; шеи и позвоночника
- **outcome:** Иметь измеримую и проверяемую способность: травма головы; шеи и позвоночника
- **safety_class:** S2_TRAINED_SUPERVISED
