---
id: "TD-CONSTRUCTION-WILDFIRE"
kind: "technology"
title: "Wildfire interface и defensible space"
...
# Wildfire interface и defensible space
...
- **node_id:** TD-CONSTRUCTION-WILDFIRE
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Wildfire interface и defensible space
- **outcome:** Иметь измеримую и проверяемую способность: wildfire interface и defensible space
- **safety_class:** S3_LICENSED_PROFESSIONAL
