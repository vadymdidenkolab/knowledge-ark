---
id: "TD-MATERIALS-PRODUCTION-WIRE"
kind: "technology"
title: "Проволока и безопасная механическая работа"
...
# Проволока и безопасная механическая работа
...
- **node_id:** TD-MATERIALS-PRODUCTION-WIRE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** MATERIAL
- **title_ru:** Проволока и безопасная механическая работа
- **outcome:** Иметь измеримую и проверяемую способность: проволока и безопасная механическая работа
- **safety_class:** S3_LICENSED_PROFESSIONAL
