---
id: "TD-ANIMALS-SHELTER"
kind: "technology"
title: "Укрытие; температура и вентиляция"
...
# Укрытие; температура и вентиляция
...
- **node_id:** TD-ANIMALS-SHELTER
- **parent_id:** [[TEC TD-ANIMALS|TD-ANIMALS]]
- **domain:** ANIMALS
- **node_type:** PROCESS
- **title_ru:** Укрытие; температура и вентиляция
- **outcome:** Иметь измеримую и проверяемую способность: укрытие; температура и вентиляция
- **safety_class:** S2_TRAINED_SUPERVISED
