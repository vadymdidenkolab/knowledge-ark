...
id: "TD-PORTUGAL-APA"
kind: "technology"
title: "APA: вода; засуха; наводнения и среда"
...
# APA: вода; засуха; наводнения и среда
...
- **node_id:** TD-PORTUGAL-APA
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** APA: вода; засуха; наводнения и среда
- **outcome:** Иметь измеримую и проверяемую способность: apa: вода; засуха; наводнения и среда
- **safety_class:** S0_OBSERVE_READ
