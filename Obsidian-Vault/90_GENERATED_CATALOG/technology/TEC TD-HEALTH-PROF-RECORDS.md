---
id: "TD-HEALTH-PROF-RECORDS"
kind: "technology"
title: "Health records; privacy; backup и patient matching"
...
# Health records; privacy; backup и patient matching
...
- **node_id:** TD-HEALTH-PROF-RECORDS
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Health records; privacy; backup и patient matching
- **outcome:** Иметь измеримую и проверяемую способность: health records; privacy; backup и patient matching
- **safety_class:** S3_LICENSED_PROFESSIONAL
