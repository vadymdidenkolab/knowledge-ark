---
id: "TD-FUEL-BATCH-ACCEPT"
kind: "technology"
title: "Приёмка партии без самодельного анализа"
...
# Приёмка партии без самодельного анализа
...
- **node_id:** TD-FUEL-BATCH-ACCEPT
- **parent_id:** [[TEC TD-FUELS|TD-FUELS]]
- **domain:** ENERGY_FUELS
- **node_type:** TEST
- **title_ru:** Приёмка партии без самодельного анализа
- **outcome:** Иметь измеримую и проверяемую способность: приёмка партии без самодельного анализа
- **safety_class:** S2_TRAINED_SUPERVISED
