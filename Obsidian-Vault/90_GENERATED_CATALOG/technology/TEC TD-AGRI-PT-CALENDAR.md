---
id: "TD-AGRI-PT-CALENDAR"
kind: "technology"
title: "Календарь культур для конкретной зоны Португалии"
...
# Календарь культур для конкретной зоны Португалии
...
- **node_id:** TD-AGRI-PT-CALENDAR
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** KNOWLEDGE
- **title_ru:** Календарь культур для конкретной зоны Португалии
- **outcome:** Иметь измеримую и проверяемую способность: календарь культур для конкретной зоны португалии
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
