---
id: "TD-MATERIALS-PRODUCTION-STONE"
kind: "technology"
title: "Камень; кладка и пылевая опасность"
...
# Камень; кладка и пылевая опасность
...
- **node_id:** TD-MATERIALS-PRODUCTION-STONE
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** PROCESS
- **title_ru:** Камень; кладка и пылевая опасность
- **outcome:** Иметь измеримую и проверяемую способность: камень; кладка и пылевая опасность
- **safety_class:** S3_LICENSED_PROFESSIONAL
