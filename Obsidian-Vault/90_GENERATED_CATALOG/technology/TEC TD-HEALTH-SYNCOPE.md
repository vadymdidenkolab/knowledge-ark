---
id: "TD-HEALTH-SYNCOPE"
kind: "technology"
title: "Обморок и внезапная слабость"
...
- **node_id:** TD-HEALTH-SYNCOPE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Обморок и внезапная слабость
- **outcome:** Иметь измеримую и проверяемую способность: обморок и внезапная слабость
- **safety_class:** S2_TRAINED_SUPERVISED
