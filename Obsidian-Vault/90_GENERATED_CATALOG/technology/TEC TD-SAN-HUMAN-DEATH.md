---
id: "TD-SAN-HUMAN-DEATH"
kind: "technology"
title: "Санитарная и правовая маршрутизация смерти человека"
...
# Санитарная и правовая маршрутизация смерти человека
...
- **node_id:** TD-SAN-HUMAN-DEATH
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Санитарная и правовая маршрутизация смерти человека
- **outcome:** Иметь измеримую и проверяемую способность: санитарная и правовая маршрутизация смерти человека
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
