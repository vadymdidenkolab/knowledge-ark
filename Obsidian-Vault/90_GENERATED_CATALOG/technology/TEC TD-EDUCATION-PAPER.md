---
id: "TD-EDUCATION-PAPER"
kind: "technology"
title: "Бумажная учебная программа и экзамены"
...
# Бумажная учебная программа и экзамены
...
- **node_id:** TD-EDUCATION-PAPER
- **parent_id:** [[TEC TD-EDUCATION|TD-EDUCATION]]
- **domain:** EDUCATION
- **node_type:** KNOWLEDGE
- **title_ru:** Бумажная учебная программа и экзамены
- **outcome:** Иметь измеримую и проверяемую способность: бумажная учебная программа и экзамены
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
