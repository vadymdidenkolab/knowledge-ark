---
id: "TD-HEALTH-ISOLATION-ROOM"
kind: "technology"
title: "Изоляционное помещение; вентиляция и потоки"
...
# Изоляционное помещение; вентиляция и потоки
...
- **node_id:** TD-HEALTH-ISOLATION-ROOM
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** DRAWING
- **title_ru:** Изоляционное помещение; вентиляция и потоки
- **outcome:** Иметь измеримую и проверяемую способность: изоляционное помещение; вентиляция и потоки
- **safety_class:** S3_LICENSED_PROFESSIONAL
