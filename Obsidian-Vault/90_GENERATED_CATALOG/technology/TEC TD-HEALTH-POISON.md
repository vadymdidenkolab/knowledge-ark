...
id: "TD-HEALTH-POISON"
kind: "technology"
title: "Отравление; передозировка и токсикологический маршрут"
...
# Отравление; передозировка и токсикологический маршрут
...
- **node_id:** TD-HEALTH-POISON
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Отравление; передозировка и токсикологический маршрут
- **outcome:** Иметь измеримую и проверяемую способность: отравление; передозировка и токсикологический маршрут
- **safety_class:** S3_LICENSED_PROFESSIONAL
