---
id: "TD-HEALTH-CONT-RENAL"
kind: "technology"
title: "Почечная недостаточность и диализ"
...
- **node_id:** TD-HEALTH-CONT-RENAL
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Почечная недостаточность и диализ
- **outcome:** Иметь измеримую и проверяемую способность: почечная недостаточность и диализ
- **safety_class:** S3_LICENSED_PROFESSIONAL
