---
id: "TD-PORTUGAL-LIVESTOCK"
kind: "technology"
title: "Животные; welfare; slaughter и ветеринарные нормы"
...
# Животные; welfare; slaughter и ветеринарные нормы
...
- **node_id:** TD-PORTUGAL-LIVESTOCK
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** GOVERNANCE
- **title_ru:** Животные; welfare; slaughter и ветеринарные нормы
- **outcome:** Иметь измеримую и проверяемую способность: животные; welfare; slaughter и ветеринарные нормы
- **safety_class:** S3_LICENSED_PROFESSIONAL
