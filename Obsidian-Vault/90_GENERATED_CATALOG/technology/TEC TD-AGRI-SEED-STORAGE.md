---
id: "TD-AGRI-SEED-STORAGE"
kind: "technology"
title: "Температура; влажность; упаковка и мониторинг семян"
...
# Температура; влажность; упаковка и мониторинг семян
...
- **node_id:** TD-AGRI-SEED-STORAGE
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** PROCESS
- **title_ru:** Температура; влажность; упаковка и мониторинг семян
- **outcome:** Иметь измеримую и проверяемую способность: температура; влажность; упаковка и мониторинг семян
- **safety_class:** S2_TRAINED_SUPERVISED
