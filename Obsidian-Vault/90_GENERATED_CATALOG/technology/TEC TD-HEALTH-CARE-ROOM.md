---
id: "TD-HEALTH-CARE-ROOM"
kind: "technology"
title: "Помещение ухода: вода; санитария; свет; тепло; энергия и приватность"
...
# Помещение ухода: вода; санитария; свет; тепло; энергия и приватность
...
- **node_id:** TD-HEALTH-CARE-ROOM
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** DRAWING
- **title_ru:** Помещение ухода: вода; санитария; свет; тепло; энергия и приватность
- **outcome:** Иметь измеримую и проверяемую способность: помещение ухода: вода; санитария; свет; тепло; энергия и приватность
- **safety_class:** S3_LICENSED_PROFESSIONAL
