---
id: "TD-HEALTH-SUPPLY-REGISTER"
kind: "technology"
title: "Медицинский supply register; минимум; расход; срок и fallback"
...
# Медицинский supply register; минимум; расход; срок и fallback
...
- **node_id:** TD-HEALTH-SUPPLY-REGISTER
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** GOVERNANCE
- **title_ru:** Медицинский supply register; минимум; расход; срок и fallback
- **outcome:** Иметь измеримую и проверяемую способность: медицинский supply register; минимум; расход; срок и fallback
- **safety_class:** S2_TRAINED_SUPERVISED
