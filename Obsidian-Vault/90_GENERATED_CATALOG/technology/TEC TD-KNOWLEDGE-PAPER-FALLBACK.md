---
id: "TD-KNOWLEDGE-PAPER-FALLBACK"
kind: "technology"
title: "Механические и бумажные fallback-системы"
...
# Механические и бумажные fallback-системы
...
- **node_id:** TD-KNOWLEDGE-PAPER-FALLBACK
- **parent_id:** [[TEC TD-KNOWLEDGE|TD-KNOWLEDGE]]
- **domain:** KNOWLEDGE
- **node_type:** PROCESS
- **title_ru:** Механические и бумажные fallback-системы
- **outcome:** Иметь измеримую и проверяемую способность: механические и бумажные fallback-системы
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
