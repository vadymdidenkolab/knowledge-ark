---
id: "TD-HEALTH-CONT-STOMA-CATH"
kind: "technology"
title: "Стома; катетер и расходники"
...
- **node_id:** TD-HEALTH-CONT-STOMA-CATH
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Стома; катетер и расходники
- **outcome:** Иметь измеримую и проверяемую способность: стома; катетер и расходники
- **safety_class:** S3_LICENSED_PROFESSIONAL
