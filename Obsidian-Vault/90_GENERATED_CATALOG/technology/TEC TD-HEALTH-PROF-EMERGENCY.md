---
id: "TD-HEALTH-PROF-EMERGENCY"
kind: "technology"
title: "Emergency и critical care"
...
- **node_id:** TD-HEALTH-PROF-EMERGENCY
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Emergency и critical care
- **outcome:** Иметь измеримую и проверяемую способность: emergency и critical care
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
