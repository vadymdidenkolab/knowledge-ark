---
id: "TD-SAN-CONSTRUCTION"
kind: "technology"
title: "Строительные отходы и опасные материалы"
...
# Строительные отходы и опасные материалы
...
- **node_id:** TD-SAN-CONSTRUCTION
- **parent_id:** [[TEC TD-SANITATION|TD-SANITATION]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Строительные отходы и опасные материалы
- **outcome:** Иметь измеримую и проверяемую способность: строительные отходы и опасные материалы
- **safety_class:** S3_LICENSED_PROFESSIONAL
