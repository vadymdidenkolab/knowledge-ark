...
- **node_id:** TD-HEALTH-IPC
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** PROCESS
- **title_ru:** Инфекционный контроль; руки; поверхности и вентиляция
- **outcome:** Иметь измеримую и проверяемую способность: инфекционный контроль; руки; поверхности и вентиляция
- **safety_class:** S2_TRAINED_SUPERVISED
