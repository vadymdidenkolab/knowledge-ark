...
- **node_id:** TD-WORKSHOP-VENT
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** PROCESS
- **title_ru:** Вентиляция; пыль и пары
- **outcome:** Иметь измеримую и проверяемую способность: вентиляция; пыль и пары
- **safety_class:** S3_LICENSED_PROFESSIONAL
