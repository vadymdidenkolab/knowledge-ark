---
id: "TD-HEALTH-REPRODUCTIVE"
kind: "technology"
title: "Добровольное репродуктивное планирование и STI-маршрут"
...
# Добровольное репродуктивное планирование и STI-маршрут
...
- **node_id:** TD-HEALTH-REPRODUCTIVE
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** KNOWLEDGE
- **title_ru:** Добровольное репродуктивное планирование и STI-маршрут
- **outcome:** Иметь измеримую и проверяемую способность: добровольное репродуктивное планирование и sti-маршрут
- **safety_class:** S3_LICENSED_PROFESSIONAL
