---
id: "TD-HEALTH-DEVICE-OXYGEN-CPAP"
kind: "technology"
title: "Потеря кислорода; CPAP или респираторного устройства"
...
# Потеря кислорода; CPAP или респираторного устройства
...
- **node_id:** TD-HEALTH-DEVICE-OXYGEN-CPAP
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Потеря кислорода; CPAP или респираторного устройства
- **outcome:** Иметь измеримую и проверяемую способность: потеря кислорода; cpap или респираторного устройства
- **safety_class:** S3_LICENSED_PROFESSIONAL
