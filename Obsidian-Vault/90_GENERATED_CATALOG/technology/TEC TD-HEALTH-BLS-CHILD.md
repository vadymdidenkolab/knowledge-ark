---
id: "TD-HEALTH-BLS-CHILD"
kind: "technology"
title: "BLS/AED для ребёнка по очному курсу"
...
# BLS/AED для ребёнка по очному курсу
...
- **node_id:** TD-HEALTH-BLS-CHILD
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** BLS/AED для ребёнка по очному курсу
- **outcome:** Иметь измеримую и проверяемую способность: bls/aed для ребёнка по очному курсу
- **safety_class:** S2_TRAINED_SUPERVISED
