---
id: "TD-HEALTH-CARE-NURSING"
kind: "technology"
title: "Базовый caregiver/nursing support в пределах подготовки"
...
# Базовый caregiver/nursing support в пределах подготовки
...
- **node_id:** TD-HEALTH-CARE-NURSING
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** TRAINING
- **title_ru:** Базовый caregiver/nursing support в пределах подготовки
- **outcome:** Иметь измеримую и проверяемую способность: базовый caregiver/nursing support в пределах подготовки
- **safety_class:** S3_LICENSED_PROFESSIONAL
