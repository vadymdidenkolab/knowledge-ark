---
id: "TD-HAZ-PRESSURE-GAS"
kind: "technology"
title: "Газ; давление и герметично нагреваемые сосуды"
...
# Газ; давление и герметично нагреваемые сосуды
...
- **node_id:** TD-HAZ-PRESSURE-GAS
- **parent_id:** [[TEC TD-HAZARDS|TD-HAZARDS]]
- **domain:** HAZARD
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Газ; давление и герметично нагреваемые сосуды
- **outcome:** Avoid explosion; leak and CO risk
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
- **execution_policy:** REFERENCE_ONLY_NO_BUILD
- **prerequisite_node_ids:** [[TEC TD-BASE-SAFETY|TD-BASE-SAFETY]]
- **source_package_ids:** не заполнено
- **materials_tools_state:** NO_DIY_PRESSURE_OR_GAS
- **instrument_ids:** [[INS INS-024|INS-024]]
- **measurement_acceptance:** Only certified equipment; professional inspection; alarms and emergency route
- **calibration_reference:** OEM and licensed service
- **drawings_bom_state:** NO_DIY_DESIGN
- **localization_state:** PORTUGAL_GAS_AND_PRESSURE_RULES_REQUIRED
- **waste_storage:** Certified disposal and cylinder route
- **stop_conditions:** Odor; hiss; damaged valve; heat; corrosion; failed relief; CO alarm
- **maintenance_spares:** Professional schedule
- **successor_proof:** Преемник evacuates and calls service without manipulating leak
- **evidence_required:** Boundary card; manuals; inspection and alarm drill
- **evidence_state:** BOUNDARY_DEFINED
- **capability_status:** REFERENCE_ONLY
- **release_gate:** REFERENCE_ONLY
- **notes:** No pressure-vessel fabrication or repair
