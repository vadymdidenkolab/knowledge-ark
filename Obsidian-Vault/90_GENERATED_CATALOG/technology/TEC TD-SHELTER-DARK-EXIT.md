---
id: "TD-SHELTER-DARK-EXIT"
kind: "technology"
title: "Тренировка выхода в темноте"
...
- **node_id:** TD-SHELTER-DARK-EXIT
- **parent_id:** [[TEC TD-SHELTER|TD-SHELTER]]
- **domain:** SHELTER
- **node_type:** TEST
- **title_ru:** Тренировка выхода в темноте
- **outcome:** Иметь измеримую и проверяемую способность: тренировка выхода в темноте
- **safety_class:** S2_TRAINED_SUPERVISED
