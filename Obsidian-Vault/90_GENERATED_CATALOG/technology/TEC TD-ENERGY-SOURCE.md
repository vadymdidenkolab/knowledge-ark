...
id: "TD-ENERGY-SOURCE"
kind: "technology"
title: "Сертифицированный автономный источник"
...
# Сертифицированный автономный источник
...
- **node_id:** TD-ENERGY-SOURCE
- **parent_id:** [[TEC TD-ENERGY|TD-ENERGY]]
- **domain:** ENERGY
- **node_type:** MATERIAL
- **title_ru:** Сертифицированный автономный источник
- **outcome:** Иметь измеримую и проверяемую способность: сертифицированный автономный источник
- **safety_class:** S2_TRAINED_SUPERVISED
