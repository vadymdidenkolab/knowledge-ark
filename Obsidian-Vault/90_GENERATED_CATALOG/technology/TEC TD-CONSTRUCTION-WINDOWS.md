---
id: "TD-CONSTRUCTION-WINDOWS"
kind: "technology"
title: "Окна; остекление и временное закрытие"
...
# Окна; остекление и временное закрытие
...
- **node_id:** TD-CONSTRUCTION-WINDOWS
- **parent_id:** [[TEC TD-CONSTRUCTION|TD-CONSTRUCTION]]
- **domain:** CONSTRUCTION
- **node_type:** PROCESS
- **title_ru:** Окна; остекление и временное закрытие
- **outcome:** Иметь измеримую и проверяемую способность: окна; остекление и временное закрытие
- **safety_class:** S3_LICENSED_PROFESSIONAL
