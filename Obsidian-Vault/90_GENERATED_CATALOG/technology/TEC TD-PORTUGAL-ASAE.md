...
id: "TD-PORTUGAL-ASAE"
kind: "technology"
title: "ASAE: пища; рынок и безопасность продукции"
...
# ASAE: пища; рынок и безопасность продукции
...
- **node_id:** TD-PORTUGAL-ASAE
- **parent_id:** [[TEC TD-PORTUGAL|TD-PORTUGAL]]
- **domain:** PORTUGAL
- **node_type:** KNOWLEDGE
- **title_ru:** ASAE: пища; рынок и безопасность продукции
- **outcome:** Иметь измеримую и проверяемую способность: asae: пища; рынок и безопасность продукции
- **safety_class:** S0_OBSERVE_READ
