---
id: "TD-MATERIALS-PRODUCTION-MACHINE-GUARD"
kind: "technology"
title: "Привод; ограждения; LOTO и stored energy"
...
# Привод; ограждения; LOTO и stored energy
...
- **node_id:** TD-MATERIALS-PRODUCTION-MACHINE-GUARD
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** HAZARD_BOUNDARY
- **title_ru:** Привод; ограждения; LOTO и stored energy
- **outcome:** Иметь измеримую и проверяемую способность: привод; ограждения; loto и stored energy
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
