---
id: "TD-FOOD-P1-PANTRY"
kind: "technology"
title: "Ротационная кладовая на 14 дней"
...
# Ротационная кладовая на 14 дней
...
- **node_id:** TD-FOOD-P1-PANTRY
- **parent_id:** [[TEC TD-FOOD|TD-FOOD]]
- **domain:** FOOD_AGRI
- **node_type:** MATERIAL
- **title_ru:** Ротационная кладовая на 14 дней
- **outcome:** Иметь измеримую и проверяемую способность: ротационная кладовая на 14 дней
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
