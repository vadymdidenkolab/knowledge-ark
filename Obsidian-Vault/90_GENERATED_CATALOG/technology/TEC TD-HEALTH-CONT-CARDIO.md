---
id: "TD-HEALTH-CONT-CARDIO"
kind: "technology"
title: "Непрерывность сердечно-сосудистого лечения"
...
# Непрерывность сердечно-сосудистого лечения
...
- **node_id:** TD-HEALTH-CONT-CARDIO
- **parent_id:** [[TEC TD-HEALTH|TD-HEALTH]]
- **domain:** HEALTH
- **node_type:** SITE_DATA
- **title_ru:** Непрерывность сердечно-сосудистого лечения
- **outcome:** Иметь измеримую и проверяемую способность: непрерывность сердечно-сосудистого лечения
- **safety_class:** S3_LICENSED_PROFESSIONAL
