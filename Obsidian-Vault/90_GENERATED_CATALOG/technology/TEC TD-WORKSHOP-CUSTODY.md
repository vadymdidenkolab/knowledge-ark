---
id: "TD-WORKSHOP-CUSTODY"
kind: "technology"
title: "Выдача; возврат и состояние инструмента"
...
# Выдача; возврат и состояние инструмента
...
- **node_id:** TD-WORKSHOP-CUSTODY
- **parent_id:** [[TEC TD-WORKSHOP|TD-WORKSHOP]]
- **domain:** WORKSHOP
- **node_type:** GOVERNANCE
- **title_ru:** Выдача; возврат и состояние инструмента
- **outcome:** Иметь измеримую и проверяемую способность: выдача; возврат и состояние инструмента
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
