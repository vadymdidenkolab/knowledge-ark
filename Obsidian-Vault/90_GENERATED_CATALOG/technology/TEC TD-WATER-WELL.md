...
id: "TD-WATER-WELL"
kind: "technology"
title: "Колодец или скважина; строительство и эксплуатация"
...
# Колодец или скважина; строительство и эксплуатация
...
- **node_id:** TD-WATER-WELL
- **parent_id:** [[TEC TD-WATER|TD-WATER]]
- **domain:** WATER_WASH
- **node_type:** PROCESS
- **title_ru:** Колодец или скважина; строительство и эксплуатация
- **outcome:** Иметь измеримую и проверяемую способность: колодец или скважина; строительство и эксплуатация
- **safety_class:** S3_LICENSED_PROFESSIONAL
