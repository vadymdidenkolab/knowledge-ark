---
id: "TD-MATERIALS-PRODUCTION-LIME"
kind: "technology"
title: "Готовая известь; растворы и маркировка"
...
# Готовая известь; растворы и маркировка
...
- **node_id:** TD-MATERIALS-PRODUCTION-LIME
- **parent_id:** [[TEC TD-MATERIALS-PRODUCTION|TD-MATERIALS-PRODUCTION]]
- **domain:** MATERIALS
- **node_type:** MATERIAL
- **title_ru:** Готовая известь; растворы и маркировка
- **outcome:** Иметь измеримую и проверяемую способность: готовая известь; растворы и маркировка
- **safety_class:** S3_LICENSED_PROFESSIONAL
