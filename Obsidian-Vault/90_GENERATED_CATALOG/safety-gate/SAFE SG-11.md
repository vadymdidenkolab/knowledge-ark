...
id: "SG-11"
kind: "safety-gate"
title: "CONFINED_SPACE_WATER_HEIGHT"
...
status: "S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD"
...
- **ID:** `SG-11`
- **Статус:** `S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD`
- **Приоритет:** `P0_RED`
...
- **gate_id:** SG-11
- **hazard_class:** CONFINED_SPACE_WATER_HEIGHT
- **no_go_rule_ru:** Не входить в колодцы, резервуары, стоки, шахты; не работать у воды/на высоте без системы
- **safety_class:** S4_REFERENCE_ONLY_PROHIBITED_HOUSEHOLD
- **safe_fallback_ru:** службы/профессиональная команда
- **release_version:** 0.4
