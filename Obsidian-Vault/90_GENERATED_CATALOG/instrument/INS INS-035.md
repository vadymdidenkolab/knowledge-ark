...
id: "INS-035"
kind: "instrument"
title: "тензиометр/датчик влажности почвы"
...
# тензиометр/датчик влажности почвы
...
- **instrument_id:** INS-035
- **category:** AGRI
- **instrument_ru:** тензиометр/датчик влажности почвы
- **measures:** водный потенциал/влажность
- **unit:** kPa|%
...
- **calibration_method:** почвоспецифическая калибровка и gravimetric comparison
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не принимать универсальные проценты как истину
- **spare_strategy:** ручная проба + второй датчик
