...
- **instrument_id:** INS-015
- **category:** THERMAL
- **instrument_ru:** термопара и считыватель
...
- **calibration_method:** reference junction и сравнение по двум точкам
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не касаться электрически опасных/движущихся частей
- **spare_strategy:** запасные зонды
