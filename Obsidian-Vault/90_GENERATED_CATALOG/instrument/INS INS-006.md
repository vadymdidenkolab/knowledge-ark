...
- **category:** METROLOGY
- **instrument_ru:** уровень пузырьковый
- **measures:** наклон
- **unit:** mm/m
...
- **calibration_method:** переворот на одной поверхности
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать на высоте без защиты
- **spare_strategy:** короткий и длинный
