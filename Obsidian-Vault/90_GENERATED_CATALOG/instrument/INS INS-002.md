...
- **calibration_method:** проверка нуля/зацепа и нескольких точек
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не отпускать ленту неконтролируемо
- **spare_strategy:** запасная рулетка и складной метр
