...
- **instrument_id:** INS-021
- **category:** ENVIRONMENT
- **instrument_ru:** люксметр
- **measures:** освещённость
- **unit:** lx
...
- **calibration_method:** сравнение с калиброванным прибором/лабораторией
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не измерять Солнце без допустимого диапазона
- **spare_strategy:** два сенсора/эталонная лампа по сроку
