...
id: "INS-024"
kind: "instrument"
title: "сертифицированный бытовой CO alarm"
...
# сертифицированный бытовой CO alarm
...
- **instrument_id:** INS-024
- **category:** ENVIRONMENT
- **instrument_ru:** сертифицированный бытовой CO alarm
- **measures:** CO alarm
- **unit:** ppm/alarm
...
- **calibration_method:** только штатная test-кнопка/замена по сроку; газовые опыты запрещены
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** никогда не тестировать выхлопом/огнём
- **spare_strategy:** несколько alarms по размещению
