...
id: "INS-042"
kind: "instrument"
title: "автоматический тонометр валидированной модели"
...
# автоматический тонометр валидированной модели
...
- **instrument_id:** INS-042
- **category:** HEALTH
- **instrument_ru:** автоматический тонометр валидированной модели
- **measures:** давление/пульс
- **unit:** mmHg|bpm
...
- **calibration_method:** проверка модели, манжеты и периодическое сравнение в клинике
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не менять лечение по одному измерению
- **spare_strategy:** запасная манжета/клиническая сверка
