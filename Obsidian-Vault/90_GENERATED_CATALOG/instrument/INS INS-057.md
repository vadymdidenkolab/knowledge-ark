...
- **instrument_id:** INS-057
- **category:** MECHANICAL
- **instrument_ru:** тахометр оптический
- **measures:** частота вращения
- **unit:** rpm
...
- **calibration_method:** reflective target on safe trainer/known source
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** ограждение; не приближаться к вращающимся деталям
- **spare_strategy:** video analysis
