...
id: "INS-049"
kind: "instrument"
title: "осциллограф low-voltage isolated use"
...
# осциллограф low-voltage isolated use
...
- **instrument_id:** INS-049
- **category:** ELECTRICAL
- **instrument_ru:** осциллограф low-voltage isolated use
- **measures:** напряжение/время
- **unit:** V|s|Hz
...
- **calibration_method:** internal cal output and service calibration
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не подключать ground clip к сети/неизолированным опасным цепям
- **spare_strategy:** logic analyzer/USB scope with limits
