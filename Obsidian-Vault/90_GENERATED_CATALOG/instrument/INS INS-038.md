...
- **instrument_id:** INS-038
- **category:** BIOLOGY
- **instrument_ru:** лупа 10x
- **measures:** морфология
- **unit:** dimensionless
...
- **calibration_method:** проверка фокуса и scale card
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не направлять Солнце в глаза/на горючее
- **spare_strategy:** вторая лупа
