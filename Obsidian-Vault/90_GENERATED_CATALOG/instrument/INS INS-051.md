...
- **instrument_id:** INS-051
- **category:** ELECTRICAL
- **instrument_ru:** LCR-метр
- **measures:** R/L/C
- **unit:** Ω|H|F
...
- **calibration_method:** open/short calibration and standards
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** только новые известные малые низковольтные учебные компоненты; неизвестные/извлечённые capacitors, power electronics и in-circuit measurement запрещены
- **spare_strategy:** known low-energy components
