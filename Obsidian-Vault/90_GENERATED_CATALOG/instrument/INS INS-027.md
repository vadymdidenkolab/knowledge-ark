...
id: "INS-027"
kind: "instrument"
title: "расходомер низкого давления"
...
- **instrument_id:** INS-027
- **category:** WATER
- **instrument_ru:** расходомер низкого давления
- **measures:** расход
- **unit:** L/min
...
- **calibration_method:** timed-volume comparison
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не подключать к газу/опасному давлению
- **spare_strategy:** ведро+секундомер
