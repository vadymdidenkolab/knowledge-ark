...
- **instrument_id:** INS-037
- **category:** AGRI
- **instrument_ru:** leaf-area scale/grid
- **measures:** площадь листа
- **unit:** cm²
...
- **calibration_method:** геометрическая проверка grid/reference
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не повреждать охраняемые растения
- **spare_strategy:** фото с масштабом
