...
- **instrument_id:** INS-016
- **category:** THERMAL
- **instrument_ru:** ИК-термометр
- **measures:** температура поверхности
- **unit:** °C
...
- **calibration_method:** blackbody/сравнительная поверхность и emissivity note
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не измеряет внутреннюю температуру и воздух; лазер не направлять в глаза
- **spare_strategy:** контактный термометр
