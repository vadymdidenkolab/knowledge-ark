...
id: "INS-066"
kind: "instrument"
title: "offline clock/source-of-truth appliance"
...
# offline clock/source-of-truth appliance
...
- **instrument_id:** INS-066
- **category:** COMPUTING
- **instrument_ru:** offline clock/source-of-truth appliance
- **measures:** время/version
- **unit:** UTC/ISO-8601
...
- **calibration_method:** compare against multiple sources before disconnect
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не считать время юридически прослеживаемым без соответствующей службы
- **spare_strategy:** mechanical/quartz logs
