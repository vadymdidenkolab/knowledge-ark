...
- **instrument_id:** INS-071
- **category:** SAFETY
- **instrument_ru:** штатный детектор дыма
- **measures:** smoke alarm
- **unit:** alarm/pass-fail
...
- **calibration_method:** test button and replacement date; aerosol only if manufacturer allows
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не тестировать огнём/дымом вне инструкции
- **spare_strategy:** несколько detectors по плану
