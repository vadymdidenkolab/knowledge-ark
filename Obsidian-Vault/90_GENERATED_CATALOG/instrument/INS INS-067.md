...
id: "INS-067"
kind: "instrument"
title: "оптический/штрихкод сканер"
...
- **instrument_id:** INS-067
- **category:** ARCHIVE
- **instrument_ru:** оптический/штрихкод сканер
- **measures:** идентификатор
- **unit:** text/check digit
...
- **calibration_method:** known test sheet and checksum validation
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не кодировать секреты в открытые labels
- **spare_strategy:** manual typed ID
