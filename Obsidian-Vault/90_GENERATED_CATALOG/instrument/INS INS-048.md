...
id: "INS-048"
kind: "instrument"
title: "DC electronic load low-power"
...
- **instrument_id:** INS-048
- **category:** ELECTRICAL
- **instrument_ru:** DC electronic load low-power
- **measures:** нагрузка/энергия
- **unit:** A|W|Wh
...
- **calibration_method:** reference meter and thermal check
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не превышать мощность; огнестойкая площадка и надзор
- **spare_strategy:** резистивные certified loads
