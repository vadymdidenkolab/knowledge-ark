...
id: "INS-041"
kind: "instrument"
title: "клинический цифровой термометр"
...
# клинический цифровой термометр
...
- **instrument_id:** INS-041
- **category:** HEALTH
- **instrument_ru:** клинический цифровой термометр
- **measures:** температура тела
- **unit:** °C
...
- **calibration_method:** штатная проверка/профессиональная поверка по назначению
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не интерпретировать вне инструкции/клинического контекста
- **spare_strategy:** второй одобренный прибор
