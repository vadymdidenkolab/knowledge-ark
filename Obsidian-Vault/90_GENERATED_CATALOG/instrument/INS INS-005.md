...
- **category:** METROLOGY
- **instrument_ru:** угольник
- **measures:** прямой угол
- **unit:** degree/pass-fail
...
- **calibration_method:** flip test на прямой линии
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не применять как ударный инструмент
- **spare_strategy:** малый и строительный
