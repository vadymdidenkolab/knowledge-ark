...
- **instrument_id:** INS-058
- **category:** MECHANICAL
- **instrument_ru:** виброметр
- **measures:** ускорение/скорость
- **unit:** m/s²|mm/s
...
- **calibration_method:** calibrator/service and fixed mounting protocol
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не приближаться к неограждённому механизму
- **spare_strategy:** trend by same sensor
