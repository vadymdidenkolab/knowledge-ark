...
id: "INS-045"
kind: "instrument"
title: "цифровой мультиметр CAT по задаче"
...
# цифровой мультиметр CAT по задаче
...
- **instrument_id:** INS-045
- **category:** ELECTRICAL
- **instrument_ru:** цифровой мультиметр CAT по задаче
- **measures:** V/A/Ω
- **unit:** V|A|Ω
...
- **calibration_method:** proof source/service calibration; lead/fuse inspection
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** базовый kit ограничен изолированным низким напряжением; mains — специалист
- **spare_strategy:** второй простой meter
