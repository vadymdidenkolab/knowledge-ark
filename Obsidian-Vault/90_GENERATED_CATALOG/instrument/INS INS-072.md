...
id: "INS-072"
kind: "instrument"
title: "штатный детектор утечки воды"
...
- **instrument_id:** INS-072
- **category:** SAFETY
- **instrument_ru:** штатный детектор утечки воды
- **measures:** water alarm
...
- **calibration_method:** test probe with clean water per manual
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не помещать электронику вне rated environment
- **spare_strategy:** несколько points + visual checks
