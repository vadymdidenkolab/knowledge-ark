...
id: "INS-039"
kind: "instrument"
title: "оптический микроскоп для готовых слайдов"
...
# оптический микроскоп для готовых слайдов
...
- **instrument_id:** INS-039
- **category:** BIOLOGY
- **instrument_ru:** оптический микроскоп для готовых слайдов
- **measures:** изображение/масштаб
- **unit:** µm
...
- **calibration_method:** stage micrometer и чистый known slide
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не культивировать/не исследовать неизвестные биообразцы
- **spare_strategy:** лупа+готовый атлас
