...
id: "INS-070"
kind: "instrument"
title: "printer with archival workflow"
...
# printer with archival workflow
...
- **instrument_id:** INS-070
- **category:** ARCHIVE
- **instrument_ru:** printer with archival workflow
- **measures:** печатный вывод
- **unit:** dpi/page
...
- **calibration_method:** test target, page count and visual comparison
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** вентиляция, расходники, персональные данные
- **spare_strategy:** второй print path/ручная копия core
