...
id: "INS-065"
kind: "instrument"
title: "два независимых hash-инструмента"
...
# два независимых hash-инструмента
...
- **instrument_id:** INS-065
- **category:** COMPUTING
- **instrument_ru:** два независимых hash-инструмента
- **measures:** fixity
- **unit:** SHA-256
...
- **calibration_method:** test vectors and cross-tool comparison
...
- **safety_class:** S0_OBSERVE_READ
- **prohibited_use:** hash не доказывает безопасность/правдивость содержимого
- **spare_strategy:** printed checksums and alternate OS
