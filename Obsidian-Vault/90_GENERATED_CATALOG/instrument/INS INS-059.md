...
- **instrument_id:** INS-059
- **category:** MECHANICAL
- **instrument_ru:** feeler gauge
- **measures:** зазор
- **unit:** mm
...
- **calibration_method:** cleanliness and comparison/reference block
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** только остановленное/изолированное оборудование
- **spare_strategy:** duplicate set
