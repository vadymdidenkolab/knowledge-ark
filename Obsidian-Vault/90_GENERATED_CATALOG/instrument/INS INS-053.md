...
id: "INS-053"
kind: "instrument"
title: "plug-in energy meter approved for EU socket"
...
# plug-in energy meter approved for EU socket
...
- **instrument_id:** INS-053
- **category:** ENERGY
- **instrument_ru:** plug-in energy meter approved for EU socket
- **measures:** мощность/энергия
- **unit:** W|Wh
...
- **calibration_method:** reference load/service check
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** только штатное включение; не вскрывать и не использовать с повреждением
- **spare_strategy:** utility meter trend/second unit
