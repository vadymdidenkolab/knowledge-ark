...
id: "INS-033"
kind: "instrument"
title: "почвенный бур/пробоотборник"
...
- **instrument_id:** INS-033
- **category:** SOIL
- **instrument_ru:** почвенный бур/пробоотборник
- **measures:** глубина/проба
- **unit:** cm
...
- **calibration_method:** разметка глубины и очистка между точками
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** только ручная неглубокая проба после документированной clearance коммуникаций/загрязнения/склона; силовое бурение и неизвестная площадка запрещены
- **spare_strategy:** лопатка для неглубоких заранее разрешённых проб
