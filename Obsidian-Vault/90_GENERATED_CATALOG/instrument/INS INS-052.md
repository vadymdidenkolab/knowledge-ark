...
id: "INS-052"
kind: "instrument"
title: "низковольтный data logger"
...
- **instrument_id:** INS-052
- **category:** ELECTRICAL
- **instrument_ru:** низковольтный data logger
- **measures:** сенсорный ряд
- **unit:** SI by sensor
...
- **calibration_method:** reference points per channel and clock sync
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать для safety-critical control
- **spare_strategy:** бумажный журнал/второй logger
