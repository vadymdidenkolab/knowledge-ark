...
- **instrument_id:** INS-019
- **category:** ENVIRONMENT
- **instrument_ru:** анемометр
- **measures:** скорость воздуха
- **unit:** m/s
...
- **calibration_method:** сервис/сравнение в контролируемом потоке
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не измерять с крыши/у ЛЭП/в шторм
- **spare_strategy:** визуальные шкалы Beaufort как fallback
