...
id: "INS-007"
kind: "instrument"
title: "цифровой угломер/инклинометр"
...
- **category:** METROLOGY
- **instrument_ru:** цифровой угломер/инклинометр
- **measures:** угол/наклон
- **unit:** degree
...
- **calibration_method:** zero на проверенной поверхности и reversal test
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать как доказательство структурной безопасности
- **spare_strategy:** механический транспортир
