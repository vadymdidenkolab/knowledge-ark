...
id: "INS-013"
kind: "instrument"
title: "контактный цифровой термометр"
...
- **instrument_id:** INS-013
- **category:** THERMAL
- **instrument_ru:** контактный цифровой термометр
- **measures:** температура
- **unit:** °C
...
- **calibration_method:** ледяная точка/сертифицированный термостат и 2-точечная проверка
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать бытовую калибровку для клинических решений
- **spare_strategy:** два датчика разных типов
