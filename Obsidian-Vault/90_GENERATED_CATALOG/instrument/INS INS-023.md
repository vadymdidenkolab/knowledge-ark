...
- **instrument_id:** INS-023
- **category:** ENVIRONMENT
- **instrument_ru:** датчик CO2 NDIR
- **measures:** CO2
- **unit:** ppm
...
- **calibration_method:** fresh-air check/сертифицированный газ у специалиста
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** CO2 не заменяет датчик CO и не доказывает отсутствие инфекции
- **spare_strategy:** два NDIR разных партий
