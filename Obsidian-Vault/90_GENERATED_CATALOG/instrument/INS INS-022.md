...
id: "INS-022"
kind: "instrument"
title: "шумомер класса по задаче"
...
- **instrument_id:** INS-022
- **category:** ENVIRONMENT
- **instrument_ru:** шумомер класса по задаче
- **measures:** уровень звука
- **unit:** dB(A/C)
...
- **calibration_method:** акустический калибратор до/после серии
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** телефон — ориентир, не юридическое измерение
- **spare_strategy:** калибратор и второй прибор
