...
id: "INS-008"
kind: "instrument"
title: "набор калибровочных гирь"
...
- **category:** METROLOGY
- **instrument_ru:** набор калибровочных гирь
- **measures:** масса-эталон
- **unit:** g
...
- **calibration_method:** сертификат/класс, чистота и контрольная карта
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не считать бытовые предметы прослеживаемым эталоном
- **spare_strategy:** две номинальные точки
