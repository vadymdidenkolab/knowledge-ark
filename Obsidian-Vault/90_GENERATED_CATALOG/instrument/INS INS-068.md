...
- **instrument_id:** INS-068
- **category:** ARCHIVE
- **instrument_ru:** документ-сканер
- **measures:** изображение/OCR
- **unit:** dpi|pixel
...
- **calibration_method:** resolution target, color/scale card and page-count reconciliation
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** контроль приватности и повреждения оригинала
- **spare_strategy:** camera rig + flatbed
