...
- **instrument_id:** INS-009
- **category:** METROLOGY
- **instrument_ru:** весы кухонные
- **measures:** масса
- **unit:** g
...
- **calibration_method:** zero, несколько гирь, повторяемость и corner-load
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать для лекарственных доз
- **spare_strategy:** механические весы как fallback
