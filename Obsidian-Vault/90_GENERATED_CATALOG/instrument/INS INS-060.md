...
- **instrument_id:** INS-060
- **category:** MECHANICAL
- **instrument_ru:** thread pitch gauge
- **measures:** шаг резьбы
- **unit:** mm|TPI
...
- **calibration_method:** known fastener/reference chart
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не применять к вращающейся детали
- **spare_strategy:** printable chart/caliper
