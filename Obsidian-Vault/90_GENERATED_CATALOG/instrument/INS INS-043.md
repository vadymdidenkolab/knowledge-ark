...
- **instrument_id:** INS-043
- **category:** HEALTH
- **instrument_ru:** пульсоксиметр
- **measures:** SpO2/пульс
- **unit:** %|bpm
...
- **calibration_method:** functional check and professional comparison; limitations logged
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** плохая перфузия/движение/лак и другие факторы искажают; не откладывать помощь
- **spare_strategy:** второй метод клинической оценки — специалист
