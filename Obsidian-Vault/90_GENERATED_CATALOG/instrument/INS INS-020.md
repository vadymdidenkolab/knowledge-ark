...
- **instrument_id:** INS-020
- **category:** ENVIRONMENT
- **instrument_ru:** дождемер
- **measures:** осадки
- **unit:** mm
...
- **calibration_method:** объёмная проверка площади приёмника
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** устанавливать без высотной работы
- **spare_strategy:** ручной резерв
