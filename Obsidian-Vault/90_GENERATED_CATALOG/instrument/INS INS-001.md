...
- **category:** METROLOGY
- **instrument_ru:** стальная линейка
- **measures:** длина
- **unit:** mm
...
- **calibration_method:** проверка нуля и сравнение с прослеживаемым эталоном длины
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать повреждённую кромку как режущий инструмент
- **spare_strategy:** две линейки разных производителей
