...
- **instrument_id:** INS-029
- **category:** WATER
- **instrument_ru:** pH-метр
- **measures:** pH
- **unit:** pH
...
- **calibration_method:** 2–3 свежих буфера, slope/offset log
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** pH не доказывает питьевую безопасность
- **spare_strategy:** полоски как грубый fallback
