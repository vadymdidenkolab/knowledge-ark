...
id: "INS-011"
kind: "instrument"
title: "механические часы/секундомер"
...
- **category:** TIME
- **instrument_ru:** механические часы/секундомер
- **measures:** время
- **unit:** s
...
- **calibration_method:** сравнение с двумя независимыми эталонами времени
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать один дрейфующий источник как эталон
- **spare_strategy:** кварцевые часы + ради/GNSS при наличии
