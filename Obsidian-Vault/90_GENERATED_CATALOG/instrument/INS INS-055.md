...
- **instrument_id:** INS-055
- **category:** MECHANICAL
- **instrument_ru:** пружинный динамометр
- **measures:** сила
- **unit:** N
...
- **calibration_method:** known masses within local g and range
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не поднимать людей/опасные грузы
- **spare_strategy:** две шкалы
