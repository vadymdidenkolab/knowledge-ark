...
id: "INS-034"
kind: "instrument"
title: "сита для текстуры/агрегатов"
...
- **instrument_id:** INS-034
- **category:** SOIL
- **instrument_ru:** сита для текстуры/агрегатов
- **measures:** размер частиц
- **unit:** mm
...
- **calibration_method:** проверка маркировки/повреждения и контрольная смесь
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** пыль — вентиляция/СИЗ; не анализировать подозрительные загрязнения
- **spare_strategy:** ручная текстурная оценка
