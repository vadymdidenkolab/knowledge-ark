...
- **instrument_id:** INS-030
- **category:** WATER
- **instrument_ru:** TDS/EC-метр
- **measures:** электропроводность
- **unit:** µS/cm
...
- **calibration_method:** сертифицированный стандарт и температурная компенсация
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** TDS не выявляет конкретные токсины/патогены
- **spare_strategy:** второй прибор/стандарт
