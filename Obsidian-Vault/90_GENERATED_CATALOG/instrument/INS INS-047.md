...
- **instrument_id:** INS-047
- **category:** ELECTRICAL
- **instrument_ru:** USB power meter
- **measures:** энергия/ток
- **unit:** Wh|A|V
...
- **calibration_method:** comparison with reference load/source
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать на сети 230 V
- **spare_strategy:** второй meter/known load
