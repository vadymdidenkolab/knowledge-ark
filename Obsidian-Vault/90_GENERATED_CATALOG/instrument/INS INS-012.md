...
- **instrument_id:** INS-012
- **category:** TIME
- **instrument_ru:** RTC/частотный счётчик
- **measures:** частота/время
- **unit:** Hz|s
...
- **calibration_method:** сравнение с прослеживаемым частотным источником
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не подключать к опасному напряжению
- **spare_strategy:** запасной модуль и опубликованный offset
