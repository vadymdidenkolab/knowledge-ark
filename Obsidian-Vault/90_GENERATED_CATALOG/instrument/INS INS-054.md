...
id: "INS-054"
kind: "instrument"
title: "solar irradiance reference cell/pyranometer"
...
# solar irradiance reference cell/pyranometer
...
- **instrument_id:** INS-054
- **category:** ENERGY
- **instrument_ru:** solar irradiance reference cell/pyranometer
- **measures:** облучённость
- **unit:** W/m²
...
- **calibration_method:** manufacturer calibration and intercomparison
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** крыша/высота требует специалиста
- **spare_strategy:** horizontal accessible reference point
