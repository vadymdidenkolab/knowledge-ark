...
id: "INS-040"
kind: "instrument"
title: "камера/фотоаппарат с scale card"
...
# камера/фотоаппарат с scale card
...
- **instrument_id:** INS-040
- **category:** BIOLOGY
- **instrument_ru:** камера/фотоаппарат с scale card
- **measures:** изображение и время
- **unit:** px|mm
...
- **calibration_method:** clock check, color/scale card and metadata
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** приватность, геолокация чувствительных видов/людей
- **spare_strategy:** два формата и печатные выборки
