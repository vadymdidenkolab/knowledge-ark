...
id: "INS-063"
kind: "instrument"
title: "лазерный дальномер Class 2 or safer"
...
# лазерный дальномер Class 2 or safer
...
- **instrument_id:** INS-063
- **category:** NAVIGATION
- **instrument_ru:** лазерный дальномер Class 2 or safer
- **measures:** длина
- **unit:** m
...
- **calibration_method:** known baseline and battery check
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не направлять в глаза/транспорт; соблюдать класс лазера
- **spare_strategy:** рулетка
