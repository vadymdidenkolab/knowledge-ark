...
- **instrument_id:** INS-025
- **category:** ENVIRONMENT
- **instrument_ru:** PM2.5 монитор
- **measures:** массовая концентрация-оценка
- **unit:** µg/m³
...
- **calibration_method:** co-location с референсом/контроль нуля по инструкции
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** низкобюджетный сенсор не равен регуляторной станции
- **spare_strategy:** второй тип + официальный мониторинг
