...
- **category:** ELECTRICAL
- **instrument_ru:** логический анализатор
- **measures:** цифровой сигнал
- **unit:** V logic|Hz
...
- **calibration_method:** known pattern generator
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** только безопасные logic levels
- **spare_strategy:** software decoder and spare probes
