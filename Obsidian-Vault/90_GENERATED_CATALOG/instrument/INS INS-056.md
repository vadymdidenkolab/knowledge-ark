...
- **instrument_id:** INS-056
- **category:** MECHANICAL
- **instrument_ru:** динамометрический ключ
- **measures:** момент
- **unit:** N·m
...
- **calibration_method:** accredited calibration and exercise/storage at minimum setting
...
- **safety_class:** S2_TRAINED_SUPERVISED
- **prohibited_use:** не использовать как breaker bar; safety fasteners by spec
- **spare_strategy:** второй диапазон/service
