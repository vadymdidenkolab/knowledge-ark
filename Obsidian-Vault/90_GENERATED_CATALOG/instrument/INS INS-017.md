...
- **instrument_id:** INS-017
- **category:** ENVIRONMENT
- **instrument_ru:** гигрометр
- **measures:** относительная влажность
- **unit:** %RH
...
- **calibration_method:** сертифицированная salt-point/эталонная камера
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не считать дешёвый датчик эталоном без проверки
- **spare_strategy:** два датчика и психрометр
