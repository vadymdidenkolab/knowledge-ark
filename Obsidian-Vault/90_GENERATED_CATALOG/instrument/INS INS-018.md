...
- **instrument_id:** INS-018
- **category:** ENVIRONMENT
- **instrument_ru:** барометр
- **measures:** давление
- **unit:** hPa
...
- **calibration_method:** сравнение с официальной станцией с поправкой высоты
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не использовать для прогноза без контекста
- **spare_strategy:** механический и цифровой
