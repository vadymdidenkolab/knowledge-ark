...
- **category:** METROLOGY
- **instrument_ru:** штангенциркуль
- **measures:** наружный/внутренний размер
- **unit:** mm
...
- **calibration_method:** очистка губок, zero check, проверочный блок
...
- **safety_class:** S1_LOW_RISK_HOUSEHOLD
- **prohibited_use:** не измерять вращающиеся/электрические части
- **spare_strategy:** механический плюс цифровой
